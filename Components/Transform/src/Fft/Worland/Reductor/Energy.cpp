...
namespace Reductor {
   ...
   Energy::Energy()
      : IWorlandEnergy(1)
   {
      this->mProfileId = Debug::Profiler::WORLANDREDU_ENERGY;
   }
   ...
   void Energy::makeOperator(Matrix& op, Matrix& eop, const internal::Array& igrid, const internal::Array& iweights, const Array& eweights, const int i) const
   {
   ...
   void Energy::applyOperator(Eigen::Ref<Matrix> rOut, const int i, const Eigen::Ref<const MatrixZ>& in) const
   {
