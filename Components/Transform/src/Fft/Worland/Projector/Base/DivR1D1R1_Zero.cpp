...
namespace Projector {
   ...
   void DivR1D1R1_Zero<base_t>::applyPreOperator(const Eigen::Ref<const Matrix>& in, const bool isEven) const
   {
   ...
   void DivR1D1R1_Zero<base_t>::applyPostOperator(Eigen::Ref<Matrix> rOut, const bool isEven) const
   {
      this->mBackend.output(rOut, isEven);
   }

   void DivR1D1R1_Zero<base_t>::applyPreOperator(const Eigen::Ref<const MatrixZ>& in, const bool isEven, const bool useReal) const
   {
   ...
   void DivR1D1R1_Zero<base_t>::applyPostOperator(Eigen::Ref<MatrixZ> rOut, const bool isEven, const bool useReal) const
   {
