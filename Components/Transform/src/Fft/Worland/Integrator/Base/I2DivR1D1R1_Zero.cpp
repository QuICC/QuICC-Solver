...
namespace Integrator {
   ...
   void I2DivR1D1R1_Zero<base_t>::applyPostOperator(Eigen::Ref<Matrix> rOut, const bool isEven) const
   {
   ...
   void I2DivR1D1R1_Zero<base_t>::applyPostOperator(Eigen::Ref<MatrixZ> rOut, const bool isEven, const bool useReal) const
   {
      DivR1D1R1<base_t>::computeWorlandExpansion(isEven);
      this->mBackend.applyI2(isEven);
