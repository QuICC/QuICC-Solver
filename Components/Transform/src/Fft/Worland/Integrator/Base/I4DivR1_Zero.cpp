...
namespace Integrator {
   ...
   void I4DivR1_Zero<base_t>::applyPostOperator(Eigen::Ref<Matrix> rOut, const bool isEven) const
   {
   ...
   void I4DivR1_Zero<base_t>::applyPostOperator(Eigen::Ref<MatrixZ> rOut, const bool isEven, const bool useReal) const
   {
      DivR1<base_t>::computeWorlandExpansion(isEven);
      this->mBackend.applyI4(isEven);
