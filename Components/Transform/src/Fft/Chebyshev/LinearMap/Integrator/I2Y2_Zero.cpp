...
namespace Integrator {
   ...
   void I2Y2_Zero::applyPreOperator(Matrix& tmp, const MatrixZ& in, const bool useReal) const
   {
      this->mBackend.input(tmp, in, useReal);
   }

   void I2Y2_Zero::applyPostOperator(MatrixZ& rOut, const Matrix& tmp, const bool useReal) const
   {
