...
namespace Integrator {
   ...
   void I2D1_I2::applyPreOperator(Matrix& rOut, const Matrix& in) const
   {
   ...
   void I2D1_I2::applyPreOperator(const MatrixZ& in, const bool useReal) const
   {
      this->mBackend.input(in, useReal);
   }

   void I2D1_I2::applyPostOperator(MatrixZ& rOut, const bool useReal) const
   {
