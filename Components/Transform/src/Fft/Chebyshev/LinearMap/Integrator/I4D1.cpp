...
namespace Integrator {
   ...
   void I4D1::applyPreOperator(Matrix& tmp, const MatrixZ& in, const bool useReal) const
   {
      this->mBackend.input(tmp, in, useReal);
   }

   void I4D1::applyPostOperator(MatrixZ& rOut, const Matrix& tmp, const bool useReal) const
   {
