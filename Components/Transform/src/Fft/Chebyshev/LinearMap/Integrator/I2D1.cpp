/**
 * @file I2D1.cpp
 * @brief Source of the implementation of the Chebyshev I2 of D integrator, with
 * linear map y = ax + b
 */
...
void I2D1::applyPreOperator(Matrix& tmp, const MatrixZ& in,
   const bool useReal) const
{
   this->mBackend.input(tmp, in, useReal);
}

void I2D1::applyPostOperator(MatrixZ& rOut, const Matrix& tmp,
   const bool useReal) const
{
