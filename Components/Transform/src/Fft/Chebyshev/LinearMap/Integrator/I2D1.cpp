...
namespace Integrator {
   ...
   void I2D1::applyPreOperator(Matrix& rOut, const Matrix& in) const
   {
   ...
   void I2D1::applyPreOperator(const MatrixZ& in, const bool useReal) const
   {
      this->mBackend.input(in, useReal);
   }

   void I2D1::applyPostOperator(MatrixZ& rOut, const bool useReal) const
   {
