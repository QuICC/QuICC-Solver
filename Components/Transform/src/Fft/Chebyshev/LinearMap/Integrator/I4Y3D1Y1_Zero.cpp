...
namespace Integrator {
   ...
   void I4Y3D1Y1_Zero::applyPreOperator(Matrix& rOut, const Matrix& in) const
   {
   ...
   void I4Y3D1Y1_Zero::applyPreOperator(const MatrixZ& in, const bool useReal) const
   {
      this->mBackend.input(in, useReal);
   }

   void I4Y3D1Y1_Zero::applyPostOperator(MatrixZ& rOut, const bool useReal) const
   {
