...
// Project includes
//
#include "QuICC/Transform/Fft/Chebyshev/LinearMap/Projector/Base/DivY1D1Y1.hpp"
...
namespace Projector {
   ...
   void DivY1D1Y1<base_t>::initOperator() const
   {
   ...
   void DivY1D1Y1<base_t>::initBackend() const
   {
   ...
   void DivY1D1Y1<base_t>::applyPreOperator(Matrix& tmp, const MatrixZ& in, const bool useReal) const
   {
   ...
   void DivY1D1Y1<base_t>::applyPostOperator(MatrixZ& rOut, const Matrix& tmp, const bool useReal) const
   {
