...
namespace Projector {
   ...
   void SphRadLapl<base_t>::initOperator() const
   {
   ...
   void SphRadLapl<base_t>::applyPreOperator(Matrix& tmp, const MatrixZ& in, const bool useReal) const
   {
   ...
   void SphRadLapl<base_t>::applyPostOperator(MatrixZ& rOut, const Matrix& tmp, const bool useReal) const
   {
