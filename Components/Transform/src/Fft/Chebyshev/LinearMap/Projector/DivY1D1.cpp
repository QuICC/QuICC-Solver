...
namespace Projector {
   ...
   void DivY1D1::initOperator() const
   {
   ...
   void DivY1D1::initBackend() const
   {
   ...
   void DivY1D1::applyPreOperator(Matrix& tmp, const Matrix& in) const
   {
   ...
   void DivY1D1::applyPostOperator(Matrix& rOut) const
   {
      this->mBackend.outputScale(rOut);
   }

   void DivY1D1::applyPreOperator(Matrix& tmp, const MatrixZ& in, const bool useReal) const
   {
   ...
   void DivY1D1::applyPostOperator(MatrixZ& rOut, const Matrix& tmp, const bool useReal) const
   {
