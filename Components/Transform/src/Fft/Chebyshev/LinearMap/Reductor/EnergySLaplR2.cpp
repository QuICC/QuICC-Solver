...
void EnergySLaplR2::initOperator() const
{
...
void EnergySLaplR2::initBackend() const
{
...
void EnergySLaplR2::applyPreOperator(Matrix& tmp, const Matrix& in) const
{
...
void EnergySLaplR2::applyPostOperator(Matrix& rOut, const Matrix& tmp) const
{
   assert(rOut.cols() == 1);
   this->mBackend.output(rOut, tmp);
}

void EnergySLaplR2::applyPreOperator(Matrix& tmp, const MatrixZ& in,
