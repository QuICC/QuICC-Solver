...
#include "QuICC/Transform/Fft/Chebyshev/LinearMap/Reductor/Base/RadialPowerDivY1D1Y1.hpp"
...
void RadialPowerDivY1D1Y1<base_t>::initOperator() const
{
...
void RadialPowerDivY1D1Y1<base_t>::initBackend() const
{
