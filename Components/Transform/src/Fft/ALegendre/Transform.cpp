/**
 * @file Transform.cpp
 * @brief Source of the implementation of the FFT based ALegendre transform
 */
...
// Class include
//
#include "QuICC/Transform/Fft/ALegendre/Transform.hpp"
...
namespace ALegendre {
   ...
   void Transform::transform(Matrix& rOut, const MatrixZ& in, const IALegendreOperator& op)
   {
      if(!op.isInitialized())
      {
         op.init(this->mspSetup);
