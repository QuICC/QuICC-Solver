...
void KokkosIALegendreProjector::initOperators(const Internal::Array& igrid,
...
void KokkosIALegendreProjector::applyOperators(MatrixZ& rOut,
...
void KokkosIALegendreProjector::applyOperator(OpMatrixR rOut, const int i,
