/**
 * @file D1DivS1.cpp
 * @brief Source of the implementation of the associated Legendre D1(1/Sin)
 * projector
 */
...
void D1DivS1<kokkos_t>::makeOperator(Matrix& op, const Internal::Array& igrid,
...
void D1DivS1<kokkos_t>::applyUnitOperator(const OpMatrixLZ& rOutView,
