/**
 * @file D1DivS1.cpp
 * @brief Source of the implementation of the associated Legendre D1(1/Sin) projector
 */
...
namespace Projector {
   ...
   void D1DivS1<base_t>::makeOperator(Matrix& op, const Internal::Array& igrid, const Internal::Array& iweights, const int i) const
   {
      ...
      Polynomial::ALegendre::dsin_1Plm plm;
      plm.compute<MHDFloat>(op, nPoly, m, igrid, Internal::Array(), ev::Set());
   }

   void D1DivS1<base_t>::applyOperator(Eigen::Ref<MatrixZ> rOut, const int i, const Eigen::Ref<const MatrixZ>& in) const
   {
