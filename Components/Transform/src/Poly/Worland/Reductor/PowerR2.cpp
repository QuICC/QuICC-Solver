...
namespace Reductor {
   ...
   PowerR2::PowerR2()
      : IWorlandPower(1)
   {
      this->mProfileId = Debug::Profiler::WORLANDREDU_POWERR2;
   }
   ...
   void PowerR2::makeOperator(Matrix& op, Matrix& eop, const internal::Array& igrid, const internal::Array& iweights, const int i) const
   {
   ...
   void PowerR2::applyOperator(Eigen::Ref<Matrix> rOut, const int i, const Eigen::Ref<const MatrixZ>& in) const
   {
