...
namespace Reductor {
   ...
   PowerD1R1::PowerD1R1()
      : IWorlandPower(0)
   {
      this->mProfileId = Debug::Profiler::WORLANDREDU_POWERD1R1;
   }
   ...
   void PowerD1R1::makeOperator(Matrix& op, Matrix& eop, const internal::Array& igrid, const internal::Array& iweights, const int i) const
   {
   ...
   void PowerD1R1::applyOperator(Eigen::Ref<Matrix> rOut, const int i, const Eigen::Ref<const MatrixZ>& in) const
   {
