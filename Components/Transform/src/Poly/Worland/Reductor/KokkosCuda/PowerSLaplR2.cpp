...
PowerSLaplR2<kokkos_t>::PowerSLaplR2() : KokkosIWorlandPower(1)
{
   this->setProfileTag();
}

void PowerSLaplR2<kokkos_t>::makeOperator(Matrix& op, Matrix& eop,
...
void PowerSLaplR2<kokkos_t>::applyUnitOperator(const OpMatrixL& rOutView,
