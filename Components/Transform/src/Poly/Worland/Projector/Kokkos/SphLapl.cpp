/**
 * @file SphLapl.cpp
 * @brief Source of the implementation of the Worland spherical laplacian
 * projector
 */
...
SphLapl<kokkos_t>::SphLapl()
{
   this->setProfileTag();
}

void SphLapl<kokkos_t>::makeOperator(Matrix& op, const Internal::Array& igrid,
...
void SphLapl<kokkos_t>::applyUnitOperator(const OpMatrixLZ& rOutView,
