...
DivR1<kokkos_t>::DivR1()
{
   this->setProfileTag();
}

void DivR1<kokkos_t>::makeOperator(Matrix& op, const Internal::Array& igrid,
...
void DivR1<kokkos_t>::applyUnitOperator(const OpMatrixLZ& rOutView,
