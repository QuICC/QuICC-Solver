...
I2DivR1_Zero<kokkos_t>::I2DivR1_Zero()
{
   this->setProfileTag();
}

void I2DivR1_Zero<kokkos_t>::makeOperator(Matrix& op,
...
void I2DivR1_Zero<kokkos_t>::applyUnitOperator(const OpMatrixLZ& rOutView,
