...
// Project includes
//
#include "QuICC/Transform/Poly/Worland/Integrator/Kokkos/I6DivR1D1R1_I4.hpp"
...
void I6DivR1D1R1_I4<kokkos_t>::makeOperator(Matrix& op,
...
void I6DivR1D1R1_I4<kokkos_t>::applyUnitOperator(const OpMatrixLZ& rOutView,
