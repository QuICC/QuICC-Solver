...
namespace Integrator {
   ...
   void I4DivR1D1R1_Zero::makeOperator(Matrix& op, const internal::Array& igrid, const internal::Array& iweights, const int i) const
   {
      ...
      } else
      {
         ...
         const int extraN = 6; // I4 has 6 superdiagonals
         int nN = nPoly + extraN;
   ...
   void I4DivR1D1R1_Zero::applyOperator(Eigen::Ref<MatrixZ> rOut, const int i, const Eigen::Ref<const MatrixZ>& in) const
   {
