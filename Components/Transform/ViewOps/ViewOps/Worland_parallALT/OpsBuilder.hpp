...
// Project includes
//
#include "QuICC/Fft/Worland/Wnl.hpp"
#include "QuICC/Fft/Worland/WorlandTypes.hpp"
#include "QuICC/Fft/Worland/claplhWnl.hpp"
#include "QuICC/Fft/Worland/dWnl.hpp"
#include "QuICC/Fft/Worland/dclaplhWnl.hpp"
#include "QuICC/Fft/Worland/drWnl.hpp"
#include "QuICC/Fft/Worland/dr_1drWnl.hpp"
#include "QuICC/Fft/Worland/rWnl.hpp"
#include "QuICC/Fft/Worland/r_1Wnl.hpp"
#include "QuICC/Fft/Worland/r_1claplhWnl.hpp"
#include "QuICC/Fft/Worland/r_1drWnl.hpp"
#include "QuICC/Fft/Worland/slaplWnl.hpp"
...
template <class VOP> struct EnergyHelperMap<VOP, Energy_t>
{
   ...
   {
      Wnl fWnl(Fft::Worland::worland_sphenergy_t::ALPHA,
         Fft::Worland::worland_sphenergy_t::DBETA, -1);
...
template <class VOP> struct OpsBuilderMap<VOP, Energy_t, bwd_t>
{
   using type = Builder<VOP,
      QuICC::DenseOp::Worland::Operator<
         r_1Wnl<QuICC::Fft::Worland::recurrence_t>>,
      bwd_t>;
};
...
template <class VOP> struct OpsBuilderMap<VOP, EnergyD1R1_t, bwd_t>
{
   using type = Builder<VOP,
      QuICC::DenseOp::Worland::Operator<
         r_1drWnl<QuICC::Fft::Worland::recurrence_t>>,
      bwd_t>;
};
...
template <class VOP> struct EnergyHelperMap<VOP, EnergyR2_t>
{
   ...
   {
      Wnl fWnl(Fft::Worland::worland_sphenergy_t::ALPHA,
         Fft::Worland::worland_sphenergy_t::DBETA, 0);
...
template <class VOP> struct OpsBuilderMap<VOP, RadialPowerDivR1D1R1_t, bwd_t>
{
   using type = Builder<VOP,
      QuICC::DenseOp::Worland::OperatorWithMean<
         r_1drWnl<QuICC::Fft::Worland::recurrence_t>, void>,
      bwd_t>;
};
