...
struct OpsBuilderMap<VOP, P_t, DIR> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<Wnl>, DIR>;
};
...
struct OpsBuilderMap<VOP, D1_t, DIR> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<dWnl>, DIR>;
};
...
struct OpsBuilderMap<VOP, D1R1_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<drWnl>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, D1_P_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<dWnl, Wnl>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, DivR1_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<r_1Wnl<recurrence_t>>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, DivR1_Zero_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<r_1Wnl<recurrence_t>, void>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, DivR1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<r_1Wnl<implicit_t>, void>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, DivR1D1R1_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<r_1drWnl<recurrence_t>>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, DivR1D1R1_Zero_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<r_1drWnl<recurrence_t>, void>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, DivR1D1R1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<r_1drWnl<implicit_t>, void>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, SphLapl_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<slaplWnl>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, CylLaplh_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<claplhWnl>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, CylLaplh_DivR1D1R1_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<claplhWnl, r_1drWnl<recurrence_t>>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, D1CylLaplh_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::Operator<dclaplhWnl>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, D1CylLaplh_D1DivR1D1R1_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<dclaplhWnl, dr_1drWnl>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, DivR1CylLaplh_Zero_t, bwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<r_1claplhWnl, void>, bwd_t>;
};
...
struct OpsBuilderMap<VOP, P_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<Wnl, void>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, R1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<rWnl, void>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, I2_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorIN<Wnl, ::QuICC::SparseSM::Worland::I2>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, I2_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorINWithMean<Wnl, ::QuICC::SparseSM::Worland::I2>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, I2DivR1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorINWithMean<r_1Wnl<implicit_t>, ::QuICC::SparseSM::Worland::I2>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, I4DivR1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorINWithMean<r_1Wnl<implicit_t>, ::QuICC::SparseSM::Worland::I4>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, I6DivR1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorINWithMean<r_1Wnl<implicit_t>, ::QuICC::SparseSM::Worland::I6>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, I2DivR1D1R1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorINWithMean<r_1drWnl<implicit_t>, ::QuICC::SparseSM::Worland::I2>, fwd_t>;
};
...
struct OpsBuilderMap<VOP, I4DivR1D1R1_Zero_t, fwd_t> {
    using type = Worland::Builder<VOP, QuICC::DenseSM::Worland::OperatorINWithMean<r_1drWnl<implicit_t>, ::QuICC::SparseSM::Worland::I4>, fwd_t>;
};
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, Energy_t, bwd_t> {
    using type = Builder<VOP, QuICC::DenseSM::Worland::Operator<r_1Wnl<QuICC::Polynomial::Worland::recurrence_t>>, bwd_t>;
};
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, EnergyD1R1_t, bwd_t> {
    using type = Builder<VOP, QuICC::DenseSM::Worland::Operator<r_1drWnl<QuICC::Polynomial::Worland::recurrence_t>>, bwd_t>;
};
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, EnergyR2_t, bwd_t> {
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, EnergySLaplR2_t, bwd_t> {
...
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR>
struct OpsBuilderMap<VOP, Power_t, DIR> {
...
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR>
struct OpsBuilderMap<VOP, PowerR2_t, DIR> {
...
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR>
struct OpsBuilderMap<VOP, PowerD1R1_t, DIR> {
...
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR>
struct OpsBuilderMap<VOP, PowerSLaplR2_t, DIR> {
...
/// @tparam VOP
template <class VOP>
struct EnergyHelperMap<VOP, RadialPower_t>
{
    void compute(VOP opView, const Internal::Array& grid,
      const Internal::Array& weights)
    {
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, RadialPower_t, fwd_t> {
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, RadialPower_t, bwd_t> {
    using type = OpsBuilder<VOP, P_t, bwd_t>;
};
...
/// @tparam VOP
template <class VOP>
struct EnergyHelperMap<VOP, RadialPowerDivR1_t>
{
    void compute(VOP opView, const Internal::Array& grid,
      const Internal::Array& weights)
    {
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, RadialPowerDivR1_t, fwd_t> {
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, RadialPowerDivR1_t, bwd_t> {
...
/// @tparam VOP
template <class VOP>
struct EnergyHelperMap<VOP, RadialPowerDivR1D1R1_t>
{
    void compute(VOP opView, const Internal::Array& grid,
      const Internal::Array& weights)
    {
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, RadialPowerDivR1D1R1_t, fwd_t> {
...
/// @tparam VOP operator view type
template <class VOP>
struct OpsBuilderMap<VOP, RadialPowerDivR1D1R1_t, bwd_t> {
    using type = Builder<VOP, QuICC::DenseSM::Worland::OperatorWithMean<r_1drWnl<QuICC::Polynomial::Worland::recurrence_t>, void>, bwd_t>;
};
