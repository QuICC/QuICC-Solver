...
namespace Chebyshev {
namespace LinearMap {
/// @brief namespace for Chebyshev LinearMap projectors (modal to physical space)
namespace Projector {

/// @brief This class implements a Chebyshev LinearMap Spectral space operation, FFT projection and grid operation
...
class SFGOp : public Operator::UnaryBaseOp<SFGOp<Tout, Tin, SpecBackend, FftBackend, GridBackend>, Tout, Tin> {
public:
...
private:
    ...
    friend Operator::UnaryBaseOp<SFGOp<Tout, Tin, SpecBackend, FftBackend, GridBackend>, Tout, Tin>;
...
template<class Tout, class Tin, class SpecBackend, class FftBackend, class GridBackend>
void SFGOp<Tout, Tin, SpecBackend, FftBackend, GridBackend>::applyImpl(Tout& out, const Tin& in)
{
    Profiler::RegionFixture<4> fix("Chebyshev::LinearMap::Projector::SFGOp::applyImpl");
