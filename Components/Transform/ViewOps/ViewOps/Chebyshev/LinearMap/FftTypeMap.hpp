...
template <class Tout, class Tin, class TType> struct Fft<viewCpu_t, Tout, Tin, TType>
{
   using type = typename QuICC::Fft::Fftw::FftOp<Tout, Tin, TType>;
};

#ifdef QUICC_HAS_CUDA_BACKEND
template <class Tout, class Tin, class TType> struct Fft<viewGpu_t, Tout, Tin, TType>
{
...
template <class Tout, class Tin, class TTYpe> struct Fft<viewGpuVkFFT_t, Tout, Tin, TType>
{
