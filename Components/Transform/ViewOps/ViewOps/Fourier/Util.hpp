...
template <> QUICC_CUDA_HOSTDEV inline double fast_pow<0>(const double i)
{
   return 1;
}

template <> QUICC_CUDA_HOSTDEV inline double fast_pow<1>(const double i)
{
   return i;
}

template <> QUICC_CUDA_HOSTDEV inline double fast_pow<2>(const double i)
{
   return i * i;
}

template <> QUICC_CUDA_HOSTDEV inline double fast_pow<3>(const double i)
{
   return i * i * i;
}

template <> QUICC_CUDA_HOSTDEV inline double fast_pow<4>(const double i)
{
   auto i2 = i * i;
   return i2 * i2;
}
