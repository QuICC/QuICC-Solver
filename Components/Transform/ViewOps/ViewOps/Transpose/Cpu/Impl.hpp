...
void implPerm201(View::View<Tout, View::DCCSC3D>& out, const View::View<Tin, View::DCCSC3D>& in)
{
    // dense transpose
...
/// @param in
template <class Tout, class Tin>
void implPerm120(View::View<Tout, View::DCCSC3D>& out, const View::View<Tin, View::DCCSC3D>& in)
{
    // dense transpose
...
/// @param in
template <class Tout, class Tin>
void implPerm201(View::View<Tout, View::DCCSC3D>& out, const View::View<Tin, View::S1CLCSC3D>& in)
{
    // dense transpose
...
/// @param in
template <class Tout, class Tin>
void implPerm120(View::View<Tout, View::S1CLCSC3D>& out, const View::View<Tin, View::DCCSC3D>& in)
{
    // dense transpose
    assert(out.size() == in.size());
    // perm = [1, 2, 0]
