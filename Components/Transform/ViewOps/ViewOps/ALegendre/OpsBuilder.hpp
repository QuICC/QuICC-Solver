...
struct HelperBuilderLlm1
{
   void compute(Tview opView, const Internal::Array& igrid,
      const Internal::Array& iweights)
   {
      builderLlm1<Tview, TPolyBuilder, Tdata>(opView, igrid, iweights);
   }
};
...
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::Plm,
...
/// @tparam VOP operator view type
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR> struct OpsBuilderMap<VOP, Ll_t, DIR>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::Plm,
...
/// @tparam VOP operator view type
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR> struct OpsBuilderMap<VOP, LlD1_t, DIR>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::dPlm,
      ::QuICC::Internal::Array::Scalar, 1>;
};
...
{
   using type = HelperBuilderLlm1<VOP, ::QuICC::Polynomial::ALegendre::dPlm,
      ::QuICC::Internal::Array::Scalar>;
};

/// @brief DivS1 Builder
/// @tparam VOP operator view type
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR> struct OpsBuilderMap<VOP, DivS1_t, DIR>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::sin_1Plm,
      ::QuICC::Internal::Array::Scalar, 0>;
};
...
/// @tparam VOP operator view type
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR> struct OpsBuilderMap<VOP, LlDivS1_t, DIR>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::sin_1Plm,
      ::QuICC::Internal::Array::Scalar, 1>;
};
...
/// @brief Llm1DivS1 Builder
/// @tparam VOP operator view type
/// @tparam DIR fwd_t or bwd_t
template <class VOP, class DIR> struct OpsBuilderMap<VOP, Llm1DivS1_t, DIR>
{
   using type = HelperBuilderLlm1<VOP, ::QuICC::Polynomial::ALegendre::sin_1Plm,
      ::QuICC::Internal::Array::Scalar>;
};
...
{
   using type = OpsBuilder<VOP, Llm1DivS1_t, DIR>;
};

/// @brief Ll2 Builder
/// Integrator only
/// @tparam VOP operator view type
template <class VOP> struct OpsBuilderMap<VOP, Ll2_t, fwd_t>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::Plm,
      ::QuICC::Internal::Array::Scalar, 2>;
};

/// @brief DivLl Builder
/// Integrator only
/// @tparam VOP operator view type
template <class VOP> struct OpsBuilderMap<VOP, DivLl_t, fwd_t>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::Plm,
      ::QuICC::Internal::Array::Scalar, -1>;
};
...
/// Integrator only
/// @tparam VOP operator view type
template <class VOP> struct OpsBuilderMap<VOP, DivLlD1_t, fwd_t>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::dPlm,
      ::QuICC::Internal::Array::Scalar, -1>;
};
...
/// Integrator only
/// @tparam VOP operator view type
template <class VOP> struct OpsBuilderMap<VOP, DivLlDivS1_t, fwd_t>
{
   using type = HelperBuilder<VOP, ::QuICC::Polynomial::ALegendre::sin_1Plm,
      ::QuICC::Internal::Array::Scalar, -1>;
};
...
/// Integrator only
/// @tparam VOP operator view type
template <class VOP> struct OpsBuilderMap<VOP, DivLlDivS1Dp_t, fwd_t>
{
