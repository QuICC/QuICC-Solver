...
class DOp : public UnaryBaseOp<DOp<Tout, Tin, Backend>, Tout, Tin> {
public:
...
private:
    ...
    std::unique_ptr<UnaryOp<Tin, Tin>> mOp;
    /// @brief give access to base class
    friend UnaryBaseOp<DOp<Tout, Tin, Backend>, Tout, Tin>;
};
