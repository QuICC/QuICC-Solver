...
TEST_CASE("Mpi S1CLCSC3DJIK to DCCSC3DJIK 201",
   "MpiS1CLCSC3DJIKtoDCCSC3D201JIK")
{
   int rank, ranks;
   MPI_Comm_rank(MPI_COMM_WORLD, &rank);
   MPI_Comm_size(MPI_COMM_WORLD, &ranks);
...
TEST_CASE("Mpi DCCSC3DJIK to S1CLCSC3DJIK 120",
   "MpiDCCSC3DJIKtoS1CLCSC3DJIK120")
{
   int rank, ranks;
   MPI_Comm_rank(MPI_COMM_WORLD, &rank);
   MPI_Comm_size(MPI_COMM_WORLD, &ranks);
...
TEST_CASE("Mpi DCCSC3D l-ordering to DCCSC3D m-ordering", "MpiDCCSC3DltoDCCSC3Dm")
{
   int rank, ranks;
   MPI_Comm_rank(MPI_COMM_WORLD, &rank);
   MPI_Comm_size(MPI_COMM_WORLD, &ranks);
