...
TEST_CASE("Serial DCCSC3D to DCCSC3DJIK 210", "SerialDCCSC3DtoDCCSC3DJIK210")
{
...
TEST_CASE("Serial DCCSC3DJIK to DCCSC3D 120", "SerialDCCSC3DJIKtoDCCSC3D120")
{
    // AL out -> FFT in, gpu backend
    // Full data and type
    constexpr size_t M = 4;
    constexpr size_t N = 2;
    constexpr size_t K = 2;
...
TEST_CASE("Serial S1CLCSC3DJIK to DCCSC3DJIK 210", "SerialS1CLCSC3DJIKtoDCCSC3DJIK210")
{
...
TEST_CASE("Serial DCCSC3DJIK to S1CLCSC3DJIK 120", "SerialDCCSC3DJIKtoS1CLCSC3DJIK120")
{
    // JW out -> AL in, gpu backend
    // Full data and type
    constexpr size_t M = 4;
    constexpr size_t N = 2;
    constexpr size_t K = 3;
