...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_RADIALPOWERDIVY1_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_RADIALPOWERDIVY1_BASE_HPP
...
template <typename Impl> class RadialPowerDivY1;

/**
 * @brief Implementation of the Chebyshev based 1/Y^1 radial power reductor,
 * with linear map y = ax + b
 */
template <> class RadialPowerDivY1<base_t> : public ILinearMapRadialPower
{
public:
   /**
    * @brief Constructor
    */
   RadialPowerDivY1() = default;
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_RADIALPOWERDIVY1_BASE_HPP
