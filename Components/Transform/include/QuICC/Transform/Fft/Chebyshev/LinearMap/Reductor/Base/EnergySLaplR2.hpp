 ...
 * @brief Implementation of the Chebyshev based r^2 spherical laplacian energy
 * reductor, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_ENERGYSLAPLR2_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_ENERGYSLAPLR2_BASE_HPP
...
template <typename Impl> class EnergySLaplR2;

/**
 * @brief Implementation of the Chebyshev based r^2 spherical laplacian energy
 * reductor, with linear map y = ax + b
 */
template <> class EnergySLaplR2<base_t> : public ILinearMapEnergy
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_ENERGYSLAPLR2_BASE_HPP
