...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1_HPP
...
namespace Projector {
    ...
    * @brief Implementation of the Chebyshev based D projector, with linear map y = ax + b
    */ 
   class D1: public IChebyshevProjector
   {
      public:
         /**
          * @brief Constructor
