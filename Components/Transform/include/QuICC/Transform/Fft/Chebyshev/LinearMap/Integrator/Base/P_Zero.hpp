...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_P_ZERO_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_P_ZERO_HPP
...
namespace Integrator {
   ...
   template <typename Impl> class P_Zero;

   /**
    * @brief Implementation of the Chebyshev based P integrator, with linear map y = ax + b
    */
   template <>
   class P_Zero<base_t>: public ILinearMapIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_P_ZERO_HPP
