/** 
 * @file D3.hpp
 * @brief Implementation of the Chebyshev based D^3 projector, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D3_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D3_HPP
...
namespace Projector {
    ...
    * @brief Implementation of the Chebyshev based D^3 projector, with linear map y = ax + b
    */ 
   class D3: public IChebyshevProjector
   {
      public:
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D3_HPP
