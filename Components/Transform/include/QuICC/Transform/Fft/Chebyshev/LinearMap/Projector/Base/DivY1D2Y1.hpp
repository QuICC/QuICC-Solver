...
template <typename Impl> class DivY1D2Y1;
   ...
   template <> class DivY1D2Y1<base_t> : public ILinearMapProjector
   {
      ...
      private:
          ...
          */
         virtual void applyPreOperator(Matrix& tmp, const Eigen::Ref<const Matrix>& in) const override;
          ...
          * @param rOut Output values
          */
         virtual void applyPostOperator(Eigen::Ref<Matrix> rOut) const override;
          ...
          */
         virtual void applyPreOperator(Matrix& tmp, const Eigen::Ref<const MatrixZ>& in, const bool useReal) const override;
          ...
          * @param useReal Real vs Imag flag
          */
         virtual void applyPostOperator(Eigen::Ref<MatrixZ> rOut, const Matrix& tmp,  const bool useReal) const override;
   };
