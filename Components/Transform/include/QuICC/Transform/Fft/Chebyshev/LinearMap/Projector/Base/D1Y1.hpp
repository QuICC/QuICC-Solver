/**
 * @file D1Y1.hpp
 * @brief Implementation of the Chebyshev based D Y projector, with linear map y
 * = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1Y1_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1Y1_BASE_HPP
...
template <typename Impl> class D1Y1;

/**
 * @brief Implementation of the Chebyshev based D Y projector, with linear map y
 * = ax + b
 */
template <> class D1Y1<base_t> : public ILinearMapProjector
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1Y1_BASE_HPP
