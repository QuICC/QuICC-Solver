/**
 * @file D1Y1.hpp
 * @brief Implementation of the Chebyshev based D Y projector, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_BASE_D1Y1_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_BASE_D1Y1_HPP
...
namespace Projector {
    ...
    */
   template <>
   class D1Y1<base_t>: public ILinearMapProjector
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_BASE_D1Y1_HPP
