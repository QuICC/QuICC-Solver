/**
 * @file ILinearMapRadialPower.hpp
 * @brief Interface for a generic Chebyshev FFT based radial power reductor
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_ILINEARMAPRADIALPOWER_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_ILINEARMAPRADIALPOWER_HPP
 ...
 */
class ILinearMapRadialPower : public IChebyshevOperator
{
public:
   /**
    * @brief Constructor
    */
   ILinearMapRadialPower() = default;

   /**
    * @brief Destructor
    */
   virtual ~ILinearMapRadialPower() = default;
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_ILINEARMAPRADIALPOWER_HPP
