...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I4_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I4_HPP
...
namespace Integrator {
    ...
    */
   template <>
   class I4<base_t>: public IChebyshevIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I4_HPP
