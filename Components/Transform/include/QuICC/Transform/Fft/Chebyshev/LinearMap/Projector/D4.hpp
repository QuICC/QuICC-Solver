/** 
 * @file D4.hpp
 * @brief Implementation of the Chebyshev based D^4 projector, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D4_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D4_HPP
...
namespace Projector {
    ...
    * @brief Implementation of the Chebyshev based D^4 projector, with linear map y = ax + b
    */ 
   class D4: public IChebyshevProjector
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D4_HPP
