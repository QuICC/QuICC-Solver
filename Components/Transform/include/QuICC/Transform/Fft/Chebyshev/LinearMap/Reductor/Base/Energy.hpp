...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_BASE_ENERGY_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_BASE_ENERGY_HPP
...
namespace Reductor {
    ...
    */
   template <>
   class Energy<base_t>: public ILinearMapEnergy
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_BASE_ENERGY_HPP
