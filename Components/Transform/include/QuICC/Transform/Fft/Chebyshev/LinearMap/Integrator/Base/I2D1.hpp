/**
 * @file I2D1.hpp
 * @brief Implementation of the Chebyshev based I^2 of D integrator, with linear
 * map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2D1_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2D1_BASE_HPP
...
template <typename Impl> class I2D1;
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2D1_BASE_HPP
