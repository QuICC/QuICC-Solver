/**
 * @file I2Y1_Zero.hpp
 * @brief Implementation of the Chebyshev based I^2 Y of P integrator, but 0 mode is zeroed, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I2Y1_ZERO_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I2Y1_ZERO_HPP
...
namespace Integrator {
   ...
   template <typename Impl> class I2Y1_Zero;

   /**
    * @brief Implementation of the Chebyshev based I^2 Y of P integrator, but 0 mode is zeroed, with linear map y = ax + b
    */
   template <>
   class I2Y1_Zero<base_t>: public IChebyshevIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I2Y1_ZERO_HPP
