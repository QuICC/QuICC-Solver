/**
 * @file I2Y1_Zero.hpp
 * @brief Implementation of the Chebyshev based I^2 Y of P integrator, but 0
 * mode is zeroed, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2Y1_ZERO_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2Y1_ZERO_BASE_HPP
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2Y1_ZERO_BASE_HPP
