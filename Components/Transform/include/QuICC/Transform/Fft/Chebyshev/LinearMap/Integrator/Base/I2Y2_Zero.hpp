/**
 * @file I2Y2_Zero.hpp
 * @brief Implementation of the Chebyshev based I^2 R^2 of P integrator, but 0
 * mode is zeroed, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2Y2_ZERO_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2Y2_ZERO_BASE_HPP
...
template <typename Impl> class I2Y2_Zero;
 ...
 */
template <>
class I2Y2_Zero<base_t> : public ILinearMapIntegrator
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2Y2_ZERO_BASE_HPP
