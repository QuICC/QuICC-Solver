/**
 * @file P.hpp
 * @brief Implementation of the Chebyshev based P projector, with linear map y =
 * ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_P_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_P_BASE_HPP
 ...
 * ax + b
 */
template <> class P<base_t> : public ILinearMapProjector
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_P_BASE_HPP
