/**
 * @file I2_I2D1.hpp
 * @brief Implementation of the Chebyshev based I^2 of P integrator, but 0 mode is I^2 of D integrator, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I2_I2D1_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I2_I2D1_HPP
...
namespace Integrator {
   ...
   template <typename Impl> class I2_I2D1;

   /**
    * @brief Implementation of the Chebyshev based I^2 of P integrator, but 0 mode is I^2 of D integrator, with linear map y = ax + b
    */
   template <>
   class I2_I2D1<base_t>: public IChebyshevIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_I2_I2D1_HPP
