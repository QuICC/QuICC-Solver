/**
 * @file I2_I2D1.hpp
 * @brief Implementation of the Chebyshev based I^2 of P integrator, but 0 mode
 * is I^2 of D integrator, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2_I2D1_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2_I2D1_BASE_HPP
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2_I2D1_BASE_HPP
