...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1Y1_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1Y1_HPP
...
namespace Projector {
    ...
    * @brief Implementation of the Chebyshev based D Y projector, with linear map y = ax + b
    */ 
   class D1Y1: public IChebyshevProjector
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_D1Y1_HPP
