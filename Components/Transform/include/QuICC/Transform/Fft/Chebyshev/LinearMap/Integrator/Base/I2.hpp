/**
 * @file I2.hpp
 * @brief Implementation of the Chebyshev based I^2 of P integrator, with linear
 * map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2_BASE_HPP
...
template <typename Impl> class I2;
 ...
 */
template <>
class I2<base_t> : public ILinearMapIntegrator
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_I2_BASE_HPP
