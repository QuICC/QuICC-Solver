/**
 * @file DivY2.hpp
 * @brief Implementation of the Chebyshev based 1/Y^2 projector, with linear map
 * y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_DIVY2_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_DIVY2_BASE_HPP
...
template <typename Impl> class DivY2;

/**
 * @brief Implementation of the Chebyshev based 1/Y^2 projector, with y = ax + b
 */
template <> class DivY2<base_t> : public ILinearMapProjector
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_DIVY2_BASE_HPP
