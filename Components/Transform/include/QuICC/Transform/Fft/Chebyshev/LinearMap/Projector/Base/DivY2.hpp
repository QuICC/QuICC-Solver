...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_BASE_DIVY2_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_BASE_DIVY2_HPP
...
namespace Projector {
    ...
    */
   template <>
   class DivY2<base_t>: public ILinearMapProjector
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_BASE_DIVY2_HPP
