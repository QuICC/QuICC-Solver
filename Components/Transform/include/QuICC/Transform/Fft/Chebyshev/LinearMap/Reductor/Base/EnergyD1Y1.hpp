...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_BASE_ENERGYD1Y1_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_BASE_ENERGYD1Y1_HPP
...
namespace Reductor {
    ...
    */
   template <>
   class EnergyD1Y1<base_t>: public ILinearMapEnergy
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_REDUCTOR_BASE_ENERGYD1Y1_HPP
