/**
 * @file I2.hpp
 * @brief Implementation of the Chebyshev based I2 integrator, with linear map y = ax + b
 */
...
#include "QuICC/Transform/Wrappers/Chebyshev/LinearMap/Integrator/I2viewCpu_t.hpp.inc"
#ifdef QUICC_HAS_CUDA_BACKEND
//#include "QuICC/Transform/Wrappers/Chebyshev/LinearMap/Integrator/I2viewGpu_t.hpp.inc"
#endif
