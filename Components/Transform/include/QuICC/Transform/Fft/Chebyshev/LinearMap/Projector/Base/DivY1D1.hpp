/**
 * @file DivY1D1.hpp
 * @brief Implementation of the Chebyshev based 1/Y D projector, with linear map y = ax + b
 */

#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_DIVY1D1_BASE_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_DIVY1D1_BASE_HPP
...
template <typename Impl> class DivY1D1;

   /**
    * @brief Implementation of the Chebyshev based 1/Y D  projector, with linear map y = ax +  b
    */
   template <> class DivY1D1<base_t> : public ILinearMapProjector
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_PROJECTOR_DIVY1D1_BASE_HPP
