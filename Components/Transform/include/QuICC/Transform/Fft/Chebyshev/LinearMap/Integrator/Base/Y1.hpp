...
#ifndef QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_Y1_HPP
#define QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_Y1_HPP
...
namespace Integrator {
   ...
   template <typename Impl> class Y1;

   /**
    * @brief Implementation of the Chebyshev based Y integrator, but 0 mode is zeroed, with linear map y = ax + b
    */
   template <>
   class Y1<base_t>: public IChebyshevIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_CHEBYSHEV_LINEARMAP_INTEGRATOR_BASE_Y1_HPP
