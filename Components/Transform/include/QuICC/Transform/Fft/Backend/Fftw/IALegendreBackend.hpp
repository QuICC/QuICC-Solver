...
#ifndef QUICC_TRANSFORM_FFT_BACKEND_FFTW_IALEGENDREBACKEND_HPP
#define QUICC_TRANSFORM_FFT_BACKEND_FFTW_IALEGENDREBACKEND_HPP
...
namespace Fftw {
    ...
    * @brief Interface for a generic ALegendre FFTW based integrator
    */
   class IALegendreBackend: public IFftwBackend
   {
      public:
