 ...
 * @brief Interface for a generic ALegendre FFTW based projector
 */

#ifndef QUICC_TRANSFORM_FFT_BACKEND_FFTW_ALEGENDREPROJECTOR_HPP
#define QUICC_TRANSFORM_FFT_BACKEND_FFTW_ALEGENDREPROJECTOR_HPP
...
namespace Fftw {
   ...
   class ALegendreProjector: public IALegendreBackend
   {
      public:
          ...
          */
         void backwardALegendre(const bool isEven, const unsigned int id = 0) const;
      ...
      private:
          ...
          */
         void partialBackwardALegendre(const int l, const int i0, const int start, const int cols, const std::vector<Matrix>& banded, Matrix& in) const;
