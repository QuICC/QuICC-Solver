...
#ifndef QUICC_TRANSFORM_FFT_BACKEND_PFSOLVE_ALEGENDREINTEGRATOR_HPP
#define QUICC_TRANSFORM_FFT_BACKEND_PFSOLVE_ALEGENDREINTEGRATOR_HPP
...
public:
   ...
   */
  void forwardALegendre(const bool isEven0, const int id = 0) const;
...
private:
   ...
   */
  void partialForwardALegendre(const int l, const int id, const int i0,
