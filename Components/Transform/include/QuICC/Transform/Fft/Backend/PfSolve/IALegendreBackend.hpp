/**
 * @file IALegendreBackend.hpp
 * @brief Interface for a generic ALegendre PFSOLVE based integrator
 */

#ifndef QUICC_TRANSFORM_FFT_BACKEND_PFSOLVE_IALEGENDREBACKEND_HPP
#define QUICC_TRANSFORM_FFT_BACKEND_PFSOLVE_IALEGENDREBACKEND_HPP
 ...
 * @brief Interface for a generic ALegendre PFSOLVE based integrator
 */
class IALegendreBackend : public IPfSolveBackend {
public:
  /// Typedef for the configuration class
  typedef ALegendre::Setup SetupType;

  /// Typedef for the configuration class as a shared pointer
  typedef ALegendre::SharedSetup SharedSetupType;
...
protected:
  ...
  /**
   * @brief Biggest ALegendre expansion size (ie. l = 0)
   */
  mutable int mWSize;
