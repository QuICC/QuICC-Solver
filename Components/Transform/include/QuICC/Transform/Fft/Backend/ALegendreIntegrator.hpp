 ...
 * @brief Interface for a generic API for ALegendre integrator
 */

#ifndef QUICC_TRANSFORM_FFT_BACKEND_ALEGENDREINTEGRATOR_HPP
#define QUICC_TRANSFORM_FFT_BACKEND_ALEGENDREINTEGRATOR_HPP
...
#endif // QUICC_TRANSFORM_FFT_BACKEND_ALEGENDREINTEGRATOR_HPP
