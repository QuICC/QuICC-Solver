 ...
 * @brief Interface for a generic API for ALegendre projector
 */

#ifndef QUICC_TRANSFORM_FFT_BACKEND_ALEGENDREPROJECTOR_HPP
#define QUICC_TRANSFORM_FFT_BACKEND_ALEGENDREPROJECTOR_HPP
