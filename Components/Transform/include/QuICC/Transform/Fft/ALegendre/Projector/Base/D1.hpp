...
#ifndef QUICC_TRANSFORM_FFT_ALEGENDRE_PROJECTOR_BASE_D1_HPP
#define QUICC_TRANSFORM_FFT_ALEGENDRE_PROJECTOR_BASE_D1_HPP
...
#endif // QUICC_TRANSFORM_FFT_ALegendre_PROJECTOR_BASE_D1_HPP
