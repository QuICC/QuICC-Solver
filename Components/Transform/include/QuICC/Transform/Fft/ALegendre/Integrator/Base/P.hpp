/**
 * @file P.hpp
 * @brief Implementation of the ALegendre based P integrator
 */

#ifndef QUICC_TRANSFORM_FFT_ALEGENDRE_INTEGRATOR_BASE_P_HPP
#define QUICC_TRANSFORM_FFT_ALEGENDRE_INTEGRATOR_BASE_P_HPP
...
#endif // QUICC_TRANSFORM_FFT_ALegendre_INTEGRATOR_BASE_P_HPP
