...
#ifndef QUICC_TRANSFORM_FFT_FOURIER_MIXED_PROJECTOR_D3BASE_HPP
#define QUICC_TRANSFORM_FFT_FOURIER_MIXED_PROJECTOR_D3BASE_HPP
...
#endif // QUICC_TRANSFORM_FFT_FOURIER_MIXED_PROJECTOR_D3BASE_HPP
