...
#ifndef QUICC_TRANSFORM_FFT_FOURIER_COMPLEX_PROJECTOR_D4BASE_HPP
#define QUICC_TRANSFORM_FFT_FOURIER_COMPLEX_PROJECTOR_D4BASE_HPP
...
namespace Projector {
    ...
    */
   template<>
   class D4<base_t>: public IComplexProjector
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_FOURIER_COMPLEX_PROJECTOR_D4BASE_HPP
