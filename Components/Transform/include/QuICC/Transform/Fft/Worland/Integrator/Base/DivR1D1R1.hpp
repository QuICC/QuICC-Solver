...
#ifndef QUICC_TRANSFORM_FFT_WORLAND_INTEGRATOR_BASE_DIVR1D1R1_HPP
#define QUICC_TRANSFORM_FFT_WORLAND_INTEGRATOR_BASE_DIVR1D1R1_HPP
...
namespace Integrator {
    ...
    */
   template <>
   class DivR1D1R1<base_t>: public IWorlandIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_WORLAND_INTEGRATOR_BASE_DIVR1D1R1_HPP
