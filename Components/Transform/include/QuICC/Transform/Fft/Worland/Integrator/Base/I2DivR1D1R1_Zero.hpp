...
#ifndef QUICC_TRANSFORM_FFT_WORLAND_INTEGRATOR_BASE_I2DIVR1D1R1_ZERO_HPP
#define QUICC_TRANSFORM_FFT_WORLAND_INTEGRATOR_BASE_I2DIVR1D1R1_ZERO_HPP
...
namespace Integrator {
    ...
    */
   template <>
   class I2DivR1D1R1_Zero<base_t>: public DivR1D1R1<base_t>
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_WORLAND_INTEGRATOR_BASE_I2DIVR1D1R1_ZERO_HPP
