...
#ifndef QUICC_TRANSFORM_FFT_WORLAND_REDUCTOR_BASE_POWERR2_HPP
#define QUICC_TRANSFORM_FFT_WORLAND_REDUCTOR_BASE_POWERR2_HPP
...
namespace Reductor {
    ...
    */
   template <>
   class PowerR2<base_t>: public IEnergyWrapper<Poly::Worland::Reductor::PowerR2<Poly::Worland::base_t>>
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_FFT_WORLAND_REDUCTOR_BASE_POWERR2_HPP
