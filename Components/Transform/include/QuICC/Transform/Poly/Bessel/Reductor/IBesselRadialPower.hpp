/**
 * @file IBesselRadialPower.hpp
 * @brief Interface for a Bessel based power operator on radial grid
 */

#ifndef QUICC_TRANSFORM_POLY_BESSEL_REDUCTOR_IBESSELRADIALPOWER_HPP
#define QUICC_TRANSFORM_POLY_BESSEL_REDUCTOR_IBESSELRADIALPOWER_HPP
...
namespace Reductor {
    ...
    */
   class IBesselRadialPower: public IBesselReductor
   {
      public:
         /**
          * @brief Constructor
          ...
          * @brief Destructor
          */
         virtual ~IBesselRadialPower() = default;
...
#endif // QUICC_TRANSFORM_POLY_BESSEL_REDUCTOR_IBESSELRADIALPOWER_HPP
