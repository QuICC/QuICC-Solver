 ...
 * @brief Interface for a spherical Bessel based operator
 */

#ifndef QUICC_TRANSFORM_POLY_BESSEL_IBESSELPERATOR_HPP
#define QUICC_TRANSFORM_POLY_BESSEL_IBESSELPERATOR_HPP
...
namespace Bessel {
    ...
    * @brief Interface for a spherical Bessel based operator
    */
   class IBesselOperator: public ITransformOperator
   {
      public:
...
#endif // QUICC_TRANSFORM_POLY_BESSEL_IBESSELPERATOR_HPP
