/**
 * @file IBesselIntegrator.hpp
 * @brief Interface for a spherical Bessel based integrator
 */

#ifndef QUICC_TRANSFORM_POLY_BESSEL_INTEGRATOR_IBESSELINTEGRATOR_HPP
#define QUICC_TRANSFORM_POLY_BESSEL_INTEGRATOR_IBESSELINTEGRATOR_HPP
...
namespace Integrator {
   ...
   /**
    * @brief Interface for a sphericla Bessel based integrator
    */
   class IBesselIntegrator: public IBesselOperator
   {
      public:
          ...
          * @brief Destructor
          */
         virtual ~IBesselIntegrator() = default;
...
#endif // QUICC_TRANSFORM_POLY_BESSEL_IBESSELINTEGRATOR_HPP
