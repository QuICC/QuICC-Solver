...
#ifndef QUICC_TRANSFORM_POLY_BESSEL_PROJECTOR_BASE_VALUE_HPP
#define QUICC_TRANSFORM_POLY_BESSEL_PROJECTOR_BASE_VALUE_HPP
...
namespace Projector {
   ...
   template <typename TOp> void Value<TOp>::makeOperator(Matrix& op, const Internal::Array& igrid, const Internal::Array& iweights, const int i) const
   {
...
#endif // QUICC_TRANSFORM_POLY_BESSEL_PROJECTOR_BASE_VALUE_HPP
