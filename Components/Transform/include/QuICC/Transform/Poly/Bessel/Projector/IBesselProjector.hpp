/**
 * @file IBesselProjector.hpp
 * @brief Interface for a spherical Bessel based projector
 */

#ifndef QUICC_TRANSFORM_POLY_BESSEL_PROJECTOR_IBESSELPROJECTOR_HPP
#define QUICC_TRANSFORM_POLY_BESSEL_PROJECTOR_IBESSELPROJECTOR_HPP
...
namespace Projector {
    ...
    * @brief Interface for a spherical Bessel based projector
    */
   class IBesselProjector: public IBesselOperator
   {
      public:
          ...
          * @brief Destructor
          */
         virtual ~IBesselProjector() = default;
...
#endif // QUICC_TRANSFORM_POLY_BESSEL_PROJECTOR_IBESSELPROJECTOR_HPP
