...
#ifndef QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_BASE_DIVR1_ZERO_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_BASE_DIVR1_ZERO_HPP
...
namespace Integrator {
    ...
    */
   template <>
   class DivR1_Zero<base_t>: public IWorlandIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_BASE_DIVR1_ZERO_HPP
