...
#ifndef QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_DIVR1_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_DIVR1_HPP
...
namespace Integrator {
    ...
    * @brief Implementation of the Worland based 1/R1 integrator
    */ 
   class DivR1: public IWorlandIntegrator
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_DIVR1_HPP
