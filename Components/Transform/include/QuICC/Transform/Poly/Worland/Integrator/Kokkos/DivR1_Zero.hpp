/**
 * @file DivR1_Zero.hpp
 * @brief Implementation of the Worland based parallel DivR1 integrator
 */

#ifndef QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_KOKKOS_DIVR1_ZERO_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_KOKKOS_DIVR1_ZERO_HPP
 ...
 */
template <> class DivR1_Zero<kokkos_t> : public KokkosIWorlandIntegrator
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_PDIVR1_ZERO_HPP
