 ...
 * @brief Implementation of the Worland based parallel I4 1/R1 D R1 integrator
 * but 0 mode is zeroed
 */

#ifndef QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_KOKKOS_I4DIVR1D1R1_ZERO_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_KOKKOS_I4DIVR1D1R1_ZERO_HPP
...
template <class Impl> class I4DivR1D1R1_Zero;
/**
 * @brief Implementation of the Worland based I4 1/R1 D R1 integrator but 0 mode
 * is zeroed
 */
template <> class I4DivR1D1R1_Zero<kokkos_t> : public KokkosIWorlandIntegrator
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_PI4DIVR1D1R1_ZERO_HPP
