/**
 * @file I2.hpp
 * @brief Implementation of the Worland based parallel I2 integrator
 */

#ifndef QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_KOKKOS_I2_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_KOKKOS_I2_HPP
...
template <class Impl> class I2;

/**
 * @brief Implementation of the associated Worland based I2 integrator but 0
 * mode is zeroed.
 */
template <> class I2<kokkos_t> : public KokkosIWorlandIntegrator
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_TRANSFORM_POLY_WORLAND_INTEGRATOR_PI2_HPP
