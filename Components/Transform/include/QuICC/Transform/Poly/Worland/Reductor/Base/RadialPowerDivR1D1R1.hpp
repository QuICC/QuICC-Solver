...
#ifndef QUICC_TRANSFORM_POLY_WORLAND_REDUCTOR_BASE_RADIALPOWERDIVR1D1R1_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_REDUCTOR_BASE_RADIALPOWERDIVR1D1R1_HPP
...
namespace Reductor {
   ...
   template <class Impl>
   class RadialPowerDivR1D1R1;

   /**
    * @brief Implementation of the Worland based 1/R D R power spectrum operator on radial grid
    */
   template <>
   class RadialPowerDivR1D1R1<base_t>: public IWorlandRadialPower
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_POLY_WORLAND_REDUCTOR_BASE_RADIALPOWERDIVR1D1R1_HPP
