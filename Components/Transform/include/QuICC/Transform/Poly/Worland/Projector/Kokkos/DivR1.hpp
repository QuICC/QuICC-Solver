...
#ifndef QUICC_TRANSFORM_POLY_WORLAND_PROJECTOR_KOKKOS_DIVR1_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_PROJECTOR_KOKKOS_DIVR1_HPP
...
template <class Impl> class DivR1;
/**
 * @brief Implementation of the associated Worland based D projector
 */
template <> class DivR1<kokkos_t> : public KokkosIWorlandProjector
{
public:
   /**
    * @brief Constructor
