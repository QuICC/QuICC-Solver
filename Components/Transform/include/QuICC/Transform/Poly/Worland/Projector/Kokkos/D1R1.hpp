...
#ifndef QUICC_TRANSFORM_POLY_WORLAND_PROJECTOR_KOKKOS_D1R1_HPP
#define QUICC_TRANSFORM_POLY_WORLAND_PROJECTOR_KOKKOS_D1R1_HPP
...
template <class Impl> class D1R1;
/**
 * @brief Implementation of the associated Worland based D projector
 */
template <> class D1R1<kokkos_t> : public KokkosIWorlandProjector
{
public:
   /**
    * @brief Constructor
