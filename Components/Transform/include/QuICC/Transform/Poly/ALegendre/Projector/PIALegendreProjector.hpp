...
#ifndef QUICC_TRANSFORM_POLY_ALEGENDRE_PROJECTOR_PIALEGENDREPROJECTOR_HPP
#define QUICC_TRANSFORM_POLY_ALEGENDRE_PROJECTOR_PIALEGENDREPROJECTOR_HPP
...
namespace Projector {
   ...
   class PIALegendreProjector: public IALegendreProjector<OpTypes>
   /* class PIALegendreProjector: public IALegendreOperator<OpTypes> */
   {
      public:
          ...
          * @brief Constructor
          */
         PIALegendreProjector();

         /**
          * @brief Destructor
          */
         virtual ~PIALegendreProjector();
