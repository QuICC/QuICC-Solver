...
#ifndef QUICC_TRANSFORM_POLY_ALEGENDRE_PROJECTOR_BASE_D1DIVS1_HPP
#define QUICC_TRANSFORM_POLY_ALEGENDRE_PROJECTOR_BASE_D1DIVS1_HPP
...
namespace Projector {
    ...
    */
   template <>
   class D1DivS1<base_t>: public IALegendreProjector
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_TRANSFORM_POLY_ALEGENDRE_PROJECTOR_BASE_D1DIVS1_HPP
