/**
 * @file PDivLlDivS1.hpp
 * @brief Implementation of the associated Legendre based 1/l(l+1) 1/Sin parallel integrator
 */

#ifndef QUICC_TRANSFORM_POLY_ALEGENDRE_INTEGRATOR_PDIVLLDIVS1_HPP
#define QUICC_TRANSFORM_POLY_ALEGENDRE_INTEGRATOR_PDIVLLDIVS1_HPP
...
namespace Integrator {
   ...
   class PDivLlDivS1: public PDivS1<OpTypes>
   {
      public:
