...
#ifndef QUICC_TRANSFORM_POLY_ALEGENDRE_INTEGRATOR_PP_HPP
#define QUICC_TRANSFORM_POLY_ALEGENDRE_INTEGRATOR_PP_HPP
...
namespace Integrator {
   ...
   class PP: public PIALegendreIntegrator<OpTypes>
   {
      public:
