...
#ifndef QUICC_TRANSFORM_POLY_ALEGENDRE_INTEGRATOR_PDIVS1_HPP
#define QUICC_TRANSFORM_POLY_ALEGENDRE_INTEGRATOR_PDIVS1_HPP
...
namespace Integrator {
   ...
   class PDivS1: public PIALegendreIntegrator<OpTypes>
   {
      public:
