/**
 * @file IntegralR2.hpp
 * @brief Implementation of integral r^2 operator
 */

#ifndef QUICC_FINITEDIFF_SPHERE_INTEGRALR2_HPP
#define QUICC_FINITEDIFF_SPHERE_INTEGRALR2_HPP
...
namespace Sphere {
    ...
    * @brief Implementation of integral r^2 operator
    */
   class IntegralR2: public Operator
   {
      public:
         /**
          * @brief Constructor
          */
         IntegralR2(const size_t order);
   ...
   template <typename T>
   void IntegralR2::compute(Eigen::Ref<Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> > rOut, const int l, const Internal::Array& igrid)
   {
      ...
      integral.array() *= igrid.array().pow(2);
...
#endif // QUICC_FINITEDIFF_SPHERE_INTEGRALR2_HPP
