...
#ifndef QUICC_TIMESTEP_PREDICTORCORRECTOR_VIEWS_TIMESTEPSOLVERCOORDINATOR_HPP
#define QUICC_TIMESTEP_PREDICTORCORRECTOR_VIEWS_TIMESTEPSOLVERCOORDINATOR_HPP
...
#include "Timestep/PredictorCorrector/Views/SparseLinearCoordinatorBase.hpp"
...
class TimestepSolverCoordinator
    : public SparseLinearCoordinatorBase<TSolver>
{
public:
   /**
    * @brief Constructor
...
private:
   using SparseLinearCoordinatorBase<TSolver>::init;
...
#endif // QUICC_TIMESTEP_PREDICTORCORRECTOR_VIEWS_TIMESTEPSOLVERCOORDINATOR_HPP
