/**
 * @file WorlandLegendreRuleTest.cpp
 * @brief Tests for the Worland Legendre quadrature rule
 */
...
TEST_CASE( "Error for Worland-Legendre quadrature rule", "[WorlandLegendreRule]" ){
   ...
   typedef ::QuICC::Polynomial::Quadrature::WorlandLegendreRule QuadratureType;
   typedef typename currentts::Tester<QuadratureType> Tester;

   Tester tester("worlandlegendre.dat", currentts::args().dumpData);
