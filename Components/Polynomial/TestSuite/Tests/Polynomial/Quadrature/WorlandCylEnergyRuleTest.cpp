 ...
 * @brief Tests for the Worland cylindrical energy quadrature rule
 */
...
TEST_CASE( "Error for Worland-Cylindrical energy quadrature rule", "[WorlandCylEnergyRule]" ){
   ...
   typedef ::QuICC::Polynomial::Quadrature::WorlandCylEnergyRule QuadratureType;
   typedef typename currentts::Tester<QuadratureType> Tester;

   Tester tester("worlandcylenergy.dat", currentts::args().dumpData);
