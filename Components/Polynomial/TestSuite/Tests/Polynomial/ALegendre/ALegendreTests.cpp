/**
 * @file ALegendreTests.cpp
 * @brief Catch2 tests driver for the ALegendre operators
 */
...
namespace test = QuICC::TestSuite::Polynomial::ALegendre;
...
int main( int argc, char* argv[] )
{
   ...
   auto cli
      ...
      | Opt( test::args().params, "harmonicM" )  // Add harmonic order option
         ["--harmonicM"]
         ("Harmonic order M")
