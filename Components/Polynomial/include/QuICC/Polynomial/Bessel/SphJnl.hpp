...
namespace Bessel {
   ...
   template <typename T> inline void SphJnl::compute(Eigen::Ref<Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> > rOut, const std::vector<Internal::MHDFloat>& roots, const int l, const Internal::Array& igrid, const Internal::Array& scale)
   {
      ...
      for(int j = 0; j < nPoly; j++)
      {
         ...
         {
            rOut(i,j) = details::SphJnl(k, l, igrid(i));
         }
