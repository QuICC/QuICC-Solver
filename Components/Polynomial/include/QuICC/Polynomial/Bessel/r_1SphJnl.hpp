...
namespace Bessel {
   ...
   template <typename T> inline void r_1SphJnl::compute(Eigen::Ref<Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> > rOut, const std::vector<Internal::MHDFloat>& roots, const int l, const Internal::Array& igrid, const Internal::Array& scale, const Internal::MHDFloat dNu)
   {
      ...
      for(int j = 0; j < nPoly; j++)
      {
         ...
         {
            col(i) = details::r_1SphJnl(k, l, igrid(i), dNu);
         }
