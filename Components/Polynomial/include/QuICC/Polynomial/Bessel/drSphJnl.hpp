...
#ifndef QUICC_POLYNOMIAL_BESSEL_DRSPHJNL_HPP
#define QUICC_POLYNOMIAL_BESSEL_DRSPHJNL_HPP
...
namespace Bessel {
   ...
   template <typename T> inline void drSphJnl::compute(Eigen::Ref<Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> > rOut, const std::vector<Internal::MHDFloat>& roots, const int l, const Internal::Array& igrid, const Internal::Array& scale, const Internal::MHDFloat dNu)
   {
      ...
      for(int j = 0; j < nPoly; j++)
      {
         ...
         {
            col(i) = details::drSphJnl(k, l, igrid(i), dNu);
         }
...
#endif // QUICC_POLYNOMIAL_BESSEL_DRSPHJNL_HPP
