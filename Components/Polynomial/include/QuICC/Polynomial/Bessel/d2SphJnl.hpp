...
#ifndef QUICC_POLYNOMIAL_BESSEL_D2SPHJNL_HPP
#define QUICC_POLYNOMIAL_BESSEL_D2SPHJNL_HPP
   ...
   const Internal::MHDFloat dNu)
{
   ...
   for (int j = 0; j < nPoly; j++)
   {
      ...
      {
         col(i) = SphericalBessel::d2SphJnl(k, l, igrid(i), dNu);
      }
...
#endif // QUICC_POLYNOMIAL_BESSEL_D2SPHJNL_HPP
