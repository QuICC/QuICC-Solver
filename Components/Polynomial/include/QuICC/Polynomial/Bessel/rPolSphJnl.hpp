...
#ifndef QUICC_POLYNOMIAL_BESSEL_RPOLSPHJNL_HPP
#define QUICC_POLYNOMIAL_BESSEL_RPOLSPHJNL_HPP
...
namespace Bessel {
   ...
   template <typename T> inline void rPolSphJnl::compute(Eigen::Ref<Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> > rOut, const int nPoly, const int lIn, const Internal::Array& igrid, const Internal::Array& scale)
   {
...
#endif // QUICC_POLYNOMIAL_BESSEL_RPOLSPHJNL_HPP
