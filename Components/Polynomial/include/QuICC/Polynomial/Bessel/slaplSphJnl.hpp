/**
 * @file slaplSphJnl.hpp
 * @brief Implementation of the spherical Bessel basis
 */

#ifndef QUICC_POLYNOMIAL_BESSEL_SLAPLSPHJNL_HPP
#define QUICC_POLYNOMIAL_BESSEL_SLAPLSPHJNL_HPP
...
namespace Bessel {
   ...
   template <typename T> inline void slaplSphJnl::compute(Eigen::Ref<Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> > rOut, const std::vector<Internal::MHDFloat>& roots, const int l, const Internal::Array& igrid, const Internal::Array& scale)
   {
      ...
      for(int j = 0; j < nPoly; j++)
      {
         ...
         {
            rOut(i,j) = details::slaplSphJnl(k, l, igrid(i));
         }
