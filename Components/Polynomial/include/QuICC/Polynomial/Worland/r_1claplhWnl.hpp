/** 
 * @file r_1claplhWnl.hpp
 * @brief Implementation of the 1/r cylindrical laplacian Worland polynomial
 */
...
namespace Worland {
   ...
   template <typename T, typename TEvaluator> void r_1claplhWnl::compute(Eigen::Ref<Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> > rOut, const int nPoly, const int l, const internal::Array& igrid, const internal::Array& scale, TEvaluator evaluator)
   {
      ...
      if(l < 0)
      {
         throw std::logic_error("Tried to compute Worland 1/r cylindrical laplacian with l < 0");
      }
...
#endif // QUICC_POLYNOMIAL_WORLAND_R_1CLAPLHWNL_HPP
