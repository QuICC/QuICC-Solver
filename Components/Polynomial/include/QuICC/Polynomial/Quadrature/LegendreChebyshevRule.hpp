/**
 * @file LegendreChebyshevRule.hpp
 * @brief Implementation of a Legendre quadrature rule
 */

#ifndef QUICC_POLYNOMIAL_QUADRATURE_LEGENDRECHEBYSHEVRULE_HPP
#define QUICC_POLYNOMIAL_QUADRATURE_LEGENDRECHEBYSHEVRULE_HPP
...
namespace Quadrature {
    ...
    * @brief Implementation of a Legendre quadrature rule
    */
   class LegendreChebyshevRule: public PrueferAlgorithm
   {
      public:
         /**
