...
#ifndef QUICC_POLYNOMIAL_JACOBI_EVALUATOR_OUTERPRODUCT_HPP
#define QUICC_POLYNOMIAL_JACOBI_EVALUATOR_OUTERPRODUCT_HPP
...
#endif // QUICC_POLYNOMIAL_JACOBI_EVALUATOR_OUTERPRODUCT_HPP
