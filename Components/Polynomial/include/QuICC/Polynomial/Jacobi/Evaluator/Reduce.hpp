...
#ifndef QUICC_POLYNOMIAL_JACOBI_EVALUATOR_REDUCE_HPP
#define QUICC_POLYNOMIAL_JACOBI_EVALUATOR_REDUCE_HPP
...
#endif // QUICC_POLYNOMIAL_JACOBI_EVALUATOR_REDUCE_HPP
