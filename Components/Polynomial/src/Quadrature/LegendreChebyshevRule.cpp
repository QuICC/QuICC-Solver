/**
 * @file LegendreChebyshevRule.cpp
...
namespace Quadrature {
   void LegendreChebyshevRule::computeQuadrature(Internal::Array& igrid, Internal::Array& iweights, const int size)
   {
   ...
   void LegendreChebyshevRule::computeQuadrature2(Internal::Array& igrid, Internal::Array& iweights, const int size)
   {
      // Internal grid and weights arrays
      igrid.resize(size);
      igrid.setZero();
   ...
   Internal::MHDLong   LegendreChebyshevRule::p(const Internal::MHDLong xi, const int diff)
   {
      // Safety asserts
      assert(diff >= 0);
   ...
   Internal::MHDLong   LegendreChebyshevRule::q(const Internal::MHDLong xi, const int diff)
   {
      // Safety asserts
      assert(diff >= 0);
   ...
   Internal::MHDLong   LegendreChebyshevRule::r(const int size, const int diff)
   {
      // Safety asserts
      assert(diff >= 0);
   ...
   Internal::MHDLong LegendreChebyshevRule::estimateNode(const int k, const int size)
   {
   ...
   Internal::MHDLong LegendreChebyshevRule::zeroPoly(const int size)
   {
   ...
   Internal::MHDLong LegendreChebyshevRule::zeroDiff(const int size)
   {
      // Initialise start value of recurrence
      Internal::MHDLong p = MHD_MP_LONG(1.0);
