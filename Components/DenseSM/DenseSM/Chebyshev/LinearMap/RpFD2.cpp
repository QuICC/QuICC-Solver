...
// Project includes
//
#include "DenseSM/Chebyshev/LinearMap/RpFD2.hpp"
...
RpFD2::RpFD2(const int nNr, const int nNc, const int p, const int lOut,
...
void RpFD2::buildOpImpl(Internal::Matrix& mat, const int rows,
   const int cols) const
{
   ...
   td2B = f.cast<MHDFloat>().asDiagonal() * td2B;

   tA = Utils::computeExpansion(td2B, this->rows(), lb, ub);
