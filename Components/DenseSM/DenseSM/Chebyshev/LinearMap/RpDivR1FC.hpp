/**
 * @file RpDivR1FC.hpp
 * @brief Implementation of the spectral operator r^p 1/r f (-lapl(*))
 *        multiplied by elsasser coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1FC_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1FC_HPP
 ...
 * @brief Implementation of the spectral operator r^p 1/r f (-lapl(*))
 */
class RpDivR1FC : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   RpDivR1FC(const int rows, const int cols, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1FC_HPP
