/**
 * @file IqRpDivR1D1FC.hpp
 * @brief Implementation of the spectral operator I^q r^p 1/r D(f (-lapl(*)))
 *        multiplied by gaunt coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1DFC_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1DFC_HPP
 ...
 * @brief Implementation of the spectral operator I^q r^p 1/r D(f (-lapl(*)))
 */
class IqRpDivR1D1FC : public IIqTripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   IqRpDivR1D1FC(const int rows, const int cols, const int q, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1DFC_HPP
