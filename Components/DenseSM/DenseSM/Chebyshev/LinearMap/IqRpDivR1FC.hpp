/**
 * @file IqRpDivR1FC.hpp
 * @brief Implementation of the spectral operator I^q r^p 1/r f (-lapl(*))
 *        multiplied by elsasser coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1FC_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1FC_HPP
 ...
 * @brief Implementation of the spectral operator I^q r^p 1/r f (-lapl(*))
 */
class IqRpDivR1FC : public IIqTripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   IqRpDivR1FC(const int rows, const int cols, const int q, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1FC_HPP
