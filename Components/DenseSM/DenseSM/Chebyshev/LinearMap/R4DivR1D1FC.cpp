/**
 * @file R4DivR1D1FC.cpp
 * @brief Source of the implementation of the spectral operator r^4 1/r D(f (-lapl(*)))
 */
...
R4DivR1D1FC::R4DivR1D1FC(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
...
void R4DivR1D1FC::buildOpImpl(Internal::Matrix& mat, const int rows,
