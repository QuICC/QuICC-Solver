...
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_PROJCURLTORCROSSPOL_HPP
...
public:
    ...
    */
   ProjCurlTorCrossPol(const int rows, const int cols, const int q, const int p,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_PROJCURLTORCROSSPOL_HPP
