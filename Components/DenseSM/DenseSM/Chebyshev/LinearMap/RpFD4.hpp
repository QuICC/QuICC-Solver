 ...
 */
 ...
 #ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD4_HPP
 #define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD4_HPP
  ...
  * @brief Implementation of the spectral operator r^p f D4( * )
  */
 class RpFD4 : public ITripleHarmonicOperator
 {
 public:
    /**
     * @brief Constructor
 ...
 #endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD4_HPP
