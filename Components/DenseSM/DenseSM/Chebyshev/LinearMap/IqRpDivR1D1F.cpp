...
IqRpDivR1D1F::IqRpDivR1D1F(const int nNr, const int nNc, const int q, const int p, const int lOut,
   ...
   const int cols) const
{
   ...
   tf =
      (-(this->mP-1)*f.array()*r.array().pow(this->mP-2))
         .cast<MHDFloat>();
