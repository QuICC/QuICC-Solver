 ...
 * 
 * Modified from R2DivR1F.cpp which does r^2 f/r = r f
 */
...
// Project includes
//
#include "DenseSM/Chebyshev/LinearMap/R2DivR2F.hpp"
...
R2DivR2F::R2DivR2F(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
...
void R2DivR2F::buildOpImpl(Internal::Matrix& mat, const int rows,
   const int cols) const
{
   ...
   // Probably a +2 below can become a +1
