/**
 * @file RpFD3.cpp
 * @brief Source of the implementation of the spectral operator r^p f D3(*)
 */
...
// Project includes
//
#include "DenseSM/Chebyshev/LinearMap/RpFD3.hpp"
...
RpFD3::RpFD3(const int nNr, const int nNc, const int p, const int lOut,
...
void RpFD3::buildOpImpl(Internal::Matrix& mat, const int rows,
   const int cols) const
{
   ...
   td3B = f.cast<MHDFloat>().asDiagonal() * td3B;

   tA = Utils::computeExpansion(td3B, this->rows(), lb, ub);
