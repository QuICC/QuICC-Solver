/**
 * @file IqRpDivR2FD1R1.hpp
 * @brief Implementation of the spectral operator I^q r^p 1/I^q r^p f D(r *)
 *        multiplied by gaunt coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR2FD1R1_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR2FD1R1_HPP
...
/**
 * @brief Implementation of the spectral operator I^q r^p f D(r *)
 */
class IqRpDivR2FD1R1 : public IIqTripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   IqRpDivR2FD1R1(const int rows, const int cols, const int q, const int p, const int lOut, const int mOut,
    ...
    * @brief Destructor
    */
   virtual ~IqRpDivR2FD1R1() = default;
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR2FD1R1_HPP
