/**
 * @file R0F.hpp
 * @brief Implementation of the spectral operator f *
 *        multiplied by elsasser coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_R0F_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_R0F_HPP
 ...
 * @brief Implementation of the spectral operator f *
 */
class R0F : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   R0F(const int rows, const int cols, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_R0F_HPP
