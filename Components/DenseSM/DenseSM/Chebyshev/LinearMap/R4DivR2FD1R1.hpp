...
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_R4DIVR2FD1R1_HPP
...
/**
 * @brief Implementation of the spectral operator r^4 f D(r *)
 */
class R4DivR2FD1R1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   R4DivR2FD1R1(const int rows, const int cols, const int lOut, const int lF, const int lIn, std::shared_ptr<RadialTorPolFunction> pF, const Scalar_t lower,
      const Scalar_t upper);

   /**
    * @brief Destructor
    */
   virtual ~R4DivR2FD1R1() = default;
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_R4DIVR2FD1R1_HPP
