/**
 * @file R4DivR2D1R1F.cpp
 * @brief Source of the implementation of the spectral operator r^4 1/r^2 D(r f) *
 */
...
R4DivR2D1R1F::R4DivR2D1R1F(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
...
void R4DivR2D1R1F::buildOpImpl(Internal::Matrix& mat, const int rows,
   const int cols) const
{
   ...
   fA = igrid.array().pow(2).cast<MHDFloat>().matrix().asDiagonal()*fA;
