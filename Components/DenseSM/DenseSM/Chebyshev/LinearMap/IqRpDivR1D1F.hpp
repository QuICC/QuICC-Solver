/**
 * @file IqRpDivR1D1F.hpp
 * @brief Implementation of the spectral operator I^q r^p 1/r D(f *)
 *        multiplied by gaunt coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1D1F_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1D1F_HPP
 ...
 * @brief Implementation of the spectral operator I^q r^p 1/r D(f *)
 */
class IqRpDivR1D1F : public IIqTripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   IqRpDivR1D1F(const int rows, const int cols, const int q, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1D1F_HPP
