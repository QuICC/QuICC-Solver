/**
 * @file IqRpDivR1D1CF.hpp
 * @brief Implementation of the spectral operator I^q r^p 1/r D(-lapl(f) *)
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVRD1CF_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVRD1CF_HPP
...
public:
    ...
    */
   IqRpDivR1D1CF(const int rows, const int cols, const int q, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVRD1CF_HPP
