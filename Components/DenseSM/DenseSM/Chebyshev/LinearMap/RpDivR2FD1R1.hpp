/**
 * @file RpDivR2FD1R1.hpp
 * @brief Implementation of the spectral operator r^p 1/r^p f D(r *)
 *        multiplied by gaunt coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR2FD1R1_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR2FD1R1_HPP
...
/**
 * @brief Implementation of the spectral operator r^p f D(r *)
 */
class RpDivR2FD1R1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   RpDivR2FD1R1(const int rows, const int cols, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR2FD1R1_HPP
