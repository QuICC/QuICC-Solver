/**
 * @file IqRpDivR1CF.hpp
 * @brief Implementation of the spectral operator I^q r^p 1/r (-lapl(f)) *
 *        multiplied by elsasser coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1CF_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1CF_HPP
 ...
 * @brief Implementation of the spectral operator I^q r^p 1/r (-lapl(f)) *
 */
class IqRpDivR1CF : public IIqTripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   IqRpDivR1CF(const int rows, const int cols, const int q, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR1CF_HPP
