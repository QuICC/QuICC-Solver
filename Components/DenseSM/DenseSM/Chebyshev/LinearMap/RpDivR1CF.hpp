/**
 * @file RpDivR1CF.hpp
 * @brief Implementation of the spectral operator r^p 1/r (-lapl(f)) *
 *        multiplied by elsasser coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1CF_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1CF_HPP
 ...
 * @brief Implementation of the spectral operator r^p 1/r (-lapl(f)) *
 */
class RpDivR1CF : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   RpDivR1CF(const int rows, const int cols, const int p, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1CF_HPP
