/**
 * @file RpFD2.hpp
 * @brief Implementation of the spectral operator r^p f D2( * )
 *        multiplied by elsasser coefficient
 */

 #ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD2_HPP
 #define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD2_HPP
  ...
  * @brief Implementation of the spectral operator r^p f D2( * )
  */
 class RpFD2 : public ITripleHarmonicOperator
 {
 public:
    /**
     * @brief Constructor
 ...
 #endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD2_HPP
