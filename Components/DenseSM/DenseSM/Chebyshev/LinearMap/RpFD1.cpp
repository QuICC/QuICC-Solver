/**
 * @file RpFD1.cpp
 * @brief Source of the implementation of the spectral operator r^p f D(*)
 */
...
// Project includes
//
#include "DenseSM/Chebyshev/LinearMap/RpFD1.hpp"
...
RpFD1::RpFD1(const int nNr, const int nNc, const int p, const int lOut,
...
void RpFD1::buildOpImpl(Internal::Matrix& mat, const int rows,
   const int cols) const
{
   ...
   td1B = f.cast<MHDFloat>().asDiagonal() * td1B;

   tA = Utils::computeExpansion(td1B, this->rows(), lb, ub);
