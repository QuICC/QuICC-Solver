/**
 * @file RpFD1.hpp
 * @brief Implementation of the spectral operator r^p f D( * )
 *        multiplied by elsasser coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD1_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD1_HPP
 ...
 * @brief Implementation of the spectral operator r^p f D( * )
 */
class RpFD1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD1_HPP
