/**
 * @file IqRpDivR2CFD1R1.hpp
 * @brief Implementation of the spectral operator I^q r^p 1/r (-lapl(f))/r D(r *)
 *        multiplied by gaunt coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR2CFD1R1_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR2CFD1R1_HPP
 ...
 * @brief Implementation of the spectral operator I^q r^p 1/r (-lapl(f))/r D(r *)
 */
class IqRpDivR2CFD1R1 : public IIqTripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   IqRpDivR2CFD1R1(const int rows, const int cols, const int q, const int p, const int lOut, const int mOut,
    ...
    * @brief Destructor
    */
   virtual ~IqRpDivR2CFD1R1() = default;
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_IQRPDIVR2CFD1R1_HPP
