/**
 * @file RpDivR1D1DivR1D1R1F.hpp
 * @brief Implementation of the spectral operator r^p 1/r D(f/r D(r *))
 *        multiplied by elsasser coefficient
 */

#ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1D1DIVR1D1R1F_HPP
#define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1D1DIVR1D1R1F_HPP
 ...
 * @brief Implementation of the spectral operator r^p 1/r D(f/r D(r *))
 */
class RpDivR1D1DivR1D1R1F : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   RpDivR1D1DivR1D1R1F(const int rows, const int cols, const int p, const int lOut,
    ...
    * @brief Destructor
    */
   virtual ~RpDivR1D1DivR1D1R1F() = default;
...
#endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPDIVR1D1DIVR1D1R1F_HPP
