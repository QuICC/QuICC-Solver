/**
 * @file RpFD3.hpp
 * @brief Implementation of the spectral operator r^p f D3( * )
 *        multiplied by elsasser coefficient
 */

 #ifndef QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD3_HPP
 #define QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD3_HPP
 ...
 /**
  * @brief Implementation of the spectral operator r^p f D4( * )
  */
 class RpFD3 : public ITripleHarmonicOperator
 {
 public:
    /**
     * @brief Constructor
 ...
 #endif // QUICC_DENSESM_CHEBYSHEV_LINEARMAP_RPFD3_HPP
