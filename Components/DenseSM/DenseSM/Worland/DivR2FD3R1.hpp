...
#ifndef QUICC_DENSESM_WORLAND_DIVR2FD3R1_HPP
#define QUICC_DENSESM_WORLAND_DIVR2FD3R1_HPP
 ...
 * @brief Implementation of the spectral operator f/r
 */
class DivR2FD3R1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR2FD3R1(const int rows, const int cols, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_DIVR2FD3R1_HPP
