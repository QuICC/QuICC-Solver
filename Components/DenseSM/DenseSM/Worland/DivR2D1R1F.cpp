/**
 * @file DivR2D1R1F.hpp.cpp
 * @brief Source of the implementation of the spectral operator 1/r D(r f) 1/r
 */
...
DivR2D1R1F::DivR2D1R1F(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
...
void DivR2D1R1F::buildOpImpl(Internal::Matrix& mat, const int rows,
   const int cols) const
{
   ...
   r_1W.compute<Internal::MHDFloat>(opBwd, this->cols(), this->mLin, igrid, Internal::Array(), ev::Set());
   
   Internal::Matrix opFFwd(igrid.size(), this->mpF->nN());
   W.compute<Internal::MHDFloat>(opFFwd, this->mpF->nN(), this->mLf, igrid, iweights, ev::Set());
   Internal::Matrix opFBwd(igrid.size(), this->mpF->nN());
   r_1drW.compute<Internal::MHDFloat>(opFBwd, this->mpF->nN(), this->mLf, igrid, Internal::Array(), ev::Set());
