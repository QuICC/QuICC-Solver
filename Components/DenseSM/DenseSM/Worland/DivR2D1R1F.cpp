...
DivR2D1R1F::DivR2D1R1F(const int nNr, const int nNc, const int lOut,
   ...
   const int cols) const
{
   ...
   r_1W.compute<Internal::MHDFloat>(opBwd, this->cols(), this->mLin, igrid,
   ...
   r_1drW.compute<Internal::MHDFloat>(opFBwd, this->mpF->nN(), this->mLf, igrid,
      Internal::Array(), ev::Set());
