...
#ifndef QUICC_DENSESM_WORLAND_F_HPP
#define QUICC_DENSESM_WORLAND_F_HPP
 ...
 * @brief Implementation of the spectral operator f/r
 */
class F : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   F(const int nNr, const int nNc, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_F_HPP
