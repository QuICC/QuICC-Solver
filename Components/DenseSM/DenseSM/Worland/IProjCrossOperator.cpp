...
IProjCrossOperator::IProjCrossOperator(const int rows, const int cols, const int lOut, const int mOut, const int lA, const int mA, const int lB, const int mB, const Scalar_t alpha,
   const Scalar_t dBeta)
: IWorlandOperator(rows, cols, alpha, dBeta), mIsZero(false), mIsImaginary(false), mLout(lOut), mMout(mOut), mLa(lA), mMa(mA), mLb(lB), mMb(mB)
{}
