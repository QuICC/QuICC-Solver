/**
 * @file ProjTorViscNu.hpp
 * @brief Implementation of the poloidal projection of the term \nu lapl(u) /rho
 */

#ifndef QUICC_DENSESM_WORLAND_PROJTORVISCNU_HPP
#define QUICC_DENSESM_WORLAND_PROJTORVISCNU_HPP
 ...
 */
class ProjTorViscNu : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   ProjTorViscNu(const int nNr, const int nNc, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_PROJTORVISCNU_HPP
