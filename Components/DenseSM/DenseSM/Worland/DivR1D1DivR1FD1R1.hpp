/**
 * @file DivR1D1DivR1FD1R1.hpp
 * @brief Implementation of the spectral operator f/r
 */

#ifndef QUICC_DENSESM_WORLAND_DIVR1D1DIVR1FD1R1_HPP
#define QUICC_DENSESM_WORLAND_DIVR1D1DIVR1FD1R1_HPP
 ...
 * @brief Implementation of the spectral operator f/r
 */
class DivR1D1DivR1FD1R1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR1D1DivR1FD1R1(const int rows, const int cols, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn, std::shared_ptr<RadialTorPolFunction> pF, const Scalar_t alpha,
      const Scalar_t dBeta);

   /**
    * @brief Destructor
    */
   virtual ~DivR1D1DivR1FD1R1() = default;
...
#endif // QUICC_DENSESM_WORLAND_DIVR1D1DIVR1FD1R1_HPP
