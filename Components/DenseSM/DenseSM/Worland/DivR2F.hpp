...
#ifndef QUICC_DENSESM_WORLAND_DIVR2F_HPP
#define QUICC_DENSESM_WORLAND_DIVR2F_HPP
 ...
 * @brief Implementation of the spectral operator f/r
 */
class DivR2F : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR2F(const int nNr, const int nNc, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_DIVR2F_HPP
