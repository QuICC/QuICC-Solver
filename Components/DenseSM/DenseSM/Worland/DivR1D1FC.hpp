...
#ifndef QUICC_DENSESM_WORLAND_DIVR1D1FC_HPP
#define QUICC_DENSESM_WORLAND_DIVR1D1FC_HPP
 ...
 * @brief Implementation of the spectral operator 1/r D(f (-lapl(*)))
 */
class DivR1D1FC : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR1D1FC(const int rows, const int cols, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn, std::shared_ptr<RadialTorPolFunction> pF, const Scalar_t alpha,
      const Scalar_t dBeta);

   /**
    * @brief Destructor
    */
   virtual ~DivR1D1FC() = default;
...
#endif // QUICC_DENSESM_WORLAND_DIVR1D1FC_HPP
