...
#ifndef QUICC_DENSESM_WORLAND_PROJCURLCURLPOLCROSSPOL_HPP
#define QUICC_DENSESM_WORLAND_PROJCURLCURLPOLCROSSPOL_HPP
...
public:
    ...
    */
   ProjCurlCurlPolCrossPol(const int rows, const int cols, const int q, const int lOut,
...
#endif // QUICC_DENSESM_WORLAND_PROJCURLCURLPOLCROSSPOL_HPP
