...
namespace Worland {
    ...
    * @brief Implementation of the projection operator from the toroidal scalar to the geostrophic basis
    */
   class Tor2EGeostrophic: public IGeostrophicOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         Tor2EGeostrophic(const int nN, const int nL, const int nS, const int nZ, const int maxNug, const ArrayI& nli, const int nCpu, const Scalar_t ugAlpha, const Scalar_t ugDBeta, const Scalar_t alphaA, const Scalar_t dBetaA, const Scalar_t alphaB, const Scalar_t dBetaB, const bool isTriangular);
