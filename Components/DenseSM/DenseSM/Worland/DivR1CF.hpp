/**
 * @file DivR1CF.hpp
 * @brief Implementation of the spectral operator -lapl(f)/r
 */

#ifndef QUICC_DENSESM_WORLAND_DIVR1CF_HPP
#define QUICC_DENSESM_WORLAND_DIVR1CF_HPP
 ...
 * @brief Implementation of the spectral operator -lapl(f)/r
 */
class DivR1CF : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR1CF(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn, std::shared_ptr<RadialTorPolFunction> pF, const Scalar_t alpha,
      const Scalar_t dBeta);

   /**
    * @brief Destructor
    */
   virtual ~DivR1CF() = default;
...
#endif // QUICC_DENSESM_WORLAND_DIVR1CF_HPP
