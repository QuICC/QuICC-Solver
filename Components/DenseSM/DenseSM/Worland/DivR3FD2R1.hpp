...
#ifndef QUICC_DENSESM_WORLAND_DIVR3FD2R1_HPP
#define QUICC_DENSESM_WORLAND_DIVR3FD2R1_HPP
 ...
 * @brief Implementation of the spectral operator f/r
 */
class DivR3FD2R1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR3FD2R1(const int rows, const int cols, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_DIVR3FD2R1_HPP
