/**
 * @file ProjPolViscD1.hpp
 * @brief Implementation of the poloidal projection of the term D1 D1(u)/rho
 */

#ifndef QUICC_DENSESM_WORLAND_PROJPOLVISCD1_HPP
#define QUICC_DENSESM_WORLAND_PROJPOLVISCD1_HPP
 ...
 */
class ProjPolViscD1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   ProjPolViscD1(const int nNr, const int nNc, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_PROJPOLVISCD1_HPP
