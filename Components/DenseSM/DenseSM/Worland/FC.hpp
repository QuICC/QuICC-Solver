...
#ifndef QUICC_DENSESM_WORLAND_FC_HPP
#define QUICC_DENSESM_WORLAND_FC_HPP
 ...
 */
class FC : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   FC(const int nNr, const int nNc, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_FC_HPP
