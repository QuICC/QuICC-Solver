/**
 * @file DivR1D1F.hpp
 * @brief Implementation of the spectral operator 1/r D(f *)
 */

#ifndef QUICC_DENSESM_WORLAND_DIVR1D1F_HPP
#define QUICC_DENSESM_WORLAND_DIVR1D1F_HPP
 ...
 * @brief Implementation of the spectral operator 1/r D(f *)
 */
class DivR1D1F : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR1D1F(const int rows, const int cols, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn, std::shared_ptr<RadialTorPolFunction> pF, const Scalar_t alpha,
      const Scalar_t dBeta);

   /**
    * @brief Destructor
    */
   virtual ~DivR1D1F() = default;
...
#endif // QUICC_DENSESM_WORLAND_DIVR1D1F_HPP
