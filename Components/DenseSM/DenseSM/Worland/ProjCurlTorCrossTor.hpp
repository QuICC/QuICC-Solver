...
#ifndef QUICC_DENSESM_WORLAND_PROJCURLTORCROSSTOR_HPP
#define QUICC_DENSESM_WORLAND_PROJCURLTORCROSSTOR_HPP
...
public:
    ...
    */
   ProjCurlTorCrossTor(const int rows, const int cols, const int q, const int lOut,
...
#endif // QUICC_DENSESM_WORLAND_PROJCURLTORCROSSTOR_HPP
