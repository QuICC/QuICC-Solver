/**
 * @file ProjPolViscNu.hpp
 * @brief Implementation of the poloidal projection of the term \nu lapl(u) /rho
 */

#ifndef QUICC_DENSESM_WORLAND_PROJPOLVISCNU_HPP
#define QUICC_DENSESM_WORLAND_PROJPOLVISCNU_HPP
...
/**
 * @brief Implementation of the spectral operator \nu lapl(u) /rho
 */
class ProjPolViscNu : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   ProjPolViscNu(const int nNr, const int nNc, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_PROJPOLVISCNU_HPP
