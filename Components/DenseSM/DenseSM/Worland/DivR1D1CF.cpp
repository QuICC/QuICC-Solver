...
DivR1D1CF::DivR1D1CF(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
   ...
   const int cols) const
{
   ...
   W.compute<Internal::MHDFloat>(opCFwd, opCFwd.cols(), lF, igrid, iweights, ev::Set());
