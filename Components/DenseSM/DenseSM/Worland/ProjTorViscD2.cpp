/**
 * @file ProjTorViscD2.cpp
 * @brief Implementation of the poloidal projection of the term D1 -D2 u /rho
 */
...
// Project includes
//
#include "DenseSM/Worland/ProjTorViscD2.hpp"
...
ProjTorViscD2::ProjTorViscD2(const int nNr, const int nNc, const int lOut, const int mOut,
...
{
   // bilaplacian
   this->mpOpA = std::make_shared<F>(nNr, nNc, lOut, mOut, lF, mF,
         lIn, mIn, pF, alpha, dBeta);
}

void ProjTorViscD2::buildOpImpl(Internal::Matrix& mat, const int rows,
