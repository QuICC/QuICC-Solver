...
DivR1D1DivR1D1R1F::DivR1D1DivR1D1R1F(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
   ...
   const int cols) const
{
   ...
   W.compute<Internal::MHDFloat>(opFFFwd, opFFFwd.cols(), this->mLin + this->mLf - 1, igrid, iweights, ev::Set());
   Internal::Matrix opFFBwd(igrid.size(), this->cols() + this->mpF->nN());
   r_1dW.compute<Internal::MHDFloat>(opFFBwd, opFFBwd.cols(), this->mLin + this->mLf - 1, igrid, Internal::Array(), ev::Set());
