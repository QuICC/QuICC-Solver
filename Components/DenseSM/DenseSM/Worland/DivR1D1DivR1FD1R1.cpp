...
DivR1D1DivR1FD1R1::DivR1D1DivR1FD1R1(const int nNr, const int nNc,
   ...
   const int cols) const
{
   ...
   W.compute<Internal::MHDFloat>(opFFwd, opFFwd.cols(),
   ...
   mat =
      opFwd.transpose() * opFBwd * opFFwd.transpose() * f.asDiagonal() * opBwd;
}
