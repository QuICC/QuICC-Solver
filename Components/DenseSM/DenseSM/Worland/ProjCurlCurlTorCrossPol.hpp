...
#ifndef QUICC_DENSESM_WORLAND_PROJCURLCURLTORCROSSPOL_HPP
#define QUICC_DENSESM_WORLAND_PROJCURLCURLTORCROSSPOL_HPP
...
public:
    ...
    */
   ProjCurlCurlTorCrossPol(const int rows, const int cols, const int lOut, const int mOut, const int lA, const int mA, const int lB, const int mB, std::shared_ptr<RadialTorPolFunction> pTorA, std::shared_ptr<RadialTorPolFunction> pPolB, const Scalar_t alpha, const Scalar_t dBeta);
...
#endif // QUICC_DENSESM_WORLAND_PROJCURLCURLTORCROSSPOL_HPP
