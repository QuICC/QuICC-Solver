...
#ifndef QUICC_DENSESM_WORLAND_DIVR1FC_HPP
#define QUICC_DENSESM_WORLAND_DIVR1FC_HPP
 ...
 * @brief Implementation of the spectral operator f(-lapl(*))/r
 */
class DivR1FC : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR1FC(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn, std::shared_ptr<RadialTorPolFunction> pF, const Scalar_t alpha,
      const Scalar_t dBeta);

   /**
    * @brief Destructor
    */
   virtual ~DivR1FC() = default;
...
#endif // QUICC_DENSESM_WORLAND_DIVR1FC_HPP
