/**
 * @file DivR1D1FD1R1.hpp
 * @brief Implementation of the spectral operator 1/r D(f) D(r *)
 */

#ifndef QUICC_DENSESM_WORLAND_DIVR1D1FD1R1_HPP
#define QUICC_DENSESM_WORLAND_DIVR1D1FD1R1_HPP
 ...
 */
class DivR1D1FD1R1 : public ITripleHarmonicOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   DivR1D1FD1R1(const int rows, const int cols, const int lOut, const int mOut,
...
#endif // QUICC_DENSESM_WORLAND_DIVR1D1FD1R1_HPP
