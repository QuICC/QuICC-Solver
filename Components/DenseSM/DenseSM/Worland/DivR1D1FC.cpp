 ...
 * @brief Source of the implementation of the spectral operator 1/r D(f (-lapl(*)))
 */
...
DivR1D1FC::DivR1D1FC(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
   ...
   const int cols) const
{
   ...
   r_1dW.compute<Internal::MHDFloat>(opFBwd, opFBwd.cols(), this->mLin + this->mLf, igrid, Internal::Array(), ev::Set());
