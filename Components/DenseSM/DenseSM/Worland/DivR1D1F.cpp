...
DivR1D1F::DivR1D1F(const int nNr, const int nNc, const int lOut, const int mOut, const int lF, const int mF, const int lIn, const int mIn,
...
void DivR1D1F::buildOpImpl(Internal::Matrix& mat, const int rows,
