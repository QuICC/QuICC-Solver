...
#ifndef QUICC_DENSESM_BESSEL_CORIOLISQP_HPP
#define QUICC_DENSESM_BESSEL_CORIOLISQP_HPP
...
namespace Bessel {
   ...
   class CoriolisQp: public IEmbeddedSMOperator
   {
      public:
          ...
          */
         CoriolisQp(const Internal::MHDFloat outDNu, const Internal::MHDFloat inDNu, const int rows, const int cols, const int l);

         /**
          * @brief Destructor
          */
         virtual ~CoriolisQp() = default;
...
#endif // QUICC_DENSESM_BESSEL_CORIOLISQP_HPP
