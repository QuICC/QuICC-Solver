...
#ifndef QUICC_DENSESM_BESSEL_PROJFITENERGYPOL_HPP
#define QUICC_DENSESM_BESSEL_PROJFITENERGYPOL_HPP
...
namespace Bessel {
   ...
   class ProjFitEnergyPol: public IMatrixSMOperator
   {
      public:
          ...
          */
         ProjFitEnergyPol(const int outRows, const std::size_t bcId, const int rows, const int cols, const int l);
...
#endif // QUICC_DENSESM_BESSEL_PROJFITENERGYPOL_HPP
