...
#ifndef QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3E_HPP
#define QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3E_HPP
 ...
 * @brief Implementation of an implicit/explicit Runge-Kutta scheme of order 3e
 */
class ImExRKCB3e : public IImExRKCBScheme
{
public:
...
/// Typedef for a shared pointer ImExRKCB3e
typedef std::shared_ptr<ImExRKCB3e> SharedImExRKCB3e;
} // namespace RungeKuttaCB
} // namespace Timestep
} // namespace QuICC

#endif // QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3E_HPP
