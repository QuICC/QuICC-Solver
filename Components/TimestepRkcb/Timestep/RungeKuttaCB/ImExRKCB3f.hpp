...
#ifndef QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3F_HPP
#define QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3F_HPP
...
#include "Timestep/RungeKuttaCB/SparseImExRK3RTimestepper.hpp"
 ...
 * @brief Implementation of an implicit/explicit Runge-Kutta scheme of order 3f
 */
class ImExRKCB3f : public IImExRKCBScheme
{
public:
...
/// Typedef for a shared pointer ImExRKCB3f
typedef std::shared_ptr<ImExRKCB3f> SharedImExRKCB3f;
} // namespace RungeKuttaCB
} // namespace Timestep
} // namespace QuICC

#endif // QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3F_HPP
