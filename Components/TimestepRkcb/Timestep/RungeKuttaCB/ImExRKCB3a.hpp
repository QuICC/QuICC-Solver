...
#ifndef QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3A_HPP
#define QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3A_HPP
...
//
// Block compilation using this timestepper (Comment out for testing purposes
// only)
//
#error                                                                         \
   "The ImExRKCB3a timestepper is broken and does not provide accurate results. Switch to another timestepper."

#endif // QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3A_HPP
