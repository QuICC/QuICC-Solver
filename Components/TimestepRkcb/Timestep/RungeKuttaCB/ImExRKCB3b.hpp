...
#ifndef QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3B_HPP
#define QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3B_HPP
 ...
 * @brief Implementation of an implicit/explicit Runge-Kutta scheme of order 3b
 */
class ImExRKCB3b : public IImExRKCBScheme
{
public:
...
/// Typedef for a shared pointer ImExRKCB3b
typedef std::shared_ptr<ImExRKCB3b> SharedImExRKCB3b;
} // namespace RungeKuttaCB
} // namespace Timestep
} // namespace QuICC

#endif // QUICC_TIMESTEP_RUNGEKUTTACB_IMEXRKCB3B_HPP
