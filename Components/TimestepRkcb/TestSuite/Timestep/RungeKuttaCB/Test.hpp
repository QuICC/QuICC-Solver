...
#ifndef QUICC_TESTSUITE_TIMESTEP_RUNGEKUTTACB_TEST_HPP
#define QUICC_TESTSUITE_TIMESTEP_RUNGEKUTTACB_TEST_HPP
...
#endif // QUICC_TESTSUITE_TIMESTEP_RUNGEKUTTACB_TEST_HPP
