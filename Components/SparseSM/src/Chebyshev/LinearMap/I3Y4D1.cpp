/**
 * @file I3Y4D1.cpp
 * @brief Source of the implementation of the I^3 Y^4 D sparse operator, with y
 * = ax + b
 */
...
I3Y4D1::I3Y4D1(const int rows, const int cols, const Scalar_t lower,
...
{
   return a<4>() * (n - 4.0_mp) *
          (a<2>() * n + 4.0_mp * a<2>() + 12.0_mp * b<2>() * n +
             12.0_mp * b<2>()) /
...
{
   return a<3>() * b<1>() * (n - 3.0_mp) *
          (a<2>() * n + 7.0_mp * a<2>() + 4.0_mp * b<2>() * n +
             4.0_mp * b<2>()) /
...
{
   return -a<2>() *
          (a<4>() * n * n - 15.0_mp * a<4>() * n - 46.0_mp * a<4>() -
             144.0_mp * a<2>() * b<2>() * n - 288.0_mp * a<2>() * b<2>() -
             16.0_mp * b<4>() * n * n - 48.0_mp * b<4>() * n -
             32.0_mp * b<4>()) /
          (64.0_mp * n * (n - 1.0_mp) * (n + 1.0_mp) * (n + 2.0_mp));
}

I3Y4D1::ACoeff_t I3Y4D1::d_1(const ACoeff_t& n) const
{
   return -a<3>() * b<1>() *
          (a<2>() * n * n - 3.0_mp * a<2>() * n - 16.0_mp * a<2>() +
             2.0_mp * b<2>() * n * n - 6.0_mp * b<2>() * n - 20.0_mp * b<2>()) /
          (4.0_mp * n * (n - 2.0_mp) * (n + 1.0_mp) * (n + 2.0_mp));
}
...
I3Y4D1::ACoeff_t I3Y4D1::d0(const ACoeff_t& n) const
{
   return -a<2>() *
          (a<4>() * n * n - 16.0_mp * a<4>() +
             12.0_mp * a<2>() * b<2>() * n * n - 120.0_mp * a<2>() * b<2>() +
             8.0_mp * b<4>() * n * n - 32.0_mp * b<4>()) /
          (16.0_mp * (n - 2.0_mp) * (n - 1.0_mp) * (n + 1.0_mp) * (n + 2.0_mp));
}
...
I3Y4D1::ACoeff_t I3Y4D1::d2(const ACoeff_t& n) const
{
   return -a<2>() *
          (a<4>() * n * n + 15.0_mp * a<4>() * n - 46.0_mp * a<4>() +
             ...
             16.0_mp * b<4>() * n * n + 48.0_mp * b<4>() * n -
             32.0_mp * b<4>()) /
          (64.0_mp * n * (n - 2.0_mp) * (n - 1.0_mp) * (n + 1.0_mp));
}
