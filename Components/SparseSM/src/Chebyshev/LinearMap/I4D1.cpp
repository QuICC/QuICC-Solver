/**
 * @file I4D1.cpp
 * @brief Source of the implementation of the I^4 D sparse operator, with y = ax
 * + b
 */
...
I4D1::I4D1(const int rows, const int cols, const Scalar_t lower,
...
{
   return -Internal::Math::pow(this->a() / 2.0, 3) * 3.0 /
          (n * (n - 2.0) * (n + 1.0));
}
