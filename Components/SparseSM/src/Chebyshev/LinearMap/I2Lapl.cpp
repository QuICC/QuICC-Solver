/**
 * @file I2Lapl.cpp
 * @brief Source of the implementation of the I^2 plane layer Cartesian
 * laplacian sparse operator, with y = ax + b
 */
...
I2Lapl::I2Lapl(const int rows, const int cols, const Scalar_t lower,
