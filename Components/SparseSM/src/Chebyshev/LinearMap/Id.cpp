/**
 * @file Id.cpp
 * @brief Source of the implementation of the Chebyshev Id sparse operator, y =
 * ax + b
 */
...
Id::Id(const int rows, const int cols, const Scalar_t lower,
   const Scalar_t upper, const int q, const int s) :
