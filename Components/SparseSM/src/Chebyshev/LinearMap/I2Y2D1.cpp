/**
 * @file I2Y2D1.cpp
 * @brief Source of the implementation of the I^2 Y^2 D sparse operator, with y
 * = ax + b
 */
...
I2Y2D1::I2Y2D1(const int rows, const int cols, const Scalar_t lower,
...
I2Y2D1::ACoeff_t I2Y2D1::d_1(const ACoeff_t& n) const
{
   ...
   return a1 * (a2 * n + 3.0 * a2 + 4.0 * b2 * n + 4.0 * b2) /
          (8.0 * n * (n + 1.0));
}
