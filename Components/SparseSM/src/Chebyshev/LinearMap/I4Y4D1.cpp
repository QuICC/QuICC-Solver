/**
 * @file I4Y4D1.cpp
 * @brief Source of the implementation of the I^4 Y^4 D sparse operator, with y
 * = ax + b
 */
...
I4Y4D1::I4Y4D1(const int rows, const int cols, const Scalar_t lower,
...
I4Y4D1::ACoeff_t I4Y4D1::d_5(const ACoeff_t& n) const
{
   ...
   const auto& b1 = this->b();
   const auto b2 = b1 * b1;
   return a5 * (n - 5.0) * (a2 * n + 13.0 * a2 + 24.0 * b2 * n + 24.0 * b2) /
          (128.0 * n * (n - 3.0) * (n - 2.0) * (n - 1.0) * (n + 1.0));
}
...
I4Y4D1::ACoeff_t I4Y4D1::d_4(const ACoeff_t& n) const
{
   ...
   const auto& b1 = this->b();
   const auto b2 = b1 * b1;
   return a4 * b1 * (n - 4.0) * (3.0 * a2 + b2 * n + b2) /
...
I4Y4D1::ACoeff_t I4Y4D1::d_3(const ACoeff_t& n) const
{
   ...
   const auto b4 = b2 * b2;
   return -a3 *
          (3.0 * a4 * n.pow(2) - 15.0 * a4 * n - 102.0 * a4 +
             24.0 * a2 * b2 * n.pow(2) - 216.0 * a2 * b2 * n - 528.0 * a2 * b2 -
             16.0 * b4 * n.pow(2) - 48.0 * b4 * n - 32.0 * b4) /
          (128.0 * n * (n - 2.0) * (n - 1.0) * (n + 1.0) * (n + 2.0));
}
...
I4Y4D1::ACoeff_t I4Y4D1::d_2(const ACoeff_t& n) const
{
   ...
   const auto b2 = b1 * b1;
   return -a4 * b1 *
          (3.0 * a2 * n.pow(2) - 3.0 * a2 * n - 78.0 * a2 +
             8.0 * b2 * n.pow(2) - 24.0 * b2 * n - 80.0 * b2) /
          (16.0 * n * (n - 3.0) * (n - 1.0) * (n + 1.0) * (n + 2.0));
}
...
I4Y4D1::ACoeff_t I4Y4D1::d_1(const ACoeff_t& n) const
{
   ...
   const auto b4 = b2 * b2;
   return -3.0 * a3 *
          (a4 * n.pow(3) + 10.0 * a4 * n.pow(2) - 29.0 * a4 * n - 190.0 * a4 +
             16.0 * a2 * b2 * n.pow(3) + 96.0 * a2 * b2 * n.pow(2) -
             304.0 * a2 * b2 * n - 1344.0 * a2 * b2 + 16.0 * b4 * n.pow(3) +
             32.0 * b4 * n.pow(2) - 144.0 * b4 * n - 288.0 * b4) /
          (128.0 * n * (n - 3.0) * (n - 2.0) * (n + 1.0) * (n + 2.0) *
             (n + 3.0));
}
...
I4Y4D1::ACoeff_t I4Y4D1::d0(const ACoeff_t& n) const
{
   ...
   const auto b2 = b1 * b1;
   return -3.0 * a4 * b1 *
          (a2 * n.pow(2) - 14.0 * a2 + 2.0 * b2 * n.pow(2) - 18.0 * b2) /
          (2 * (n - 3.0) * (n - 2.0) * (n - 1.0) * (n + 1.0) * (n + 2.0) *
             (n + 3.0));
}
...
I4Y4D1::ACoeff_t I4Y4D1::d2(const ACoeff_t& n) const
{
   ...
   return a4 * b1 *
          (3.0 * a2 * n.pow(2) + 3.0 * a2 * n - 78.0 * a2 +
             8.0 * b2 * n.pow(2) + 24.0 * b2 * n - 80.0 * b2) /
          (16.0 * n * (n - 2.0) * (n - 1.0) * (n + 1.0) * (n + 3.0));
}
...
I4Y4D1::ACoeff_t I4Y4D1::d5(const ACoeff_t& n) const
{
   ...
   const auto b2 = b1 * b1;
   return -a5 * (n + 5.0) * (a2 * n - 13.0 * a2 + 24.0 * b2 * n - 24.0 * b2) /
          (128.0 * n * (n - 1.0) * (n + 1.0) * (n + 2.0) * (n + 3.0));
}
