...
namespace LinearMap {
   ...
   {
      return Internal::Math::pow(this->a()/2.0,7)/(n*(n - 3.0)*(n - 2.0)*(n - 1.0));
   }

   I4Y3::ACoeff_t I4Y3::d_6(const ACoeff_t& n) const
   {
      return 3.0*Internal::Math::pow(this->a()/2.0,6)*this->b()/(n*(n - 3.0)*(n - 2.0)*(n - 1.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d_5(const ACoeff_t& n) const
   {
      ...
      return -Internal::Math::pow(this->a()/2.0,5)*(a2*(n - 11.0) - 12.0*b2*(n + 1.0))/(4.0*n*(n - 3.0)*(n - 2.0)*(n - 1.0)*(n + 1.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d_4(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return -Internal::Math::pow(this->a()/2.0,4)*this->b()*(3.0*a2*(n - 5.0) - 2.0*b2*(n + 1))/(2.0*n*(n - 3.0)*(n - 2.0)*(n - 1.0)*(n + 1.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d_3(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return -3.0*Internal::Math::pow(this->a()/2.0,5)*(a2*(n + 6.0) + 12.0*b2*(n + 2.0))/(4.0*n*(n - 2.0)*(n - 1.0)*(n + 1.0)*(n + 2.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d_2(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return -Internal::Math::pow(this->a()/2.0,4)*this->b()*(3.0*a2*(n + 17.0) + 16.0*b2*(n + 2.0))/(4.0*n*(n - 3.0)*(n - 1.0)*(n + 1.0)*(n + 2.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d_1(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return 3.0*Internal::Math::pow(this->a()/2.0,5)*(a2*(n.pow(2) - 5.0*n - 34.0) + 8.0*b2*(n.pow(2) - 5.0*n - 24.0))/(4.0*n*(n - 3.0)*(n - 2.0)*(n + 1.0)*(n + 2.0)*(n + 3.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d0(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return 3.0*Internal::Math::pow(this->a()/2.0,4)*this->b()*(a2*(n.pow(2) - 19.0) + 2.0*b2*(n.pow(2) - 9.0))/((n - 3.0)*(n - 2.0)*(n - 1.0)*(n + 1.0)*(n + 2.0)*(n + 3.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d2(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return -Internal::Math::pow(this->a()/2.0,4)*this->b()*(3.0*a2*(n - 17.0) + 16.0*b2*(n - 2.0))/(4.0*n*(n - 2.0)*(n - 1.0)*(n + 1.0)*(n + 3.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d4(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return -Internal::Math::pow(this->a()/2.0,4)*this->b()*(3.0*a2*(n + 5.0) - 2.0*b2*(n - 1.0))/(2.0*n*(n - 1.0)*(n + 1.0)*(n + 2.0)*(n + 3.0));
   }
   ...
   I4Y3::ACoeff_t I4Y3::d5(const ACoeff_t& n) const
   {
      auto a2 = this->a()*this->a();
      auto b2 = this->b()*this->b();
      return -Internal::Math::pow(this->a()/2.0,5)*(a2*(n + 11.0) - 12.0*b2*(n - 1.0))/(4.0*n*(n - 1.0)*(n + 1.0)*(n + 2.0)*(n + 3.0));
   }

   I4Y3::ACoeff_t I4Y3::d6(const ACoeff_t& n) const
   {
      return 3.0*Internal::Math::pow(this->a()/2.0,6)*this->b()/(n*(n + 1.0)*(n + 2.0)*(n + 3.0));
   }

   I4Y3::ACoeff_t I4Y3::d7(const ACoeff_t& n) const
   {
      return Internal::Math::pow(this->a()/2.0,7)/(n*(n + 1.0)*(n + 2.0)*(n + 3.0));
   }
