/**
 * @file I3Y4.cpp
 * @brief Source of the implementation of the I^3 Y^4 sparse operator, with y = ax + b
 */
...
namespace LinearMap {
   ...
   I3Y4::I3Y4(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper)
   ...
   {
      return a<5>()*(a<2>()*n + 7.0_mp*a<2>() + 24.0_mp*b<2>()*n + 24.0_mp*b<2>())/(128.0_mp*n*(n - 2.0_mp)*(n - 1.0_mp)*(n + 1.0_mp));
   }

   I3Y4::ACoeff_t I3Y4::d_4(const ACoeff_t& n) const
   {
      return a<4>()*b<1>()*(3.0_mp*a<2>() + 2.0_mp*b<2>()*n + 2.0_mp*b<2>())/(8.0_mp*n*(n - 2.0_mp)*(n - 1.0_mp)*(n + 1.0_mp));
   }

   I3Y4::ACoeff_t I3Y4::d_3(const ACoeff_t& n) const
   {
      return -a<3>()*(3.0_mp*a<4>()*n*n - 3.0_mp*a<4>()*n - 30.0_mp*a<4>() + 24.0_mp*a<2>()*b<2>()*n*n - 72.0_mp*a<2>()*b<2>()*n - 240.0_mp*a<2>()*b<2>() - 16.0_mp*b<4>()*n*n - 48.0_mp*b<4>()*n - 32.0_mp*b<4>())/(128.0_mp*n*(n - 2.0_mp)*(n - 1.0_mp)*(n + 1.0_mp)*(n + 2.0_mp));
   }

   I3Y4::ACoeff_t I3Y4::d_2(const ACoeff_t& n) const
   {
      return -a<4>()*b<1>()*(3.0_mp*a<2>()*n + 9.0_mp*a<2>() + 8.0_mp*b<2>()*n + 16.0_mp*b<2>())/(16.0_mp*n*(n - 1.0_mp)*(n + 1.0_mp)*(n + 2.0_mp));
   }

   I3Y4::ACoeff_t I3Y4::d_1(const ACoeff_t& n) const
   {
      return -3.0_mp*a<3>()*(a<4>()*n + 6.0_mp*a<4>() + 16.0_mp*a<2>()*b<2>()*n + 64.0_mp*a<2>()*b<2>() + 16.0_mp*b<4>()*n + 32.0_mp*b<4>())/(128.0_mp*n*(n - 2.0_mp)*(n + 1.0_mp)*(n + 2.0_mp));
   }

   I3Y4::ACoeff_t I3Y4::d0(const ACoeff_t& n) const
   {
      return -3.0_mp*a<4>()*b<1>()*(a<2>() + 2.0_mp*b<2>())/(4.0_mp*(n - 2.0_mp)*(n - 1.0_mp)*(n + 1.0_mp)*(n + 2.0_mp));
   }
   ...
   {
      return a<4>()*b<1>()*(3.0_mp*a<2>()*n - 9.0_mp*a<2>() + 8.0_mp*b<2>()*n - 16.0_mp*b<2>())/(16.0_mp*n*(n - 2.0_mp)*(n - 1.0_mp)*(n + 1.0_mp));
   }
   ...
   {
      return a<4>()*b<1>()*(3.0_mp*a<2>() - 2.0_mp*b<2>()*n + 2.0_mp*b<2>())/(8.0_mp*n*(n - 1.0_mp)*(n + 1.0_mp)*(n + 2.0_mp));
   }

   I3Y4::ACoeff_t I3Y4::d5(const ACoeff_t& n) const
   {
      return -a<5>()*(a<2>()*n - 7.0_mp*a<2>() + 24.0_mp*b<2>()*n - 24.0_mp*b<2>())/(128.0_mp*n*(n - 1.0_mp)*(n + 1.0_mp)*(n + 2.0_mp));
   }
