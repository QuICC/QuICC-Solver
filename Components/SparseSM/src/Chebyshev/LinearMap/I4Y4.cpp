/**
 * @file I4Y4.cpp
 * @brief Source of the implementation of the I^4 Y^4 sparse operator, with y =
 * ax + b
 */
...
I4Y4::I4Y4(const int rows, const int cols, const Scalar_t lower,
...
I4Y4::ACoeff_t I4Y4::d_6(const ACoeff_t& n) const
{
   ...
   const auto b2 = b1 * b1;
   return (3.0 * a6 * (2.0 * b2 * n + a2 + 2.0 * b2)) /
...
I4Y4::ACoeff_t I4Y4::d_5(const ACoeff_t& n) const
{
   ...
   const auto a5 = a2 * a3;
   const auto b2 = b1 * b1;
   return -(a5 * b1 * (a2 * n - 4.0 * b2 * n - 11.0 * a2 - 4.0 * b2)) /
...
I4Y4::ACoeff_t I4Y4::d_4(const ACoeff_t& n) const
{
   ...
   const auto b2 = b1 * b1;
   const auto b4 = b2 * b2;
   return -(a4 * (a4 * n.pow(2) - 19.0 * a4 + 12.0 * a2 * b2 * n.pow(2) -
                    36.0 * a2 * b2 * n - 120.0 * a2 * b2 - 4.0 * b4 * n.pow(2) -
                    12.0 * b4 * n - 8.0 * b4)) /
          (64.0 * n * (n - 1.0) * (n - 2.0) * (n - 3.0) * (n + 2.0) *
             (n + 1.0));
}
...
I4Y4::ACoeff_t I4Y4::d_3(const ACoeff_t& n) const
{
   ...
   const auto a5 = a2 * a3;
   const auto b2 = b1 * b1;
   return -(3.0 * a5 * b1 * (a2 * n + 4.0 * b2 * n + 6.0 * a2 + 8.0 * b2)) /
          (32.0 * n * (n - 1.0) * (n - 2.0) * (n + 2.0) * (n + 1.0));
}
...
I4Y4::ACoeff_t I4Y4::d_2(const ACoeff_t& n) const
{
   ...
   const auto b2 = b1 * b1;
   const auto b4 = b2 * b2;
   return -(a4 * (9.0 * a4 * n + 33.0 * a4 + 6.0 * a2 * b2 * n.pow(2) +
                    120 * a2 * b2 * n + 306.0 * a2 * b2 + 16.0 * b4 * n.pow(2) +
                    80.0 * b4 * n + 96.0 * b4)) /
          (64.0 * n * (n - 1.0) * (n - 3.0) * (n + 3.0) * (n + 2.0) *
             (n + 1.0));
}
...
I4Y4::ACoeff_t I4Y4::d_1(const ACoeff_t& n) const
{
   ...
   const auto b2 = b1 * b1;
   return (a5 * b1 *
             (3.0 * a2 * n.pow(2) - 15.0 * a2 * n - 102.0 * a2 +
                8.0 * b2 * n.pow(2) - 40.0 * b2 * n - 192.0 * b2)) /
          (32.0 * n * (n - 2.0) * (n - 3.0) * (n + 3.0) * (n + 2.0) *
             (n + 1.0));
}
...
I4Y4::ACoeff_t I4Y4::d0(const ACoeff_t& n) const
{
   ...
   const auto b4 = b2 * b2;
   return (3.0 * a4 *
             (a4 * n.pow(2) - 29.0 * a4 + 16.0 * a2 * b2 * n.pow(2) -
                304.0 * a2 * b2 + 16.0 * b4 * n.pow(2) - 144.0 * b4)) /
          (128.0 * (n - 1.0) * (n - 2.0) * (n - 3.0) * (n + 3.0) * (n + 2.0) *
             (n + 1.0));
}
...
I4Y4::ACoeff_t I4Y4::d1(const ACoeff_t& n) const
{
   ...
   return (a5 * b1 *
             (3.0 * a2 * n.pow(2) + 15.0 * a2 * n - 102.0 * a2 +
                8.0 * b2 * n.pow(2) + 40.0 * b2 * n - 192.0 * b2)) /
          (32.0 * n * (n - 1.0) * (n - 2.0) * (n - 3.0) * (n + 3.0) *
             (n + 2.0));
}
...
I4Y4::ACoeff_t I4Y4::d2(const ACoeff_t& n) const
{
   ...
   const auto b4 = b2 * b2;
   return (a4 * (9.0 * a4 * n - 33.0 * a4 - 6.0 * a2 * b2 * n.pow(2) +
                   120.0 * a2 * b2 * n - 306.0 * a2 * b2 -
                   16.0 * b4 * n.pow(2) + 80.0 * b4 * n - 96.0 * b4)) /
          (64.0 * n * (n - 1.0) * (n - 2.0) * (n - 3.0) * (n + 3.0) *
             (n + 1.0));
}
...
I4Y4::ACoeff_t I4Y4::d6(const ACoeff_t& n) const
{
   ...
   const auto a6 = a2 * a4;
   const auto b2 = b1 * b1;
   return -(3.0 * a6 * (a2 - 2.0 * b2 * n + 2.0 * b2)) /
