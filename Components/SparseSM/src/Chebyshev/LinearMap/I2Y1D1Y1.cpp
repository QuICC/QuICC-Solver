/**
 * @file I2Y1D1Y1.cpp
 * @brief Source of the implementation of the I^2 Y D Y sparse operator, with y
 * = ax + b
 */
...
I2Y1D1Y1::I2Y1D1Y1(const int rows, const int cols, const Scalar_t lower,
...
{
   return Internal::Math::pow(this->a() / 2.0, 2) * this->b() *
          (2.0 * n - 3.0) / (n * (n - 1.0));
}
...
I2Y1D1Y1::ACoeff_t I2Y1D1Y1::d_1(const ACoeff_t& n) const
{
   ...
   return this->a() * (a2 * (n + 2.0) + 4.0 * b2 * (n + 1.0)) /
          (8.0 * n * (n + 1.0));
}

I2Y1D1Y1::ACoeff_t I2Y1D1Y1::d0(const ACoeff_t& n) const
{
   auto a2 = this->a() * this->a();
   return a2 * this->b() / (2.0 * (n - 1.0) * (n + 1.0));
}

I2Y1D1Y1::ACoeff_t I2Y1D1Y1::d1(const ACoeff_t& n) const
{
   auto a2 = this->a() * this->a();
   auto b2 = this->b() * this->b();
   return -this->a() * (a2 * (n - 2.0) + 4.0 * b2 * (n - 1.0)) /
...
I2Y1D1Y1::ACoeff_t I2Y1D1Y1::d2(const ACoeff_t& n) const
{
   auto a2 = this->a() * this->a();
   return -a2 * this->b() * (2.0 * n + 3.0) / (4.0 * n * (n + 1.0));
}

I2Y1D1Y1::ACoeff_t I2Y1D1Y1::d3(const ACoeff_t& n) const
{
   return -Internal::Math::pow(this->a(), 3) * (n + 2.0) /
          (8.0 * n * (n + 1.0));
}
