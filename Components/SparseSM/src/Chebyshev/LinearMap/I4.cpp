/**
 * @file I4.cpp
 * @brief Source of the implementation of the I^4 sparse operator, with y = ax +
 * b
 */
...
I4::I4(const int rows, const int cols, const Scalar_t lower,
...
{
   return -Internal::Math::pow(this->a() / 2.0, 4) * 4.0 /
          (n * (n - 3.0) * (n - 1.0) * (n + 1.0));
}

I4::ACoeff_t I4::d0(const ACoeff_t& n) const
{
   return Internal::Math::pow(this->a() / 2.0, 4) * 6.0 /
