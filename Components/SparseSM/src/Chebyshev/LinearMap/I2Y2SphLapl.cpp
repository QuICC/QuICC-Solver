 ...
 * @brief Source of the implementation of the I^2 Y^2 spherical laplacian sparse
...
I2Y2SphLapl::I2Y2SphLapl(const int rows, const int cols, const Scalar_t lower,
...
I2Y2SphLapl::ACoeff_t I2Y2SphLapl::d0(const ACoeff_t& n) const
{
   ...
   return (a2 * l2 + a2 * l1 + a2 * n.pow(2) - a2 + 2.0 * b2 * n.pow(2) -
             2.0 * b2) /
          (2.0 * (n - 1.0) * (n + 1.0));
}
