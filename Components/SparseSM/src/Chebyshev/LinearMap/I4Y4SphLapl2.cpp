 ...
 * @brief Source of the implementation of the I^4 Y^4 spherical bilaplacian
 * sparse operator, with y = ax + b
 */
...
I4Y4SphLapl2::I4Y4SphLapl2(const int rows, const int cols, const Scalar_t lower,
...
I4Y4SphLapl2::ACoeff_t I4Y4SphLapl2::d_4(const ACoeff_t& n) const
{
   ...
   return (c * (l1 - n + 6.0) * (l1 + n - 5.0) * (l1 - n + 4.0) *
             (l1 + n - 3.0)) /
          (n * (n - 3.0) * (n - 1.0) * (n - 2.0));
}
...
I4Y4SphLapl2::ACoeff_t I4Y4SphLapl2::d_3(const ACoeff_t& n) const
{
   ...
   return -(a3 * b1 * (n - 4.0) * (l2 + l1 - n.pow(2) + 8.0 * n - 15.0)) /
          (2.0 * n * (n - 1.0) * (n - 2.0));
}
...
I4Y4SphLapl2::ACoeff_t I4Y4SphLapl2::d_2(const ACoeff_t& n) const
{
   ...
   return -(a2 *
             (a2 * l4 + 2.0 * a2 * l3 + 5.0 * a2 * l2 * n - 20.0 * a2 * l2 +
                5.0 * a2 * l1 * n - 21.0 * a2 * l1 - a2 * n.pow(4) +
                9.0 * a2 * n.pow(3) - 17.0 * a2 * n.pow(2) - 39.0 * a2 * n +
                108.0 * a2 + 2.0 * b2 * l2 * n.pow(2) - 4.0 * b2 * l2 * n -
                6.0 * b2 * l2 + 2.0 * b2 * l1 * n.pow(2) - 4.0 * b2 * l1 * n -
                6.0 * b2 * l1 - 6.0 * b2 * n.pow(4) + 54.0 * b2 * n.pow(3) -
                138.0 * b2 * n.pow(2) + 18.0 * b2 * n + 216.0 * b2)) /
          (4.0 * n * (n - 3.0) * (n - 1.0) * (n + 1.0));
}
...
I4Y4SphLapl2::ACoeff_t I4Y4SphLapl2::d_1(const ACoeff_t& n) const
{
   ...
   return (a1 * b1 *
             (a2 * l2 * n - 8.0 * a2 * l2 + a2 * l1 * n - 8.0 * a2 * l1 +
                3.0 * a2 * n.pow(3) - 12.0 * a2 * n.pow(2) - 15.0 * a2 * n +
                72.0 * a2 + 4.0 * b2 * n.pow(3) - 16.0 * b2 * n.pow(2) +
                4.0 * b2 * n + 24.0 * b2)) /
          (2.0 * n * (n + 1.0) * (n - 2.0));
}
...
I4Y4SphLapl2::ACoeff_t I4Y4SphLapl2::d0(const ACoeff_t& n) const
{
   ...
   const auto a4 = a2 * a2;
   const auto b4 = b2 * b2;
   return (3.0 * a4 * l4 + 6.0 * a4 * l3 + 2.0 * a4 * l2 * n.pow(2) -
             47.0 * a4 * l2 + 2.0 * a4 * l1 * n.pow(2) - 50.0 * a4 * l1 +
             3.0 * a4 * n.pow(4) - 51.0 * a4 * n.pow(2) + 228.0 * a4 +
             8.0 * a2 * b2 * l2 * n.pow(2) - 32.0 * a2 * b2 * l2 +
             8.0 * a2 * b2 * l1 * n.pow(2) - 32.0 * a2 * b2 * l1 +
             24.0 * a2 * b2 * n.pow(4) - 264.0 * a2 * b2 * n.pow(2) +
             672.0 * a2 * b2 + 8.0 * b4 * n.pow(4) - 40.0 * b4 * n.pow(2) +
             32.0 * b4) /
          (8.0 * (n - 1.0) * (n - 2.0) * (n + 2.0) * (n + 1.0));
}
...
I4Y4SphLapl2::ACoeff_t I4Y4SphLapl2::d4(const ACoeff_t& n) const
{
   ...
   const auto a2 = a1 * a1;
   const auto a4 = a2 * a2;
   return (a4 * (l1 + n + 6.0) * (l1 - n - 3.0) * (l1 + n + 4.0) *
             (l1 - n - 5.0)) /
