/**
 * @file I2Y2.cpp
 * @brief Source of the implementation of the I^2 Y^2 sparse operator, with y =
 * ax + b
 */
...
I2Y2::I2Y2(const int rows, const int cols, const Scalar_t lower,
...
{
   return Internal::Math::pow(this->a() / 2.0, 4) / (n * (n - 1.0));
}

I2Y2::ACoeff_t I2Y2::d_3(const ACoeff_t& n) const
{
   return Internal::Math::pow(this->a(), 3) * this->b() / (4.0 * n * (n - 1.0));
}
