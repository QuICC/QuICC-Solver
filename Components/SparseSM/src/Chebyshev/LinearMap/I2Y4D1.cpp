/**
 * @file I2Y4D1.cpp
 * @brief Source of the implementation of the I^2 Y^4 D sparse operator, with y
 * = ax + b
 */
...
I2Y4D1::I2Y4D1(const int rows, const int cols, const Scalar_t lower,
...
I2Y4D1::ACoeff_t I2Y4D1::d_3(const ACoeff_t& n) const
{
   ...
   const auto& b1 = this->b();
   const auto b2 = b1 * b1;
   return a3 * (n - 3.0) * (3.0 * a2 * n + 5 * a2 + 24 * b2 * (n + 1)) /
          (32.0 * n * (n - 1.0) * (n + 1.0));
}
...
I2Y4D1::ACoeff_t I2Y4D1::d_2(const ACoeff_t& n) const
{
   ...
   const auto& b1 = this->b();
   const auto b2 = b1 * b1;
   return a2 * b1 * (n - 2.0) * (a2 * (n + 2.0) + 2.0 * b2 * (n + 1.0)) /
          (2.0 * n * (n - 1.0) * (n + 1.0));
}
...
I2Y4D1::ACoeff_t I2Y4D1::d_1(const ACoeff_t& n) const
{
   ...
   const auto b4 = b2 * b2;
   return a1 *
          (a4 * (n + 5.0) + 12.0 * a2 * b2 * (n + 3.0) + 8.0 * b4 * (n + 1.0)) /
          (16.0 * n * (n + 1.0));
}
...
I2Y4D1::ACoeff_t I2Y4D1::d1(const ACoeff_t& n) const
{
   ...
   const auto b4 = b2 * b2;
   return -a1 *
          (a4 * (n - 5.0) + 12.0 * a2 * b2 * (n - 3.0) + 8 * b4 * (n - 1.0)) /
          (16.0 * n * (n - 1.0));
}
...
I2Y4D1::ACoeff_t I2Y4D1::d3(const ACoeff_t& n) const
{
   ...
   return -a3 * (n + 3.0) * (3.0 * a2 * n - 5.0 * a2 + 24 * b2 * (n - 1.0)) /
          (32.0 * n * (n - 1.0) * (n + 1.0));
}
