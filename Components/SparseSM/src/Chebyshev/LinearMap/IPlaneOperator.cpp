 ...
 * @brief Source of the base implementation of a plane layer operator with y =
 * ax + b and k1, k2 Fourier modes
 */
...
IPlaneOperator::IPlaneOperator(const int rows, const int cols,
   const Scalar_t lower, const Scalar_t upper, const Scalar_t k1,
   const Scalar_t k2) :
