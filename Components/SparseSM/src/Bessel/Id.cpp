/** 
 * @file Id.cpp
 * @brief Source of the implementation of the full sphere Bessel Id sparse operator
 */
...
namespace Bessel {
   ...
   Id::Id(const int rows, const int cols, const BesselKind type, const int l, const int s)
