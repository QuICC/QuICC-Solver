/**
 * @file SphLapl.cpp
 * @brief Source of the implementation of the full sphere Bessel SphLapl sparse operator
 */
...
namespace Bessel {
   ...
   SphLapl::SphLapl(const int rows, const int cols, const BesselKind type, const int l)
   ...
   void SphLapl::buildBanded(Internal::Matrix& bd, unsigned int& kL, unsigned int &kU) const
   {
      kL = 1;
      kU = 3;
