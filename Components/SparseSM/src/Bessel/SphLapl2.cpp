...
namespace Bessel {
   ...
   SphLapl2::SphLapl2(const int rows, const int cols, const BesselKind type, const int l)
   ...
   void SphLapl2::buildBanded(Internal::Matrix& bd, unsigned int& kL, unsigned int &kU) const
   {
      kL = 1;
      kU = 3;
