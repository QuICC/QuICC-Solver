...
ValueD2Diags::ACoeff_t ValueD2Diags::d_2(const ACoeff_t& n) const
{
   ...
   ACoeff_t num = 4.0 * (-1.0 + n) * n * (-3.0 + l1 + 2.0 * n) *
                  (19.0 + 8.0 * (-3.0 + n) * n + 2.0 * l1 * (-5.0 + 4.0 * n));
   ACoeff_t den = (-1.0 + l1 + 2.0 * n) * (3.0 + 4.0 * (-2.0 + n) * n) *
                  (3.0 + 8.0 * (-1.0 + n) * n + l1 * (-2.0 + 8.0 * n));
...
ValueD2Diags::ACoeff_t ValueD2Diags::d_1(const ACoeff_t& n) const
{
   ...
   ACoeff_t num =
      -4.0 * n * (l1 + 2.0 * n) * (7.0 + 8.0 * n * n + l1 * (2.0 + 8.0 * n));
   ACoeff_t den = (-1.0 + 2.0 * n) * (1.0 + l1 + 2.0 * n) *
                  (3.0 + 8.0 * n * (1.0 + n) + l1 * (6.0 + 8.0 * n));
