...
namespace SphEnergy {
   ...
   ValueD2Diags::ACoeff_t ValueD2Diags::d_2(const ACoeff_t& n) const
   {
      ...
      ACoeff_t num = (2.0*l1 + 4.0*n - 3.0)*(2.0*l1*n - 2.0*l1 + 2.0*n*n - 3.0*n - 1.0);
      ACoeff_t den = ((2.0*l1 + 4.0*n + 1.0)*(2.0*l1*n + 2.0*n*n + n - 2.0));
   ...
   ValueD2Diags::ACoeff_t ValueD2Diags::d_1(const ACoeff_t& n) const
   {
      ...
      ACoeff_t num = -(2.0*l1 + 4.0*n + 3.0)*(4.0*l1*n + 2.0*l1 + 4.0*n*n + 6.0*n + 1.0);
      ACoeff_t den = ((2.0*l1 + 4.0*n + 5.0)*(2.0*l1*n + 2.0*l1 + 2.0*n*n + 5.0*n + 1.0));
