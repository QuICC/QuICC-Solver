/**
 * @file I4Qp.cpp
 * @brief Source of the implementation of the full sphere Worland I4Qp sparse
 * operator
 */
...
I4Qp::I4Qp(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::SPHENERGY:
      this->mpImpl = std::make_shared<SphEnergy::I4QpDiags>(alpha, l, q);
      break;
   }
}
...
void I4Qp::buildBanded(Internal::Matrix& bd, unsigned int& kL,
