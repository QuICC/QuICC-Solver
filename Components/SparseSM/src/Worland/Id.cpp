/**
 * @file Id.cpp
 * @brief Source of the implementation of the full sphere Worland Id sparse
 * operator
 */
...
Id::Id(const int rows, const int cols, const Scalar_t alpha,
   const Scalar_t dBeta, const int l, const int q, const int s) :
