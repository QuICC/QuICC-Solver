/**
 * @file I4Lapl.cpp
 * @brief Source of the implementation of the full sphere Worland I4Lapl sparse
 * operator
 */
...
I4Lapl::I4Lapl(const int rows, const int cols, const Scalar_t alpha,
...
void I4Lapl::buildBanded(Internal::Matrix& bd, unsigned int& kL,
