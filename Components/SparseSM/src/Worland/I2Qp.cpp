/**
 * @file I2Qp.cpp
 * @brief Source of the implementation of the full sphere Worland I2Qp sparse
 * operator
 */
...
I2Qp::I2Qp(const int rows, const int cols, const Scalar_t alpha,
...
void I2Qp::buildBanded(Internal::Matrix& bd, unsigned int& kL,
