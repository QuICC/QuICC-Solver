/**
 * @file I3D3m.cpp
 * @brief Source of the implementation of the full sphere Worland I3D3m sparse
 * operator
 */
...
#include "QuICC/SparseSM/Worland/I3D3m.hpp"
...
I3D3m::I3D3m(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::CHEBYSHEV:
      this->mpImpl = std::make_shared<Chebyshev::I3D3mDiags>(alpha, l, q);
      break;
...
void I3D3m::buildTriplets(TripletList_t& list) const
{
   const int dShift = 2;
...
void I3D3m::buildBanded(Internal::Matrix& bd, unsigned int& kL,
