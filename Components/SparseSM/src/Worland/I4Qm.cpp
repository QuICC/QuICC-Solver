/**
 * @file I4Qm.cpp
 * @brief Source of the implementation of the full sphere Worland I4Qm sparse
 * operator
 */
...
I4Qm::I4Qm(const int rows, const int cols, const Scalar_t alpha,
...
void I4Qm::buildBanded(Internal::Matrix& bd, unsigned int& kL,
