...
#include "QuICC/SparseSM/Worland/I4laplD2p.hpp"
...
I4laplD2p::I4laplD2p(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::CHEBYSHEV:
      this->mpImpl = std::make_shared<Chebyshev::I4laplD2pDiags>(alpha, l, q);
      break;
...
void I4laplD2p::buildTriplets(TripletList_t& list) const
{
   const int dShift = 2;
...
void I4laplD2p::buildBanded(Internal::Matrix& bd, unsigned int& kL,
