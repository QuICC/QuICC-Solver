/**
 * @file I3Lapl.cpp
 * @brief Source of the implementation of the full sphere Worland I3Lapl sparse
 * operator
 */
...
I3Lapl::I3Lapl(const int rows, const int cols, const Scalar_t alpha,
...
void I3Lapl::buildBanded(Internal::Matrix& bd, unsigned int& kL,
