/**
 * @file I2Lapl.cpp
 * @brief Source of the implementation of the full sphere Worland I2Lapl sparse
 * operator
 */
...
I2Lapl::I2Lapl(const int rows, const int cols, const Scalar_t alpha,
...
void I2Lapl::buildBanded(Internal::Matrix& bd, unsigned int& kL,
