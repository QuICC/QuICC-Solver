...
#include "QuICC/SparseSM/Worland/I4laplDm.hpp"
...
I4laplDm::I4laplDm(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::CHEBYSHEV:
      this->mpImpl = std::make_shared<Chebyshev::I4laplDmDiags>(alpha, l, q);
      break;
...
void I4laplDm::buildTriplets(TripletList_t& list) const
{
   const int dShift = 2;
...
void I4laplDm::buildBanded(Internal::Matrix& bd, unsigned int& kL,
