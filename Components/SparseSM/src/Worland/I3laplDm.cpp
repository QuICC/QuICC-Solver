...
#include "QuICC/SparseSM/Worland/I3laplDm.hpp"
...
I3laplDm::I3laplDm(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::CHEBYSHEV:
      this->mpImpl = std::make_shared<Chebyshev::I3laplDmDiags>(alpha, l, q);
      break;
...
void I3laplDm::buildTriplets(TripletList_t& list) const
{
   const int dShift = 2;
...
void I3laplDm::buildBanded(Internal::Matrix& bd, unsigned int& kL,
