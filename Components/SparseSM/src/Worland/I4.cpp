/**
 * @file I4.cpp
 * @brief Source of the implementation of the full sphere Worland I4 sparse
 * operator
 */
...
I4::I4(const int rows, const int cols, const Scalar_t alpha,
...
void I4::buildBanded(Internal::Matrix& bd, unsigned int& kL,
