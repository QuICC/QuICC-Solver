/**
 * @file I3.cpp
 * @brief Source of the implementation of the full sphere Worland I3 sparse operator
 */
...
namespace Worland {
   ...
   I3::I3(const int rows, const int cols, const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q)
   ...
   void I3::buildBanded(Internal::Matrix& bd, unsigned int& kL, unsigned int& kU) const
   {
      kL = 1;
      kU = 5;
