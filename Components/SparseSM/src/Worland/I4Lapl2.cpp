/**
 * @file I4Lapl2.cpp
 * @brief Source of the implementation of the full sphere Worland I4Lapl2 sparse
 * operator
 */
...
I4Lapl2::I4Lapl2(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::SPHENERGY:
      this->mpImpl = std::make_shared<SphEnergy::I4Lapl2Diags>(alpha, l, q);
      break;
   }
}
...
void I4Lapl2::buildBanded(Internal::Matrix& bd, unsigned int& kL,
