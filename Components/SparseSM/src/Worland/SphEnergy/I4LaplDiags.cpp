...
namespace SphEnergy {
   ...
   I4LaplDiags::ACoeff_t I4LaplDiags::d_3(const ACoeff_t& n) const
   {
      ...
      val = 256.0*(2.0*l1 + 2.0*n - 5.0)*(2.0*l1 + 2.0*n - 3.0)*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 9.0)*(2.0*l1 + 4.0*n - 7.0)*(2.0*l1 + 4.0*n - 5.0)*(2.0*l1 + 4.0*n - 3.0)*(2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0));
   ...
   I4LaplDiags::ACoeff_t I4LaplDiags::d_2(const ACoeff_t& n) const
   {
      ...
      val = -512.0*(2.0*l1 - 2.0*n - 1.0)*(2.0*l1 + 2.0*n - 3.0)*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 7.0)*(2.0*l1 + 4.0*n - 5.0)*(2.0*l1 + 4.0*n - 3.0)*(2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0));
   ...
   I4LaplDiags::ACoeff_t I4LaplDiags::d_1(const ACoeff_t& n) const
   {
      ...
      val = 256.0*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)*(4.0*l2 - 24.0*l1*n - 16.0*l1 - 4.0*n.pow(2) + 8.0*n + 15.0)/((2.0*l1 + 4.0*n - 5.0)*(2.0*l1 + 4.0*n - 3.0)*(2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0));
   ...
   I4LaplDiags::ACoeff_t I4LaplDiags::d0(const ACoeff_t& n) const
   {
      ...
      val = 2048.0*(n + 1.0)*(2.0*l1 + 2.0*n + 1.0)*(4.0*l2 - 4.0*l1*n - 8.0*l1 - 4.0*n.pow(2) - 6.0*n + 3.0)/((2.0*l1 + 4.0*n - 3.0)*(2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0)*(2.0*l1 + 4.0*n + 9.0));
   ...
   I4LaplDiags::ACoeff_t I4LaplDiags::d1(const ACoeff_t& n) const
   {
      ...
      val = 2048.0*(n + 1.0)*(n + 2.0)*(12.0*l2 + 8.0*l1*n - 2.0*n.pow(2) - 10.0*n - 3.0)/((2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0)*(2.0*l1 + 4.0*n + 9.0)*(2.0*l1 + 4.0*n + 11.0));
   ...
   I4LaplDiags::ACoeff_t I4LaplDiags::d2(const ACoeff_t& n) const
   {
      ...
      val = 8192.0*(n + 1.0)*(n + 2.0)*(n + 3.0)*(2.0*l1 + n + 1.0)/((2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0)*(2.0*l1 + 4.0*n + 9.0)*(2.0*l1 + 4.0*n + 11.0)*(2.0*l1 + 4.0*n + 13.0));
   ...
   I4LaplDiags::ACoeff_t I4LaplDiags::d3(const ACoeff_t& n) const
   {
      ...
      val = 4096.0*(n + 1.0)*(n + 2.0)*(n + 3.0)*(n + 4.0)/((2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0)*(2.0*l1 + 4.0*n + 9.0)*(2.0*l1 + 4.0*n + 11.0)*(2.0*l1 + 4.0*n + 13.0)*(2.0*l1 + 4.0*n + 15.0));
   ...
   void I4LaplDiags::correctQ2(ACoeff_t& val, const ACoeff_t& n, const int k) const
   {
      ...
      if(this->mQ == 2 && i_ >= 0)
      {
         ...
         // Tau coefficient obtained as the ratio of I4Lapl 3rd subdiagonal/ I4 4th subdiagonal
