...
namespace SphEnergy {
   ...
   I2QpDiags::ACoeff_t I2QpDiags::d_2(const ACoeff_t& n) const
   {
      ...
      val = 16.0*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 3.0)*(2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0));
   ...
   I2QpDiags::ACoeff_t I2QpDiags::d_1(const ACoeff_t& n) const
   {
      ...
      val = -16.0*(2.0*l1 - 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0));
   ...
   I2QpDiags::ACoeff_t I2QpDiags::d0(const ACoeff_t& n) const
   {
      ...
      val = -64.0*(n + 1.0)*(2.0*l1 + n + 1.0)/((2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0));
   ...
   I2QpDiags::ACoeff_t I2QpDiags::d1(const ACoeff_t& n) const
   {
      ...
      val = -64.0*(n + 1.0)*(n + 2.0)/((2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0)*(2.0*l1 + 4.0*n + 9.0));
   ...
   void I2QpDiags::correctQ1(ACoeff_t& val, const ACoeff_t& n, const int k) const
   {
      ...
      if(this->mQ == 1 && i_ >= 0)
      {
         ...
         // Tau coefficient obtained as the ratio of I2QP 2nd subdiagonal/ I2 2nd subdiagonal
