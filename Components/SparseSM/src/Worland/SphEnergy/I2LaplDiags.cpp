...
namespace SphEnergy {
   ...
   I2LaplDiags::ACoeff_t I2LaplDiags::d_1(const ACoeff_t& n) const
   {
      ...
      val = 16.0*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0));
   ...
   I2LaplDiags::ACoeff_t I2LaplDiags::d0(const ACoeff_t& n) const
   {
      ...
      val = 64.0*(n + 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0));
   ...
   I2LaplDiags::ACoeff_t I2LaplDiags::d1(const ACoeff_t& n) const
   {
      ...
      val = 64.0*(n + 1.0)*(n + 2.0)/((2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0));
