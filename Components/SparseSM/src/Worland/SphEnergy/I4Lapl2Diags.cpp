...
namespace SphEnergy {
   ...
   I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d_2(const ACoeff_t& n) const
   {
      ...
      val = 256.0*(2.0*l1 + 2.0*n - 5.0)*(2.0*l1 + 2.0*n - 3.0)*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 5.0)*(2.0*l1 + 4.0*n - 3.0)*(2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0));
   ...
   I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d_1(const ACoeff_t& n) const
   {
      ...
      val = 2048.0*(n + 1.0)*(2.0*l1 + 2.0*n - 3.0)*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 3.0)*(2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0));
   ...
   I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d0(const ACoeff_t& n) const
   {
      ...
      val = 6144.0*(n + 1.0)*(n + 2.0)*(2.0*l1 + 2.0*n - 1.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n - 1.0)*(2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0));
   ...
   I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d1(const ACoeff_t& n) const
   {
      ...
      val = 8192.0*(n + 1.0)*(n + 2.0)*(n + 3.0)*(2.0*l1 + 2.0*n + 1.0)/((2.0*l1 + 4.0*n + 1.0)*(2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0)*(2.0*l1 + 4.0*n + 9.0));
   ...
   I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d2(const ACoeff_t& n) const
   {
      ...
      val = 4096.0*(n + 1.0)*(n + 2.0)*(n + 3.0)*(n + 4.0)/((2.0*l1 + 4.0*n + 5.0)*(2.0*l1 + 4.0*n + 7.0)*(2.0*l1 + 4.0*n + 9.0)*(2.0*l1 + 4.0*n + 11.0));
