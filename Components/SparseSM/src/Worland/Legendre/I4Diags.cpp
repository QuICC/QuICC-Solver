...
I4Diags::ACoeff_t I4Diags::d_4(const ACoeff_t& n) const
{
   ...
   val = 256.0 * (2.0 * l1 + 2.0 * n - 7.0) * (2.0 * l1 + 2.0 * n - 5.0) *
...
I4Diags::ACoeff_t I4Diags::d_3(const ACoeff_t& n) const
{
   ...
   val = -1024.0 * (2.0 * l1 - 1.0) * (2.0 * l1 + 2.0 * n - 5.0) *
         (2.0 * l1 + 2.0 * n - 3.0) * (2.0 * l1 + 2.0 * n - 1.0) /
...
I4Diags::ACoeff_t I4Diags::d_2(const ACoeff_t& n) const
{
   ...
   val =
      512.0 * (2.0 * l1 + 2.0 * n - 3.0) * (2.0 * l1 + 2.0 * n - 1.0) *
      (12.0 * l2 - 8.0 * l1 * n - 8.0 * l1 - 8.0 * n.pow(2) + 12.0 * n + 17.0) /
      ((2.0 * l1 + 4.0 * n - 11.0) * (2.0 * l1 + 4.0 * n - 9.0) *
         (2.0 * l1 + 4.0 * n - 7.0) * (2.0 * l1 + 4.0 * n - 5.0) *
         (2.0 * l1 + 4.0 * n - 3.0) * (2.0 * l1 + 4.0 * n - 1.0) *
...
I4Diags::ACoeff_t I4Diags::d0(const ACoeff_t& n) const
{
   ...
   val =
      256.0 *
      (16.0 * l4 - 192.0 * l3 * n - 128.0 * l3 - 96.0 * l2 * n.pow(2) +
         192.0 * l2 * n + 344.0 * l2 + 192.0 * l1 * n.pow(3) +
         384.0 * l1 * n.pow(2) - 144.0 * l1 * n - 352.0 * l1 + 96.0 * n.pow(4) +
         96.0 * n.pow(3) - 264.0 * n.pow(2) - 144.0 * n + 105.0) /
      ((2.0 * l1 + 4.0 * n - 7.0) * (2.0 * l1 + 4.0 * n - 5.0) *
         (2.0 * l1 + 4.0 * n - 3.0) * (2.0 * l1 + 4.0 * n - 1.0) *
         (2.0 * l1 + 4.0 * n + 3.0) * (2.0 * l1 + 4.0 * n + 5.0) *
...
I4Diags::ACoeff_t I4Diags::d1(const ACoeff_t& n) const
{
   ...
   val = 2048.0 * (2.0 * l1 - 1.0) * (n + 1.0) *
         (4.0 * l2 - 12.0 * l1 * n - 16.0 * l1 - 12.0 * n.pow(2) - 18.0 * n +
            15.0) /
         ((2.0 * l1 + 4.0 * n - 5.0) * (2.0 * l1 + 4.0 * n - 3.0) *
            (2.0 * l1 + 4.0 * n - 1.0) * (2.0 * l1 + 4.0 * n + 3.0) *
            (2.0 * l1 + 4.0 * n + 5.0) * (2.0 * l1 + 4.0 * n + 7.0) *
...
I4Diags::ACoeff_t I4Diags::d2(const ACoeff_t& n) const
{
   ...
   val =
      2048.0 * (n + 1.0) * (n + 2.0) *
      (12.0 * l2 - 8.0 * l1 * n - 24.0 * l1 - 8.0 * n.pow(2) - 20.0 * n + 9.0) /
      ((2.0 * l1 + 4.0 * n - 3.0) * (2.0 * l1 + 4.0 * n - 1.0) *
         (2.0 * l1 + 4.0 * n + 3.0) * (2.0 * l1 + 4.0 * n + 5.0) *
         (2.0 * l1 + 4.0 * n + 7.0) * (2.0 * l1 + 4.0 * n + 9.0) *
