...
I4QmDiags::I4QmDiags(const Scalar_t alpha, const int l, const int q) :
    QuICC::SparseSM::Worland::I4QmDiags(alpha, MHD_MP(-0.5), l, q),
    mI4(alpha, l, 0)
{
   if (q > 2)
   {
...
I4QmDiags::ACoeff_t I4QmDiags::d_3(const ACoeff_t& n) const
{
   ...
   val = -32.0 * (l1 + n - 4.0) * (l1 + n - 3.0) * (l1 + n - 2.0) *
         (l1 + n - 1.0) /
...
I4QmDiags::ACoeff_t I4QmDiags::d_1(const ACoeff_t& n) const
{
   ...
   val = -24.0 * (l1 + n - 2.0) * (l1 + n - 1.0) *
         (4.0 * l2 - 8.0 * l1 * n - 4.0 * n.pow(2) + 8.0 * n + 5.0) /
...
I4QmDiags::ACoeff_t I4QmDiags::d0(const ACoeff_t& n) const
{
   ...
   val = 4.0 * (l1 + n - 1.0) *
         (8.0 * l3 - 72.0 * l2 * n - 12.0 * l2 - 24.0 * l1 * n.pow(2) +
            72.0 * l1 * n + 58.0 * l1 + 24.0 * n.pow(3) + 12.0 * n.pow(2) -
            54.0 * n - 27.0) /
         ((l1 + 2.0 * n - 4.0) * (l1 + 2.0 * n - 3.0) * (l1 + 2.0 * n - 2.0) *
...
I4QmDiags::ACoeff_t I4QmDiags::d1(const ACoeff_t& n) const
{
   ...
   val = 2.0 * (2.0 * n + 1.0) *
         (32.0 * l3 - 48.0 * l2 * n - 72.0 * l2 - 96.0 * l1 * n.pow(2) -
            48.0 * l1 * n + 112.0 * l1 - 24.0 * n.pow(3) + 12.0 * n.pow(2) +
            54.0 * n - 27.0) /
         ((l1 + 2.0 * n - 3.0) * (l1 + 2.0 * n - 2.0) * (l1 + 2.0 * n - 1.0) *
...
I4QmDiags::ACoeff_t I4QmDiags::d2(const ACoeff_t& n) const
{
   ...
   val = 3.0 * (2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * l1 + 2.0 * n + 1.0) *
         (8.0 * l2 - 8.0 * l1 - 4.0 * n.pow(2) - 8.0 * n + 5.0) /
         ((l1 + n) * (l1 + 2.0 * n - 2.0) * (l1 + 2.0 * n - 1.0) *
            (l1 + 2.0 * n + 1.0) * (l1 + 2.0 * n + 2.0) * (l1 + 2.0 * n + 3.0) *
...
I4QmDiags::ACoeff_t I4QmDiags::d3(const ACoeff_t& n) const
{
   ...
   val = (2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * n + 5.0) *
         (2.0 * l1 + 2.0 * n + 1.0) * (2.0 * l1 + 2.0 * n + 3.0) *
         (8.0 * l1 + 2.0 * n - 1.0) /
         (2.0 * (l1 + n) * (l1 + n + 1.0) * (l1 + 2.0 * n - 1.0) *
            (l1 + 2.0 * n + 1.0) * (l1 + 2.0 * n + 2.0) * (l1 + 2.0 * n + 3.0) *
