...
I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d_2(const ACoeff_t& n) const
{
   ...
   val = 64.0 * (l1 + n - 2.0) * (l1 + n - 1.0) * (2.0 * l1 + 2.0 * n - 5.0) *
         (2.0 * l1 + 2.0 * n - 3.0) /
...
I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d_1(const ACoeff_t& n) const
{
   ...
   val = 128.0 * (l1 + n - 1.0) * (2.0 * l1 + 2.0 * n - 3.0) *
         (4.0 * l1 * n + 4.0 * n.pow(2) - 4.0 * n - 3.0) /
...
I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d0(const ACoeff_t& n) const
{
   ...
   val = 96.0 * (2.0 * n + 1.0) * (2.0 * l1 + 2.0 * n - 1.0) *
         (4.0 * l1 * n + 2.0 * l1 + 4.0 * n.pow(2) - 5.0) /
...
I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d1(const ACoeff_t& n) const
{
   ...
   val = 32.0 * (2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * l1 + 2.0 * n + 1.0) *
         (4.0 * l1 * n + 4.0 * l1 + 4.0 * n.pow(2) + 4.0 * n - 3.0) /
         ((l1 + n) * (l1 + 2.0 * n - 1.0) * (l1 + 2.0 * n + 1.0) *
...
I4Lapl2Diags::ACoeff_t I4Lapl2Diags::d2(const ACoeff_t& n) const
{
   ...
   val = 4.0 * (2.0 * n + 1.0) * (2.0 * n + 3.0).pow(2) * (2.0 * n + 5.0) *
