 ...
 * @brief Source of the implementation of the full sphere Worland I3LaplDiags sparse operator
 */
...
namespace Chebyshev {
   ...
   I3LaplDiags::I3LaplDiags(const Scalar_t alpha, const int l, const int q)
      : QuICC::SparseSM::Worland::I3LaplDiags(alpha, MHD_MP(-0.5), l, q), mI3(alpha,l,0)
   {
      if(q > 2)
      {
   ...
   I3LaplDiags::ACoeff_t I3LaplDiags::d_2(const ACoeff_t& n) const
   {
      ...
      val = 16.0_mp*(l<1>() + n - 2.0_mp)*(l<1>() + n - 1.0_mp)*(2.0_mp*l<1>() + 2.0_mp*n - 3.0_mp)/((l<1>() + 2.0_mp*n - 4.0_mp)*(l<1>() + 2.0_mp*n - 3.0_mp)*(l<1>() + 2.0_mp*n - 2.0_mp)*(l<1>() + 2.0_mp*n - 1.0_mp));
   ...
   I3LaplDiags::ACoeff_t I3LaplDiags::d_1(const ACoeff_t& n) const
   {
      ...
      val = -16.0_mp*(l<1>() + n - 1.0_mp)*(2.0_mp*l<2>() - 2.0_mp*l<1>()*n - l<1>() - 4.0_mp*n*n + 4.0_mp*n + 3.0_mp)/((l<1>() + 2.0_mp*n - 3.0_mp)*(l<1>() + 2.0_mp*n - 2.0_mp)*(l<1>() + 2.0_mp*n - 1.0_mp)*(l<1>() + 2.0_mp*n + 1.0_mp));
   ...
   I3LaplDiags::ACoeff_t I3LaplDiags::d0(const ACoeff_t& n) const
   {
      ...
      val = -8.0_mp*(12.0_mp*l<2>()*n + 2.0_mp*l<2>() + 12.0_mp*l<1>()*n*n - 4.0_mp*l<1>()*n - 9.0_mp*l<1>() - 4.0_mp*n*n + 1.0_mp)/((l<1>() + 2.0_mp*n - 2.0_mp)*(l<1>() + 2.0_mp*n - 1.0_mp)*(l<1>() + 2.0_mp*n + 1.0_mp)*(l<1>() + 2.0_mp*n + 2.0_mp));
   ...
   I3LaplDiags::ACoeff_t I3LaplDiags::d1(const ACoeff_t& n) const
   {
      ...
      val = -4.0_mp*(2.0_mp*n + 1.0_mp)*(2.0_mp*l<1>() + 2.0_mp*n + 1.0_mp)*(6.0_mp*l<1>()*n + 5.0_mp*l<1>() + 4.0_mp*n*n + 4.0_mp*n - 3.0_mp)/((l<1>() + n)*(l<1>() + 2.0_mp*n - 1.0_mp)*(l<1>() + 2.0_mp*n + 1.0_mp)*(l<1>() + 2.0_mp*n + 2.0_mp)*(l<1>() + 2.0_mp*n + 3.0_mp));
   ...
   I3LaplDiags::ACoeff_t I3LaplDiags::d2(const ACoeff_t& n) const
   {
      ...
      val = -(2.0_mp*n + 1.0_mp)*(2.0_mp*n + 3.0_mp).pow(2)*(2.0_mp*l<1>() + 2.0_mp*n + 1.0_mp)*(2.0_mp*l<1>() + 2.0_mp*n + 3.0_mp)/((l<1>() + n)*(l<1>() + n + 1.0_mp)*(l<1>() + 2.0_mp*n + 1.0_mp)*(l<1>() + 2.0_mp*n + 2.0_mp)*(l<1>() + 2.0_mp*n + 3.0_mp)*(l<1>() + 2.0_mp*n + 4.0_mp));
