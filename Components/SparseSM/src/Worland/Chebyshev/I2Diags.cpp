...
I2Diags::ACoeff_t I2Diags::d_2(const ACoeff_t& n) const
{
   ...
   {
      val = 4.0 * (l1 + n - 2.0) * (l1 + n - 1.0) /
            ((l1 + 2.0 * n - 4.0) * (l1 + 2.0 * n - 3.0) *
...
I2Diags::ACoeff_t I2Diags::d0(const ACoeff_t& n) const
{
   ...
   val = 2.0 * (2.0 * l2 - 4.0 * l1 * n - 4.0 * n.pow(2) + 1.0) /
...
I2Diags::ACoeff_t I2Diags::d1(const ACoeff_t& n) const
{
   ...
   val = 2.0 * l1 * (2.0 * n + 1.0) * (2.0 * l1 + 2.0 * n + 1.0) /
...
I2Diags::ACoeff_t I2Diags::d2(const ACoeff_t& n) const
{
   ...
   val = (2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * l1 + 2.0 * n + 1.0) *
         (2.0 * l1 + 2.0 * n + 3.0) /
         (4.0 * (l1 + n) * (l1 + n + 1.0) * (l1 + 2.0 * n + 1.0) *
