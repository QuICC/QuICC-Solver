...
I3Diags::ACoeff_t I3Diags::d_3(const ACoeff_t& n) const
{
   ...
   if (l<1>() == 0)
   {
      val = 1.0_mp / ((2.0_mp * n - 5.0_mp) * (2.0_mp * n - 3.0_mp) *
                        (2.0_mp * n - 1.0_mp));
      val.head(1) =
         8.0_mp / ((l<1>() + 3.0_mp) * (l<1>() + 4.0_mp) * (l<1>() + 5.0_mp));
   }
   else
   {
      val = 8.0_mp * (l<1>() + n - 3.0_mp) * (l<1>() + n - 2.0_mp) *
            (l<1>() + n - 1.0_mp) /
...
I3Diags::ACoeff_t I3Diags::d_2(const ACoeff_t& n) const
{
   ...
   val = -24.0_mp * l<1>() * (l<1>() + n - 2.0_mp) * (l<1>() + n - 1.0_mp) /
...
I3Diags::ACoeff_t I3Diags::d_1(const ACoeff_t& n) const
{
   ...
   val = 6.0_mp * (l<1>() + n - 1.0_mp) *
         (4.0_mp * l<2>() - 4.0_mp * l<1>() * n + 2.0_mp * l<1>() -
...
I3Diags::ACoeff_t I3Diags::d0(const ACoeff_t& n) const
{
   ...
   val = -4.0_mp * l<1>() *
         (2.0_mp * l<2>() - 12.0_mp * l<1>() * n - 12.0_mp * n * n + 7.0_mp) /
         ((l<1>() + 2.0_mp * n - 3.0_mp) * (l<1>() + 2.0_mp * n - 2.0_mp) *
            (l<1>() + 2.0_mp * n - 1.0_mp) * (l<1>() + 2.0_mp * n + 1.0_mp) *
...
I3Diags::ACoeff_t I3Diags::d1(const ACoeff_t& n) const
{
   ...
   val = -3.0_mp * (2.0_mp * n + 1.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n + 1.0_mp) *
         (4.0_mp * l<2>() - 4.0_mp * l<1>() * n - 2.0_mp * l<1>() -
            4.0_mp * n * n - 4.0_mp * n + 3.0_mp) /
         (2.0_mp * (l<1>() + n) * (l<1>() + 2.0_mp * n - 2.0_mp) *
            (l<1>() + 2.0_mp * n - 1.0_mp) * (l<1>() + 2.0_mp * n + 1.0_mp) *
            (l<1>() + 2.0_mp * n + 2.0_mp) * (l<1>() + 2.0_mp * n + 3.0_mp) *
            (l<1>() + 2.0_mp * n + 4.0_mp));
...
I3Diags::ACoeff_t I3Diags::d2(const ACoeff_t& n) const
{
   ...
   val = -3.0_mp * l<1>() * (2.0_mp * n + 1.0_mp) * (2.0_mp * n + 3.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n + 1.0_mp) *
...
I3Diags::ACoeff_t I3Diags::d3(const ACoeff_t& n) const
{
   ...
   val =
      -(2.0_mp * n + 1.0_mp) * (2.0_mp * n + 3.0_mp) * (2.0_mp * n + 5.0_mp) *
      (2.0_mp * l<1>() + 2.0_mp * n + 1.0_mp) *
      (2.0_mp * l<1>() + 2.0_mp * n + 3.0_mp) *
      (2.0_mp * l<1>() + 2.0_mp * n + 5.0_mp) /
      (8.0_mp * (l<1>() + n) * (l<1>() + n + 1.0_mp) * (l<1>() + n + 2.0_mp) *
         (l<1>() + 2.0_mp * n + 1.0_mp) * (l<1>() + 2.0_mp * n + 2.0_mp) *
