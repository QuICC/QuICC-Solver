 ...
 * @brief Source of the implementation of the full sphere Worland I3laplDmDiags
 * sparse operator
 *
...
// Project includes
//
#include "QuICC/SparseSM/Worland/Chebyshev/I3laplDmDiags.hpp"
...
I3laplDmDiags::I3laplDmDiags(const Scalar_t alpha, const int l, const int q) :
    QuICC::SparseSM::Worland::I3laplDmDiags(alpha, MHD_MP(-0.5), l, q)
{
   if (q > 0)
   {
      throw std::logic_error("I3laplDm: truncation (q>0) not supported - build "
                             "with TRUNCATE_QI=OFF");
   }
}

I3laplDmDiags::ACoeff_t I3laplDmDiags::d_1(const ACoeff_t& n) const
{
   ACoeff_t val;
...
I3laplDmDiags::ACoeff_t I3laplDmDiags::d0(const ACoeff_t& n) const
{
   ACoeff_t val;
...
I3laplDmDiags::ACoeff_t I3laplDmDiags::d1(const ACoeff_t& n) const
{
   ACoeff_t val;
   val = 8.0_mp * (2.0_mp * n + 1.0_mp) *
         (12.0_mp * l<1>() * n + 10.0_mp * l<1>() + 12.0_mp * n * n +
            8.0_mp * n - 7.0_mp) /
...
I3laplDmDiags::ACoeff_t I3laplDmDiags::d2(const ACoeff_t& n) const
{
   ACoeff_t val;
