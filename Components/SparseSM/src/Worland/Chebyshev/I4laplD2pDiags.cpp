 ...
 * @brief Source of the implementation of the full sphere Worland I4laplD2pDiags
 * sparse operator
 *
...
// Project includes
//
#include "QuICC/SparseSM/Worland/Chebyshev/I4laplD2pDiags.hpp"
...
I4laplD2pDiags::I4laplD2pDiags(const Scalar_t alpha, const int l, const int q) :
    QuICC::SparseSM::Worland::I4laplD2pDiags(alpha, MHD_MP(-0.5), l, q)
{
   if (q > 0)
   {
      throw std::logic_error(
         "I4laplD2p: truncation (q>0) not supported - build with "
         "TRUNCATE_QI=OFF");
   }
}

I4laplD2pDiags::ACoeff_t I4laplD2pDiags::d_3(const ACoeff_t& n) const
{
   ACoeff_t val;
...
I4laplD2pDiags::ACoeff_t I4laplD2pDiags::d_2(const ACoeff_t& n) const
{
   ACoeff_t val;
   val = 64.0_mp * (2.0_mp * l<1>() + 2.0_mp * n - 3.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n - 1.0_mp) *
         (4.0_mp * l<1>() * n - l<1>() + 4.0_mp * n * n - 2.0_mp * n - 2.0_mp) /
         ((l<1>() + 2.0_mp * n - 3.0_mp) * (l<1>() + 2.0_mp * n - 2.0_mp) *
            (l<1>() + 2.0_mp * n - 1.0_mp) * (l<1>() + 2.0_mp * n + 1.0_mp));
   return this->normalizeDiag(n, -2, 2) * val;
}

I4laplD2pDiags::ACoeff_t I4laplD2pDiags::d_1(const ACoeff_t& n) const
{
   ACoeff_t val;
   val = 48.0_mp * (2.0_mp * n + 1.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n - 1.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n + 1.0_mp) *
         (4.0_mp * l<1>() * n + 4.0_mp * n * n - 3.0_mp) /
...
I4laplD2pDiags::ACoeff_t I4laplD2pDiags::d0(const ACoeff_t& n) const
{
   ACoeff_t val;
...
I4laplD2pDiags::ACoeff_t I4laplD2pDiags::d1(const ACoeff_t& n) const
{
   ACoeff_t val;
   val = 2.0_mp * (2.0_mp * n + 1.0_mp) * (2.0_mp * n + 1.0_mp) *
