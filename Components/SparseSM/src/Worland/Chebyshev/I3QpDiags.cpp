/**
 * @file I3QpDiags.cpp
 * @brief Source of the implementation of the full sphere Worland I3QpDiags
 * sparse operator
 */
...
I3QpDiags::I3QpDiags(const Scalar_t alpha, const int l, const int q) :
    QuICC::SparseSM::Worland::I3QpDiags(alpha, MHD_MP(-0.5), l, q),
    mI2(alpha, l, 0)
{
   if (q > 1)
   {
...
{
   ACoeff_t val;
   val = 8.0_mp * (l<1>() + n - 2.0_mp) * (l<1>() + n - 1.0_mp) *
...
{
   ACoeff_t val;
   val = -4.0_mp * (l<1>() + n - 1.0_mp) *
         (8.0_mp * l<2>() + 4.0_mp * l<1>() * n - 2.0_mp * l<1>() -
            4.0_mp * n * n + 8.0_mp * n + 5.0_mp) /
...
I3QpDiags::ACoeff_t I3QpDiags::d_1(const ACoeff_t& n) const
{
   ACoeff_t val;
   val = 4.0_mp *
         (4.0_mp * l<3>() - 12.0_mp * l<2>() * n + 6.0_mp * l<2>() -
            24.0_mp * l<1>() * n * n + 12.0_mp * l<1>() * n + 20.0_mp * l<1>() -
            8.0_mp * n * n * n + 4.0_mp * n * n + 10.0_mp * n + 3.0_mp) /
         ((l<1>() + 2.0_mp * n - 3.0_mp) * (l<1>() + 2.0_mp * n - 2.0_mp) *
...
{
   ACoeff_t val;
   val = 2.0_mp * (2.0_mp * l<1>() + 2.0_mp * n + 1.0_mp) *
         (12.0_mp * l<2>() * n + 2.0_mp * l<2>() + 4.0_mp * l<1>() * n -
            10.0_mp * l<1>() - 8.0_mp * n * n * n - 4.0_mp * n * n +
            10.0_mp * n - 3.0_mp) /
...
{
   ACoeff_t val;
   val = (2.0_mp * n + 1.0_mp) * (2.0_mp * l<1>() + 2.0_mp * n + 1.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n + 3.0_mp) *
         (12.0_mp * l<1>() * n + 10.0_mp * l<1>() + 4.0_mp * n * n +
            8.0_mp * n - 5.0_mp) /
         (2.0_mp * (l<1>() + n) * (l<1>() + n + 1.0_mp) *
            (l<1>() + 2.0_mp * n - 1.0_mp) * (l<1>() + 2.0_mp * n + 1.0_mp) *
            (l<1>() + 2.0_mp * n + 2.0_mp) * (l<1>() + 2.0_mp * n + 3.0_mp) *
            (l<1>() + 2.0_mp * n + 4.0_mp));
...
{
   ACoeff_t val;
   val = (2.0_mp * n + 1.0_mp) * (2.0_mp * n + 3.0_mp) * (2.0_mp * n + 3.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n + 1.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n + 3.0_mp) *
         (2.0_mp * l<1>() + 2.0_mp * n + 5.0_mp) /
         (4.0_mp * (l<1>() + n) * (l<1>() + n + 1.0_mp) *
