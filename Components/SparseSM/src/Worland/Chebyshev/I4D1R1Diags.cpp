 ...
 * @brief Source of the implementation of the full sphere Worland I4D1R1Diags
 * sparse operator
 */
...
I4D1R1Diags::ACoeff_t I4D1R1Diags::d2(const ACoeff_t& n) const
{
   ...
   val = 3.0 * (2.0 * n + 1.0) * (2.0 * n + 3.0) /
         (16.0 * n * (n + 1.0).pow(2) * (n + 2.0) * (n + 3.0));
...
I4D1R1Diags::ACoeff_t I4D1R1Diags::d3(const ACoeff_t& n) const
{
   ...
   val = -(2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * n + 5.0) /
         (32.0 * n * (n + 1.0).pow(2) * (n + 2.0).pow(2) * (n + 3.0));
...
I4D1R1Diags::ACoeff_t I4D1R1Diags::d4(const ACoeff_t& n) const
{
   ...
   val = -(2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * n + 5.0) *
         (2.0 * n + 7.0) /
         (64.0 * (n + 1.0).pow(2) * (n + 2.0).pow(2) * (n + 3.0).pow(2) *
            (n + 4.0));
