...
I4QpDiags::I4QpDiags(const Scalar_t alpha, const int l, const int q) :
    QuICC::SparseSM::Worland::I4QpDiags(alpha, MHD_MP(-0.5), l, q),
    mI4(alpha, l, 0)
{
   if (q > 2)
   {
...
I4QpDiags::ACoeff_t I4QpDiags::d_4(const ACoeff_t& n) const
{
   ...
   val = 16.0 * (l1 + n - 3.0) * (l1 + n - 2.0) * (l1 + n - 1.0) *
         (2.0 * l1 + 2.0 * n - 5.0) /
...
I4QpDiags::ACoeff_t I4QpDiags::d_3(const ACoeff_t& n) const
{
   ...
   val =
      -8.0 * (l1 + n - 2.0) * (l1 + n - 1.0) *
      (12.0 * l2 + 8.0 * l1 * n - 16.0 * l1 - 4.0 * n.pow(2) + 12.0 * n + 7.0) /
...
I4QpDiags::ACoeff_t I4QpDiags::d_2(const ACoeff_t& n) const
{
   ...
   val = 12.0 * (l1 + n - 1.0) *
         (8.0 * l3 - 8.0 * l2 * n + 4.0 * l2 - 24.0 * l1 * n.pow(2) +
            40.0 * l1 * n + 26.0 * l1 - 8.0 * n.pow(3) + 20.0 * n.pow(2) +
            2.0 * n - 5.0) /
...
I4QpDiags::ACoeff_t I4QpDiags::d_1(const ACoeff_t& n) const
{
   ...
   val = -2.0 *
         (16.0 * l4 - 128.0 * l3 * n + 32.0 * l3 - 192.0 * l2 * n.pow(2) +
            96.0 * l2 * n + 272.0 * l2 + 32.0 * l1 * n + 112.0 * l1 +
            48.0 * n.pow(4) - 48.0 * n.pow(3) - 144.0 * n.pow(2) + 108.0 * n +
            81.0) /
         ((l1 + 2.0 * n - 4.0) * (l1 + 2.0 * n - 3.0) * (l1 + 2.0 * n - 2.0) *
...
I4QpDiags::ACoeff_t I4QpDiags::d0(const ACoeff_t& n) const
{
   ...
   val = -(2.0 * l1 + 2.0 * n + 1.0) *
         (64.0 * l3 * n + 16.0 * l3 - 96.0 * l2 * n.pow(2) - 48.0 * l2 * n -
            96.0 * l2 - 192.0 * l1 * n.pow(3) - 144.0 * l1 * n.pow(2) +
            320.0 * l1 * n - 4.0 * l1 - 48.0 * n.pow(4) - 48.0 * n.pow(3) +
            144.0 * n.pow(2) + 108.0 * n - 81.0) /
         ((l1 + n) * (l1 + 2.0 * n - 3.0) * (l1 + 2.0 * n - 2.0) *
            (l1 + 2.0 * n - 1.0) * (l1 + 2.0 * n + 1.0) * (l1 + 2.0 * n + 2.0) *
            (l1 + 2.0 * n + 3.0) * (l1 + 2.0 * n + 4.0));
...
I4QpDiags::ACoeff_t I4QpDiags::d1(const ACoeff_t& n) const
{
   ...
   val = -3.0 * (2.0 * n + 1.0) * (2.0 * l1 + 2.0 * n + 1.0) *
         (2.0 * l1 + 2.0 * n + 3.0) *
         (16.0 * l2 * n + 16.0 * l2 - 24.0 * l1 - 8.0 * n.pow(3) -
            20.0 * n.pow(2) + 2.0 * n + 5.0) /
         (2.0 * (l1 + n) * (l1 + n + 1.0) * (l1 + 2.0 * n - 2.0) *
            (l1 + 2.0 * n - 1.0) * (l1 + 2.0 * n + 1.0) * (l1 + 2.0 * n + 2.0) *
...
I4QpDiags::ACoeff_t I4QpDiags::d2(const ACoeff_t& n) const
{
   ...
   val =
      -(2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * l1 + 2.0 * n + 1.0) *
      (2.0 * l1 + 2.0 * n + 3.0) * (2.0 * l1 + 2.0 * n + 5.0) *
      (16.0 * l1 * n + 28.0 * l1 + 4.0 * n.pow(2) + 12.0 * n - 7.0) /
      (4.0 * (l1 + n) * (l1 + n + 1.0) * (l1 + n + 2.0) * (l1 + 2.0 * n - 1.0) *
...
I4QpDiags::ACoeff_t I4QpDiags::d3(const ACoeff_t& n) const
{
   ...
   val = -(2.0 * n + 1.0) * (2.0 * n + 3.0) * (2.0 * n + 5.0).pow(2) *
...
void I4QpDiags::correctQ2(ACoeff_t& val, const ACoeff_t& n, const int k) const
{
   ...
   if (this->mQ == 2)
   {
      ...
      ACoeff_t f =
         (2.0 * l1 + 2.0 * m - 1.0) * (l1 + 2.0 * m - 4.0) / (l1 + m - 2.0);
      ACoeff_t ncA =
      ...
      m = n.bottomRows(1) - 1;
      ACoeff_t num = -2.0 *
                     (4.0 * l2 + 4.0 * l1 - 4.0 * m.pow(2) + 4.0 * m + 3.0) /
                     ((l1 + 2.0 * m + 1.0));
      num *= this->normalizeDiag(m, -1, 1);
      ACoeff_t prod = -8.0 * l1 * (l1 + m - 1.0) /
                      ((l1 + 2.0 * m - 3.0) * (l1 + 2.0 * m + 1.0));
      prod *= this->normalizeDiag(m, -1);
      ACoeff_t den = 4.0 * (l1 + m - 2.0) * (l1 + m - 1.0) /
                     ((l1 + 2.0 * m - 4.0) * (l1 + 2.0 * m - 3.0));
