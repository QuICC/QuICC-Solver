/**
 * @file I3QmDiags.cpp
 * @brief Source of the implementation of the full sphere Worland I3QmDiags
 * sparse operator
 */
...
I3QmDiags::ACoeff_t I3QmDiags::d_2(const ACoeff_t& n) const
{
   ...
   val = -16.0_mp * (l<1>() + n - 3.0_mp) * (l<1>() + n - 2.0_mp) *
         (l<1>() + n - 1.0_mp) /
...
{
   ACoeff_t val;
   val = -8.0_mp * (l<1>() + n - 1.0_mp) *
         (2.0_mp * l<2>() - 8.0_mp * l<1>() * n - 2.0_mp * l<1>() -
...
I3QmDiags::ACoeff_t I3QmDiags::d1(const ACoeff_t& n) const
{
   ...
   val = -4.0_mp * (2.0_mp * n + 1.0_mp) *
         (6.0_mp * l<2>() - 6.0_mp * l<1>() - 4.0_mp * n * n - 4.0_mp * n +
            3.0_mp) /
         ((l<1>() + 2.0_mp * n - 2.0_mp) * (l<1>() + 2.0_mp * n - 1.0_mp) *
