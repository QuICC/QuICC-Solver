/**
 * @file I2Qm.cpp
 * @brief Source of the implementation of the full sphere Worland I2Qm sparse
 * operator
 */
...
I2Qm::I2Qm(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::SPHENERGY:
      this->mpImpl = std::make_shared<SphEnergy::I2QmDiags>(alpha, l, q);
      break;
   }
}
...
void I2Qm::buildBanded(Internal::Matrix& bd, unsigned int& kL,
