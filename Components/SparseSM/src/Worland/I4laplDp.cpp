...
#include "QuICC/SparseSM/Worland/I4laplDp.hpp"
...
I4laplDp::I4laplDp(const int rows, const int cols, const Scalar_t alpha,
    ...
    IWorlandOperator(rows, cols, alpha, dBeta)
{
   ...
   case WorlandKind::CHEBYSHEV:
      this->mpImpl = std::make_shared<Chebyshev::I4laplDpDiags>(alpha, l, q);
      break;
...
void I4laplDp::buildTriplets(TripletList_t& list) const
{
   const int dShift = 2;
...
void I4laplDp::buildBanded(Internal::Matrix& bd, unsigned int& kL,
