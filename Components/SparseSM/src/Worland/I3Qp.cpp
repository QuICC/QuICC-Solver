...
namespace Worland {
   ...
   I3Qp::I3Qp(const int rows, const int cols, const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q)
   ...
   void I3Qp::buildBanded(Internal::Matrix& bd, unsigned int& kL, unsigned int &kU) const
   {
