...
#ifndef QUICC_SPARSESM_BESSEL_VALUE_SPHLAPLDIAGS_HPP
#define QUICC_SPARSESM_BESSEL_VALUE_SPHLAPLDIAGS_HPP
...
#endif // QUICC_SPARSESM_BESSEL_VALUE_SPHLAPLDIAGS_HPP
