/**
 * @file I3Y4.hpp
 * @brief Implementation of the I^3 Y^4 sparse operator, with y = ax + b
 */

#ifndef QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I3Y4_HPP
#define QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I3Y4_HPP
...
namespace LinearMap {
    ...
    * @brief Implementation of the I^3 Y^4 sparse operator, with y = ax + b
    */
   class I3Y4: public ILinearMapOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I3Y4(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper);

         /**
          * @brief Destructor
          */
         virtual ~I3Y4() = default;
...
#endif // QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I3Y4_HPP
