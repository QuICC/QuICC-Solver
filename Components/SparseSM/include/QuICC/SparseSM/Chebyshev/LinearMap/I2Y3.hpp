/**
 * @file I2Y3.hpp
 * @brief Implementation of the I^2 Y^3 sparse operator, with y = ax + b
 */

#ifndef QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y3_HPP
#define QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y3_HPP
...
namespace LinearMap {
    ...
    * @brief Implementation of the I^2 Y^3 sparse operator, with y = ax + b
    */
   class I2Y3: public ILinearMapOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I2Y3(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper);

         /**
          * @brief Destructor
          */
         virtual ~I2Y3() = default;
...
#endif // QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y3_HPP
