/**
 * @file Id.hpp
 * @brief Implementation of the Chebyshev linear map generalized identity sparse
 * operator. Part of the top/bottom can be made zero and it doesn't need to be
 * square.
 */
...
public:
    ...
    */
   Id(const int rows, const int cols, const Scalar_t lower,
      const Scalar_t upper, const int q = 0, const int s = 0);
