/**
 * @file I2Y4.hpp
 * @brief Implementation of the I^2 Y^4 sparse operator, with y = ax + b
 */

#ifndef QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y4_HPP
#define QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y4_HPP
...
namespace LinearMap {
    ...
    * @brief Implementation of the I^2 Y^4 sparse operator, with y = ax + b
    */
   class I2Y4: public ILinearMapOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I2Y4(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper);

         /**
          * @brief Destructor
          */
         virtual ~I2Y4() = default;
...
#endif // QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y4_HPP
