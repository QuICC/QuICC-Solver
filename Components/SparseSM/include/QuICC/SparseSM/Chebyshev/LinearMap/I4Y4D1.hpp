/**
 * @file I4Y4D1.hpp
 * @brief Implementation of the I^4 Y^4 D sparse operator, with y = ax + b
 */

#ifndef QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I4Y4D1_HPP
#define QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I4Y4D1_HPP
...
namespace LinearMap {
   ...
   /**
    * @brief Implementation of the I^4 Y^3 D sparse operator, with y = ax + b
    */
   class I4Y4D1: public ILinearMapOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I4Y4D1(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper);

         /**
          * @brief Destructor
          */
         virtual ~I4Y4D1() = default;
...
#endif // QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I4Y4D1_HPP
