/**
 * @file Operator.hpp
 * @brief Implementation of the bounary operator for Chebyshev linear map
 * polynomials
 */
...
/**
 * @brief Implementation of the boundary operator for Chebyshev linear map
 * polynomial
 */
...
public:
    ...
    */
   Operator(const int rows, const int cols, const Scalar_t lower,
      const Scalar_t upper, const bool atTop = true);
   ...
   void addRow(const ICondition::Position pos, const int l);
...
template <typename TCondition>
void Operator::addRow(const ICondition::Position pos)
{
...
template <typename TCondition>
void Operator::addRow(const ICondition::Position pos, const int l)
{
...
template <typename TCondition> 
void Operator::addRow(const ICondition::Position pos, const MHDFloat Fb)
   {
