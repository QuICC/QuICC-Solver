/**
 * @file ICondition.hpp
 * @brief Implementation of the generic interface for a boundary condition for
 * the Cheyshev sparse operator based on a linear map y = ax + b, x = [-1, 1]
 * (natural chebyshev grid)
 */
