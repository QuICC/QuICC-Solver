/**
 * @file I2Y2D1.hpp
 * @brief Implementation of the I^2 Y2 D1 sparse operator, with y = ax + b
 */

#ifndef QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y2D1_HPP
#define QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y2D1_HPP
...
namespace LinearMap {
    ...
    * @brief Implementation of the I^2 Y2 D1 sparse operator, with y = ax + b
    */
   class I2Y2D1: public ILinearMapOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I2Y2D1(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper);

         /**
          * @brief Destructor
          */
         virtual ~I2Y2D1() = default;
...
#endif // QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y2D1_HPP
