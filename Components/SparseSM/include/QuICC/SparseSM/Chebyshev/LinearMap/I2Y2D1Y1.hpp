/**
 * @file I2Y2D1Y1.hpp
 * @brief Implementation of the I^2 Y^2 D Y sparse operator, with y = ax + b
 */

#ifndef QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y2D1Y1_HPP
#define QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y2D1Y1_HPP
...
namespace LinearMap {
    ...
    * @brief Implementation of the I^2 Y^2 D Y sparse operator, with y = ax + b
    */
   class I2Y2D1Y1: public ILinearMapOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I2Y2D1Y1(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper);
...
#endif // QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I2Y2D1Y1_HPP
