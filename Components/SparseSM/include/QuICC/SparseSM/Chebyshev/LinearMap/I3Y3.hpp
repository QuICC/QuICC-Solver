/**
 * @file I3Y3.hpp
 * @brief Implementation of the I^3 Y^3 sparse operator, with y = ax + b
 */

#ifndef QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I3Y3_HPP
#define QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I3Y3_HPP
...
namespace LinearMap {
    ...
    * @brief Implementation of the I^3 Y^3 sparse operator, with y = ax + b
    */
   class I3Y3: public ILinearMapOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I3Y3(const int rows, const int cols, const Scalar_t lower, const Scalar_t upper);

         /**
          * @brief Destructor
          */
         virtual ~I3Y3() = default;
...
#endif // QUICC_SPARSESM_CHEBYSHEV_LINEARMAP_I3Y3_HPP
