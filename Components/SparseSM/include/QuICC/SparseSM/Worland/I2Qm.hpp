...
#ifndef QUICC_SPARSESM_WORLAND_I2QM_HPP
#define QUICC_SPARSESM_WORLAND_I2QM_HPP
...
namespace Worland {
    ...
    * @brief Implementation of the full sphere Worland I2 of Coriolis Q on l-1 sparse operator
    */
   class I2Qm: public IWorlandOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I2Qm(const int rows, const int cols, const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q = 0);

         /**
          * @brief Destructor
          */
         virtual ~I2Qm() = default;
      ...
      private:
          ...
          */
         std::shared_ptr<I2QmDiags> mpImpl;
   };
...
#endif // QUICC_SPARSESM_WORLAND_I2QM_HPP
