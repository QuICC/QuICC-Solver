...
#ifndef QUICC_SPARSESM_WORLAND_I3QPDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I3QPDIAGS_HPP
...
namespace Worland {
   ...
   class I3QpDiags: public IDiags
   {
      public:
          ...
          */
         I3QpDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I3QPDIAGS_HPP
