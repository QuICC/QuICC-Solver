...
#ifndef QUICC_SPARSESM_WORLAND_I4D4M_HPP
#define QUICC_SPARSESM_WORLAND_I4D4M_HPP
 ...
 */
class I4D4m : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D4m(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4D4m() = default;
...
private:
    ...
    */
   std::shared_ptr<I4D4mDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4D4M_HPP
