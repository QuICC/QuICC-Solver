...
#ifndef QUICC_SPARSESM_WORLAND_I4D2P_HPP
#define QUICC_SPARSESM_WORLAND_I4D2P_HPP
 ...
 */
class I4D2p : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D2p(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4D2p() = default;
...
private:
    ...
    */
   std::shared_ptr<I4D2pDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4D2P_HPP
