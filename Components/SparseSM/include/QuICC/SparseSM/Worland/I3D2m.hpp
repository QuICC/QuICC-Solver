/**
 * @file I3D2m.hpp
 * @brief Implementation of the full sphere Worland I3 of D^2 on l-2 coupling
 * sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I3D2M_HPP
#define QUICC_SPARSESM_WORLAND_I3D2M_HPP
 ...
 */
class I3D2m : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I3D2m(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I3D2m() = default;
...
private:
    ...
    */
   std::shared_ptr<I3D2mDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I3D2M_HPP
