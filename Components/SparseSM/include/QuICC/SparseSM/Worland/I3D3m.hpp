...
#ifndef QUICC_SPARSESM_WORLAND_I3D3M_HPP
#define QUICC_SPARSESM_WORLAND_I3D3M_HPP
...
#include "QuICC/SparseSM/Worland/I3D3mDiags.hpp"
 ...
 */
class I3D3m : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I3D3m(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I3D3m() = default;
...
private:
    ...
    */
   std::shared_ptr<I3D3mDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I3D3M_HPP
