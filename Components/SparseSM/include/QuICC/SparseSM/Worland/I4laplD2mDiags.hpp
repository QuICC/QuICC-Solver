...
#ifndef QUICC_SPARSESM_WORLAND_I4LAPLD2MDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I4LAPLD2MDIAGS_HPP
 ...
 */
class I4laplD2mDiags : public IDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4laplD2mDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l,
      const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I4LAPLD2MDIAGS_HPP
