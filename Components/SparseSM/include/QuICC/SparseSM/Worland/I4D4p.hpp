/**
 * @file I4D4p.hpp
 * @brief Implementation of the full sphere Worland I4 of D^4 on l+4 coupling
 * sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I4D4P_HPP
#define QUICC_SPARSESM_WORLAND_I4D4P_HPP
...
#include "QuICC/SparseSM/Worland/I4D4pDiags.hpp"
 ...
 */
class I4D4p : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D4p(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4D4p() = default;
...
private:
    ...
    */
   std::shared_ptr<I4D4pDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4D4P_HPP
