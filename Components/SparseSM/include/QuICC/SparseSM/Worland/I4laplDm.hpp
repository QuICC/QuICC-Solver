...
#ifndef QUICC_SPARSESM_WORLAND_I4LAPLDM_HPP
#define QUICC_SPARSESM_WORLAND_I4LAPLDM_HPP
 ...
 */
class I4laplDm : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4laplDm(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4laplDm() = default;
...
private:
    ...
    */
   std::shared_ptr<I4laplDmDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4LAPLDM_HPP
