/**
 * @file I3QmDiags.hpp
 * @brief Interface to I3Qm diagonals for full sphere Worland I3Qm sparse operator
 */
...
namespace Worland {
   ...
   class I3QmDiags: public IDiags
   {
      public:
          ...
          */
         I3QmDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q);
