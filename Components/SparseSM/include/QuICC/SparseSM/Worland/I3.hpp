...
#ifndef QUICC_SPARSESM_WORLAND_I3_HPP
#define QUICC_SPARSESM_WORLAND_I3_HPP
...
namespace Worland {
    ...
    * @brief Implementation of the full sphere Worland I3 sparse operator
    */
   class I3: public IWorlandOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I3(const int rows, const int cols, const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q = 0);
...
#endif // QUICC_SPARSESM_WORLAND_I3_HPP
