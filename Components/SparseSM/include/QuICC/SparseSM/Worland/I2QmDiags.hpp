/**
 * @file I2QmDiags.hpp
 * @brief Interface to I2Qm diagonals for full sphere Worland I2Qm sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I2QMDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I2QMDIAGS_HPP
...
namespace Worland {
   ...
   class I2QmDiags: public IDiags
   {
      public:
          ...
          */
         I2QmDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I2QMDIAGS_HPP
