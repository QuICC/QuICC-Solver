/**
 * @file I3D3p.hpp
 * @brief Implementation of the full sphere Worland I3 of D^3 on l+3 coupling
 * sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I3D3P_HPP
#define QUICC_SPARSESM_WORLAND_I3D3P_HPP
 ...
 */
class I3D3p : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I3D3p(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I3D3p() = default;
...
private:
    ...
    */
   std::shared_ptr<I3D3pDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I3D3P_HPP
