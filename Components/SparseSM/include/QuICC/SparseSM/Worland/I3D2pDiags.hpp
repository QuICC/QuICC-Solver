...
#ifndef QUICC_SPARSESM_WORLAND_I3D2PDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I3D2PDIAGS_HPP
 ...
 */
class I3D2pDiags : public IDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I3D2pDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l,
      const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I3D2PDIAGS_HPP
