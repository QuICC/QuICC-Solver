...
#ifndef QUICC_SPARSESM_WORLAND_I3LAPLDM_HPP
#define QUICC_SPARSESM_WORLAND_I3LAPLDM_HPP
 ...
 */
class I3laplDm : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I3laplDm(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I3laplDm() = default;
...
private:
    ...
    */
   std::shared_ptr<I3laplDmDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I3LAPLDM_HPP
