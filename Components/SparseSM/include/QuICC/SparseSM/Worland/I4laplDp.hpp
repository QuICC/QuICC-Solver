/**
 * @file I4laplDp.hpp
 * @brief Implementation of the full sphere Worland I4 of lapl*D on l+1 coupling
 * sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I4LAPLDP_HPP
#define QUICC_SPARSESM_WORLAND_I4LAPLDP_HPP
 ...
 */
class I4laplDp : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4laplDp(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4laplDp() = default;
...
private:
    ...
    */
   std::shared_ptr<I4laplDpDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4LAPLDP_HPP
