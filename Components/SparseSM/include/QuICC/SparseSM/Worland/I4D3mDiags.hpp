...
#ifndef QUICC_SPARSESM_WORLAND_I4D3MDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I4D3MDIAGS_HPP
 ...
 *
 * Band: subdiagonal d_1, main d0, superdiagonals d1..d4 (l-3 coupling).
 */
class I4D3mDiags : public IDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D3mDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l,
      const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I4D3MDIAGS_HPP
