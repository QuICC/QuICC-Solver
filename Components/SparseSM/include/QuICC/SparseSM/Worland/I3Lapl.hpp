...
#ifndef QUICC_SPARSESM_WORLAND_I3LAPL_HPP
#define QUICC_SPARSESM_WORLAND_I3LAPL_HPP
...
namespace Worland {
    ...
    * @brief Implementation of the full sphere Worland I3Lapl sparse operator
    */
   class I3Lapl: public IWorlandOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I3Lapl(const int rows, const int cols, const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q = 0);

         /**
          * @brief Destructor
          */
         virtual ~I3Lapl() = default;
      ...
      private:
          ...
          */
         std::shared_ptr<I3LaplDiags> mpImpl;
   };
...
#endif // QUICC_SPARSESM_WORLAND_I3LAPL_HPP
