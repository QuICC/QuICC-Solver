/**
 * @file I4QmDiags.hpp
 * @brief Interface to I4Qm diagonals for full sphere Worland I4Qm sparse
 * operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I4QMDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I4QMDIAGS_HPP
...
public:
    ...
    */
   I4QmDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l,
      const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I4QMDIAGS_HPP
