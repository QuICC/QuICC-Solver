...
#ifndef QUICC_SPARSESM_WORLAND_I4QM_HPP
#define QUICC_SPARSESM_WORLAND_I4QM_HPP
...
namespace Worland {
    ...
    * @brief Implementation of the full sphere Worland I4 of Coriolis Q on l-1 sparse operator
    */
   class I4Qm: public IWorlandOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I4Qm(const int rows, const int cols, const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q = 0);

         /**
          * @brief Destructor
          */
         virtual ~I4Qm() = default;
      ...
      private:
          ...
          */
         std::shared_ptr<I4QmDiags> mpImpl;
   };
...
#endif // QUICC_SPARSESM_WORLAND_I4QM_HPP
