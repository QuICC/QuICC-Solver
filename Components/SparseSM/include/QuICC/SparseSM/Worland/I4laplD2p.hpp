/**
 * @file I4laplD2p.hpp
 * @brief Implementation of the full sphere Worland I4 of lapl*D^2 on l+2
 * coupling sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I4LAPLD2P_HPP
#define QUICC_SPARSESM_WORLAND_I4LAPLD2P_HPP
...
/**
 * @brief Implementation of the full sphere Worland I4 of lapl*D^2 on l+2
 * coupling sparse operator (Stage 4-5 spheroid LHS; never truncated, q>0
 * unsupported)
 */
class I4laplD2p : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4laplD2p(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4laplD2p() = default;
...
private:
    ...
    */
   std::shared_ptr<I4laplD2pDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4LAPLD2P_HPP
