...
#ifndef QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D2MDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D2MDIAGS_HPP
 ...
 */
class I4D2mDiags : public QuICC::SparseSM::Worland::I4D2mDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D2mDiags(const Scalar_t alpha, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D2MDIAGS_HPP
