...
#ifndef QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D4PDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D4PDIAGS_HPP
 ...
 */
class I4D4pDiags : public QuICC::SparseSM::Worland::I4D4pDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D4pDiags(const Scalar_t alpha, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D4PDIAGS_HPP
