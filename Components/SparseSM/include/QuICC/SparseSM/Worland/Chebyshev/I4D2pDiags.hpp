...
#ifndef QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D2PDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D2PDIAGS_HPP
 ...
 */
class I4D2pDiags : public QuICC::SparseSM::Worland::I4D2pDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D2pDiags(const Scalar_t alpha, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D2PDIAGS_HPP
