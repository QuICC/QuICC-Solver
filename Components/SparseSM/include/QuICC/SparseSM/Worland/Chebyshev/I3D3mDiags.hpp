...
#ifndef QUICC_SPARSESM_WORLAND_CHEBYSHEV_I3D3MDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_CHEBYSHEV_I3D3MDIAGS_HPP
 ...
 */
class I3D3mDiags : public QuICC::SparseSM::Worland::I3D3mDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I3D3mDiags(const Scalar_t alpha, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_CHEBYSHEV_I3D3MDIAGS_HPP
