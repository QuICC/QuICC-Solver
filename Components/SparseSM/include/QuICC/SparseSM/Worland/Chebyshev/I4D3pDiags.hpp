...
#ifndef QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D3PDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D3PDIAGS_HPP
 ...
 */
class I4D3pDiags : public QuICC::SparseSM::Worland::I4D3pDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D3pDiags(const Scalar_t alpha, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4D3PDIAGS_HPP
