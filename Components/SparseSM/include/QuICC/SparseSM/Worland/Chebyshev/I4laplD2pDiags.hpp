...
#ifndef QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4LAPLD2PDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4LAPLD2PDIAGS_HPP
 ...
 */
class I4laplD2pDiags : public QuICC::SparseSM::Worland::I4laplD2pDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4laplD2pDiags(const Scalar_t alpha, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_CHEBYSHEV_I4LAPLD2PDIAGS_HPP
