/**
 * @file I3QpDiags.hpp
 * @brief Interface to I3Qp diagonals for full sphere Worland I3Qp sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_CHEBYSHEV_I3QPDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_CHEBYSHEV_I3QPDIAGS_HPP
...
namespace Chebyshev {
   ...
   /**
    * @brief Implementation of the full sphere Worland I3Qp sparse operator
    */
   class I3QpDiags: public QuICC::SparseSM::Worland::I3QpDiags
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I3QpDiags(const Scalar_t alpha, const int l, const int q);

         /**
          * @brief Destructor
          */
         virtual ~I3QpDiags() = default;
...
#endif // QUICC_SPARSESM_WORLAND_CHEBYSHEV_I3QPDIAGS_HPP
