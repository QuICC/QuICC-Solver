...
#ifndef QUICC_SPARSESM_WORLAND_I4D4MDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I4D4MDIAGS_HPP
 ...
 *
 * Band: main d0, superdiagonals d1..d4 (l-4 coupling).
 */
class I4D4mDiags : public IDiags
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D4mDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l,
      const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I4D4MDIAGS_HPP
