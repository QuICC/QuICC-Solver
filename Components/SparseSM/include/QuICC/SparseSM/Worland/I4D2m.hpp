/**
 * @file I4D2m.hpp
 * @brief Implementation of the full sphere Worland I4 of D^2 on l-2 coupling
 * sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I4D2M_HPP
#define QUICC_SPARSESM_WORLAND_I4D2M_HPP
 ...
 */
class I4D2m : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D2m(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4D2m() = default;
...
private:
    ...
    */
   std::shared_ptr<I4D2mDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4D2M_HPP
