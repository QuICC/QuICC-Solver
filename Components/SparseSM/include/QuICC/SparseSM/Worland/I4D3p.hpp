...
#ifndef QUICC_SPARSESM_WORLAND_I4D3P_HPP
#define QUICC_SPARSESM_WORLAND_I4D3P_HPP
 ...
 */
class I4D3p : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4D3p(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4D3p() = default;
...
private:
    ...
    */
   std::shared_ptr<I4D3pDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4D3P_HPP
