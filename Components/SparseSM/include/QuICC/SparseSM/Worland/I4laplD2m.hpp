...
#ifndef QUICC_SPARSESM_WORLAND_I4LAPLD2M_HPP
#define QUICC_SPARSESM_WORLAND_I4LAPLD2M_HPP
 ...
 * unsupported)
 */
class I4laplD2m : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I4laplD2m(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I4laplD2m() = default;
...
private:
    ...
    */
   std::shared_ptr<I4laplD2mDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I4LAPLD2M_HPP
