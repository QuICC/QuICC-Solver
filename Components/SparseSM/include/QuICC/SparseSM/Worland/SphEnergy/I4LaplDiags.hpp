...
#ifndef QUICC_SPARSESM_WORLAND_SPHENERGY_I4LAPLDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_SPHENERGY_I4LAPLDIAGS_HPP
...
public:
    ...
    */
   I4LaplDiags(const Scalar_t alpha, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_SPHENERGY_I4LAPLDIAGS_HPP
