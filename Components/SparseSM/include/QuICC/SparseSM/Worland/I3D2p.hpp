...
#ifndef QUICC_SPARSESM_WORLAND_I3D2P_HPP
#define QUICC_SPARSESM_WORLAND_I3D2P_HPP
 ...
 */
class I3D2p : public IWorlandOperator
{
public:
   /**
    * @brief Constructor
    ...
    */
   I3D2p(const int rows, const int cols, const Scalar_t alpha,
      const Scalar_t dBeta, const int l, const int q = 0);

   /**
    * @brief Destructor
    */
   virtual ~I3D2p() = default;
...
private:
    ...
    */
   std::shared_ptr<I3D2pDiags> mpImpl;
};
...
#endif // QUICC_SPARSESM_WORLAND_I3D2P_HPP
