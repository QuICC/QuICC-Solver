 ...
 * @brief Interface to I3Lapl diagonals for full sphere Worland I3Lapl sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I3LAPLDIAGS_HPP
#define QUICC_SPARSESM_WORLAND_I3LAPLDIAGS_HPP
...
namespace Worland {
    ...
    */
   class I3LaplDiags: public IDiags
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I3LaplDiags(const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q);
...
#endif // QUICC_SPARSESM_WORLAND_I3LAPLDIAGS_HPP
