/**
 * @file I4Qp.hpp
 * @brief Implementation of the full sphere Worland I4 of Coriolis Q on l+1 sparse operator
 */

#ifndef QUICC_SPARSESM_WORLAND_I4QP_HPP
#define QUICC_SPARSESM_WORLAND_I4QP_HPP
...
namespace Worland {
    ...
    * @brief Implementation of the full sphere Worland I4 of Coriolis Q on l+1 sparse operator
    */
   class I4Qp: public IWorlandOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         I4Qp(const int rows, const int cols, const Scalar_t alpha, const Scalar_t dBeta, const int l, const int q = 0);

         /**
          * @brief Destructor
          */
         virtual ~I4Qp() = default;
      ...
      private:
          ...
          */
         std::shared_ptr<I4QpDiags> mpImpl;
   };
...
#endif // QUICC_SPARSESM_WORLAND_I4QP_HPP
