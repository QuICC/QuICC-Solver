...
/// @param uval
/// @param umod
extern "C" void _ciface_quiccir_fr_prj_layoutUval_layoutUmod(void* obj, view3_t* pUval, view3_cd_t* pUmod)
{
//   auto cl = reinterpret_cast<frOp*>(obj);
//   cl->apply(pUval, pUmod);
    std::cout << "_ciface_quiccir_fr_prj_layoutUval_layoutUmod\n";
};
...
/// @param umod
/// @param uval
extern "C" void _ciface_quiccir_fr_int_layoutUmod_layoutUval(void* obj, view3_cd_t* pUmod, view3_t* pUval)
{
//   auto cl = reinterpret_cast<frOp*>(obj);
//   cl->apply(pUmod, pUval);
    std::cout << "_ciface_quiccir_fr_int_layoutUmod_layoutUval\n";
};
...
/// @param op
/// @param umod
extern "C" void _ciface_quiccir_alloc_fr_prj_layoutUval_layoutUmod(view3_t* pNewBuffer, view3_cd_t* pProdBuffer)
{
  /// proto is dense
...
//   pNewBuffer->data = reinterpret_cast<double*>(::operator new(sizeByte, static_cast<std::align_val_t>(sizeof(double))));
    std::cout << "_ciface_quiccir_alloc_fr_prj_layoutUval_layoutUmod\n";
};
