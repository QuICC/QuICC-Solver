    ...
    )
{
    #ifndef NDEBUG
    std::cout <<
        "_ciface_quiccir_cross_inertia_f64_DCCSC3D_f64_DCCSC3D_f64_DCCSC3D_f64_DCCSC3D_f64_DCCSC3D_f64_DCCSC3D_f64_DCCSC3D_f64_DCCSC3D_f64_DCCSC3D\n";
    #endif
    assert(obj != nullptr);
...
/// @brief C Interface to MLIR for a binary cross operator
/// gpu backend
/// @param obj
/// @param pRet
/// @param pLhs
/// @param pRhs
extern "C" void _ciface_quiccir_cross_f64_DCCSC3DJIK_f64_DCCSC3DJIK_f64_DCCSC3DJIK(void* obj,
    ViewDescriptor<double, std::uint32_t, 3>* pRet, ViewDescriptor<double, std::uint32_t, 3>* pLhs, ViewDescriptor<double, std::uint32_t, 3>* pRhs)
{
    #ifndef NDEBUG
    std::cout <<
        "_ciface_quiccir_cross_f64_DCCSC3DJIK_f64_DCCSC3DJIK_f64_DCCSC3DJIK\n";
    #endif
    assert(obj != nullptr);
    assert(pRet != nullptr);
    assert(pLhs != nullptr);
