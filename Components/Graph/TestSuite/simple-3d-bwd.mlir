...
// phys -> mod
// Nr x Nphi x Ntheta
!type_uval = !quiccir.view<3x10x20xf64, "R_DCCSC3D_t">
// L x N x M  ( ..., radial, ...)
!type_umod = !quiccir.view<10x2x6xf64, "C_DCCSC3D_t">

!type_tuval = tensor<3x10x20xf64, "R_DCCSC3D_t">
!type_tumod = tensor<10x2x6xf64, "C_DCCSC3D_t">
...
func.func @entry(%thisArr: !llvm.ptr<array<15 x ptr>> {llvm.noalias}, %Polv: !type_umod, %Rv: !type_uval) {
  ...
  %Polur = call @bwd(%Rur) : (tensor<?x?x?xf64>) -> tensor<?x?x?xf64>
