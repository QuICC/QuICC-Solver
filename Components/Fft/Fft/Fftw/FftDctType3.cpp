/**
 * @file FftDctType3.cpp
 * @brief Fftw DCT Type 3 backend
 */
...
namespace details {
fftw_plan setPlanDctType3(const int fwdSize, const int blockSize, const int mult);
} // namespace details
...
FftOp<View::View<double, AttOut>,
   View::View<double, AttIn>, dct_type3_t>::FftOp()
{
   // FFTW Fixture
   Library::getInstance();
}
...
void FftOp<View::View<double, AttOut>,
   View::View<double, AttIn>, dct_type3_t>::applyImpl(View::View<double,
                                            AttOut>& phys,
   const View::View<double, AttIn>& mods)
{
   ...
   if (_plan == nullptr)
   {
      Profiler::RegionFixture<5> fix("Fftw::FftOp::initFft-DctType3");
      int columns = 0;
      ...
      _plan = details::setPlanDctType3(phys.dims()[0], columns, 1);
   }
   Profiler::RegionFixture<5> fix("Fftw::FftOp::applyFft-DctType3");
...
template class FftOp<RmodsDense2D_t, RphysDense2D_t, dct_type3_t>;
template class FftOp<RmodsDCCSC3D_t, RphysDCCSC3D_t, dct_type3_t>;
...
FftOp<View::View<std::complex<double>, AttOut>,
   View::View<std::complex<double>, AttIn>, dct_type3_t>::FftOp()
{
   // FFTW Fixture
   Library::getInstance();
}
...
void FftOp<View::View<std::complex<double>, AttOut>,
   View::View<std::complex<double>, AttIn>, dct_type3_t>::applyImpl(View::View<std::complex<double>,
                                            AttOut>& phys,
   const View::View<std::complex<double>, AttIn>& mods)
{
   ...
   if (_plan == nullptr)
   {
      ...
      _plan = details::setPlanDctType3(phys.dims()[0], columns, 2);
   }
   Profiler::RegionFixture<5> fix("Fftw::FftOp::applyFft-DctType3");
   fftw_execute_r2r(static_cast<fftw_plan>(_plan),
...
// Explicit instantiations
template class FftOp<CmodsDense2D_t, CphysDense2D_t, dct_type3_t>;
template class FftOp<CmodsDCCSC3D_t, CphysDCCSC3D_t, dct_type3_t>;
