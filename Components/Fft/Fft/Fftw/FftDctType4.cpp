/**
 * @file FftDctType4.cpp
 * @brief Fftw DCT Type 4 backend
 */
...
namespace details {
fftw_plan setPlanDctType4(const int fwdSize, const int blockSize, const int mult);
} // namespace details
...
FftOp<View::View<double, AttOut>,
   View::View<double, AttIn>, dct_type4_t>::FftOp()
{
   // FFTW Fixture
   Library::getInstance();
}
...
void FftOp<View::View<double, AttOut>,
   View::View<double, AttIn>, dct_type4_t>::applyImpl(View::View<double,
                                            AttOut>& phys,
   const View::View<double, AttIn>& mods)
{
   ...
   if (_plan == nullptr)
   {
      Profiler::RegionFixture<5> fix("Fftw::FftOp::initFft-DctType4");
      int columns = 0;
      ...
      _plan = details::setPlanDctType4(phys.dims()[0], columns, 1);
   }
   Profiler::RegionFixture<5> fix("Fftw::FftOp::applyFft-DctType4");
...
template class FftOp<RmodsDense2D_t, RphysDense2D_t, dct_type4_t>;
template class FftOp<RmodsDCCSC3D_t, RphysDCCSC3D_t, dct_type4_t>;
...
FftOp<View::View<std::complex<double>, AttOut>,
   View::View<std::complex<double>, AttIn>, dct_type4_t>::FftOp()
{
   // FFTW Fixture
   Library::getInstance();
}
...
void FftOp<View::View<std::complex<double>, AttOut>,
   View::View<std::complex<double>, AttIn>, dct_type4_t>::applyImpl(View::View<std::complex<double>,
                                            AttOut>& phys,
   const View::View<std::complex<double>, AttIn>& mods)
{
   ...
   if (_plan == nullptr)
   {
      ...
      _plan = details::setPlanDctType4(phys.dims()[0], columns, 2);
   }
   Profiler::RegionFixture<5> fix("Fftw::FftOp::applyFft-DctType4");
   fftw_execute_r2r(static_cast<fftw_plan>(_plan),
...
// Explicit instantiations
template class FftOp<CmodsDense2D_t, CphysDense2D_t, dct_type4_t>;
template class FftOp<CmodsDCCSC3D_t, CphysDCCSC3D_t, dct_type4_t>;
...
fftw_plan setPlanDctType4(const int fwdSize, const int blockSize, const int mult)
{
   ...
   // Create the real to real type IV plan
   const fftw_r2r_kind fftKind[] = {FFTW_REDFT11};
