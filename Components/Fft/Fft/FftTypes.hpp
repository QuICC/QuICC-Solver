...
/// @brief Real dense 2D tensor, input modes view type
using RmodsDense2D_t = View::View<double, View::dense2D>;
/// @brief Real dense 2D tensor, output phys view type
using RphysDense2D_t = View::View<double, View::dense2D>;
/// @brief Real compressed sparse layer 3D tensor, input modes view type
using RmodsDCCSC3D_t = View::View<double, View::DCCSC3D>;
/// @brief Real compressed sparse layer 3D tensor, output phys view type
using RphysDCCSC3D_t = View::View<double, View::DCCSC3D>;
/// @brief Real compressed sparse layer 3D tensor, output phys view type
using RphysDCCSC3DInOrder_t = View::View<double, View::DCCSC3DInOrder>;
/// @brief Real compressed sparse layer 3D tensor, input mods view type
using RmodsDCCSC3DInOrder_t = View::View<double, View::DCCSC3DInOrder>;
