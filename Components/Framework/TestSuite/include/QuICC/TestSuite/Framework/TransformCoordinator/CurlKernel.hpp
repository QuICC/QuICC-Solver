/**
 * @file CurlKernel.hpp
 * @brief Physical kernel for the Curl of field
 */

#ifndef QUICC_PHYSICAL_CURLKERNEL_HPP
#define QUICC_PHYSICAL_CURLKERNEL_HPP
...
namespace Kernel {
    ...
    * @brief Physical kernel for the Curl of field
    */
   class CurlKernel: public IPhysicalKernel
   {
      public:
         /**
...
#endif // QUICC_PHYSICAL_CURLKERNEL_HPP
