...
template <QuICC::FieldComponents::Physical::Id TONE, QuICC::FieldComponents::Physical::Id TTWO, QuICC::FieldComponents::Physical::Id TTHREE>
   using TestOp = QuICC::Physical::VelocityAdvection<TONE,TTWO,TTHREE>;

TEST_CASE("VelocityAdvection validation FlatScalarField vs ViewScalarField", "[VelocityAdvectionValidation]")
{
