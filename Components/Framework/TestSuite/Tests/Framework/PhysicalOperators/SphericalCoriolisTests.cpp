   ...
   for(std::uint32_t varBase: variants)
   {
      ...
      for(auto&& c: cs)
      {
         ...
         // Timing FlatScalarField
         {
            ...
            {
               QuICC::Profiler::RegionStart<1>("SphericalCoriolisTests::Flat" + ctag + "Set_" + std::to_string(varBase));
               ...
               QuICC::Profiler::RegionStop<1>("SphericalCoriolisTests::Flat" + ctag + "Set_" + std::to_string(varBase));

               QuICC::Profiler::RegionStart<1>("SphericalCoriolisTests::Flat" + ctag + "Add_" + std::to_string(varBase));
               ...
               QuICC::Profiler::RegionStop<1>("SphericalCoriolisTests::Flat" + ctag + "Add_" + std::to_string(varBase));

               QuICC::Profiler::RegionStart<1>("SphericalCoriolisTests::Flat" + ctag + "Sub_" + std::to_string(varBase));
               ...
               QuICC::Profiler::RegionStop<1>("SphericalCoriolisTests::Flat" + ctag + "Sub_" + std::to_string(varBase));
            }
         }
         ...
         // Timing ViewScalarField
         {
            ...
            for(std::uint32_t it = 0; it < itMax; it++)
            {
               QuICC::Profiler::RegionStart<1>("SphericalCoriolisTests::View" + ctag + "Set_" + std::to_string(varBase));
               TestOp::set(*spScalarA, R, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               TestOp::set(*spScalarA, T, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               TestOp::set(*spScalarA, P, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               QuICC::Profiler::RegionStop<1>("SphericalCoriolisTests::View" + ctag + "Set_" + std::to_string(varBase));

               QuICC::Profiler::RegionStart<1>("SphericalCoriolisTests::View" + ctag + "Add_" + std::to_string(varBase));
               TestOp::add(*spScalarA, R, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               TestOp::add(*spScalarA, T, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               TestOp::add(*spScalarA, P, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               QuICC::Profiler::RegionStop<1>("SphericalCoriolisTests::View" + ctag + "Add_" + std::to_string(varBase));

               QuICC::Profiler::RegionStart<1>("SphericalCoriolisTests::View" + ctag + "Sub_" + std::to_string(varBase));
               TestOp::sub(*spScalarA, R, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               TestOp::sub(*spScalarA, T, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               TestOp::sub(*spScalarA, P, idxFunc, cosTheta, sinTheta, *spVectorA, c);
               QuICC::Profiler::RegionStop<1>("SphericalCoriolisTests::View" + ctag + "Sub_" + std::to_string(varBase));
            }
         }
      }
   }
