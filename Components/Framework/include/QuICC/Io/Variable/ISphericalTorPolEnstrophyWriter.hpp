 ...
 * @brief Implementation of the ASCII spherical harmonics enstrophy calculation
 * for a Toroidal/Poloidal field in a spherical geometry
 */
 ...
 * for a Toroidal/Poloidal field in a spherical geometry
 */
class ISphericalTorPolEnstrophyWriter
    : public ISphericalTorPolEnstrophyBaseWriter
{
public:
   /**
    * @brief Constructor
    ...
    */
   ISphericalTorPolEnstrophyWriter(const std::string& prefix,
...
private:
    ...
    */
   virtual void storeQEnstrophy(const int l, const int m,
      const MHDFloat enstrophy);

   /**
    * @brief Store enstrophy from S component
    */
   virtual void storeSEnstrophy(const int l, const int m,
      const MHDFloat enstrophy);

   /**
    * @brief Store enstrophy from T component
    */
   virtual void storeTEnstrophy(const int l, const int m,
      const MHDFloat enstrophy);
};
