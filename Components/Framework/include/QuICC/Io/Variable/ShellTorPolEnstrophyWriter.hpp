...
public:
    ...
    */
   ShellTorPolEnstrophyWriter(const std::string& prefix,
      const std::string& type);

   /**
    * @brief Destructor
    */
   virtual ~ShellTorPolEnstrophyWriter() = default;
...
typedef std::shared_ptr<ShellTorPolEnstrophyWriter>
   SharedShellTorPolEnstrophyWriter;
