...
public:
    ...
    */
   SphereTorPolMSpectrumWriter(const std::string& prefix,
      const std::string& type);

   /**
    * @brief Destructor
    */
   virtual ~SphereTorPolMSpectrumWriter() = default;
...
typedef std::shared_ptr<SphereTorPolMSpectrumWriter>
   SharedSphereTorPolMSpectrumWriter;
