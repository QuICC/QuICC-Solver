...
namespace Variable {
   ...
   class ShellTorPolMSpectrumWriter: public ISphericalTorPolMSpectrumWriter
   {
      public:
          ...
          */
         ShellTorPolMSpectrumWriter(const std::string& prefix, const std::string& type, std::vector<std::shared_ptr<QuICC::DenseSM::Chebyshev::LinearMap::RadialTorPolFunction>> pF = {});
