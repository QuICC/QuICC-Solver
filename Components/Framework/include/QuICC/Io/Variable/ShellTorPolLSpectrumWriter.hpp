...
namespace Variable {
   ...
   class ShellTorPolLSpectrumWriter: public ISphericalTorPolLSpectrumWriter
   {
      public:
          ...
          */
         ShellTorPolLSpectrumWriter(const std::string& prefix, const std::string& type, std::shared_ptr<QuICC::DenseSM::Chebyshev::LinearMap::RadialTorPolFunction> pF = nullptr);
