...
#ifndef QUICC_IO_VARIABLE_CARTESIAN1DFLUCTUATINGMAGNETICENERGYWRITER_HPP
#define QUICC_IO_VARIABLE_CARTESIAN1DFLUCTUATINGMAGNETICENERGYWRITER_HPP
...
namespace Variable {
   ...
   typedef std::shared_ptr<Cartesian1DFluctuatingMagneticEnergyWriter> SharedCartesian1DFluctuatingMagneticEnergyWriter;

}
}
}

#endif // QUICC_IO_VARIABLE_CARTESIAN1DFLUCTUATINGMAGNETICENERGYWRITER_HPP
