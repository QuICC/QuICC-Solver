...
#ifndef QUICC_IO_VARIABLE_CARTESIAN1DSTREAMENERGYWRITER_HPP
#define QUICC_IO_VARIABLE_CARTESIAN1DSTREAMENERGYWRITER_HPP
...
namespace Variable {
   ...
   typedef std::shared_ptr<Cartesian1DStreamEnergyWriter> SharedCartesian1DStreamEnergyWriter;

}
}
}

#endif // QUICC_IO_VARIABLE_CARTESIAN1DSTREAMENERGYWRITER_HPP
