...
#ifndef QUICC_IO_VARIABLE_CARTESIAN1DKINETICCARTESIANWRITER_HPP
#define QUICC_IO_VARIABLE_CARTESIAN1DKINETICCARTESIANWRITER_HPP
...
namespace Variable {
   ...
   typedef std::shared_ptr<Cartesian1DKineticCartesianWriter> SharedCartesian1DKineticCartesianWriter;

}
}
}

#endif // QUICC_IO_VARIABLE_CARTESIAN1DKINETICCARTESIANWRITER_HPP
