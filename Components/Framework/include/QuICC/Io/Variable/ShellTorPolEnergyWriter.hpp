...
namespace Variable {
   ...
   class ShellTorPolEnergyWriter: public ISphericalTorPolEnergyWriter
   {
      public:
          ...
          */
         ShellTorPolEnergyWriter(const std::string& prefix, const std::string& type, std::shared_ptr<QuICC::DenseSM::Chebyshev::LinearMap::RadialTorPolFunction> pF = nullptr);
