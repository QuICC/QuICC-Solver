...
public:
    ...
    */
   SphereAngularMomentumWriter(const std::string& prefix,
      const std::string& type);

   /**
    * @brief Destructor
    */
   virtual ~SphereAngularMomentumWriter() = default;
...
typedef std::shared_ptr<SphereAngularMomentumWriter>
   SharedSphereAngularMomentumWriter;
