 ...
 * @brief Implementation of the ASCII spherical harmonics mode energy spectrum calculation for a scalar field in a spherical shell
 */
...
namespace Variable {
   ...
   class ShellScalarModeSpectrumWriter: public ISphericalScalarModeSpectrumWriter
   {
      public:
          ...
          */
         ShellScalarModeSpectrumWriter(const std::string& prefix, const std::string& type);
   ...
   typedef std::shared_ptr<ShellScalarModeSpectrumWriter> SharedShellScalarModeSpectrumWriter;
