...
public:
    ...
    */
   IVariableHdf5Reader(std::string name, std::string ext, std::string header,
...
protected:
   ...
   typedef std::map<std::size_t,
      Framework::Selector::VariantSharedScalarVariable>::iterator
      scalar_iterator;

   /// Typedef for the vector const iterator
   typedef std::map<std::size_t,
      Framework::Selector::VariantSharedVectorVariable>::iterator
      vector_iterator;
