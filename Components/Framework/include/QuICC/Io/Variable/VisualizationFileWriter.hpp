...
protected:
    ...
    */
   void writePhysicalScalar(const std::string& name,
    ...
    */
   void writePhysicalTensor(const std::string& name,
      const std::map<std::pair<FieldComponents::Physical::Id,
