 ...
 * @brief Implementation of the ASCII plane layer energy calculation for a
 * scalar field
 */
...
public:
    ...
    */
   Cartesian1DScalarEnergyWriter(const std::string& prefix,
...
typedef std::shared_ptr<Cartesian1DScalarEnergyWriter>
   SharedSCartesian1DScalarEnergyWriter;
