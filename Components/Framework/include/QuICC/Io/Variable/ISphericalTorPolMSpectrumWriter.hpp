...
namespace Variable {
   ...
   class ISphericalTorPolMSpectrumWriter: public ISphericalTorPolEnergyBaseWriter
   {
      public:
          ...
          */
         ISphericalTorPolMSpectrumWriter(const std::string& prefix, const std::string& type, std::vector<std::shared_ptr<QuICC::DenseSM::Chebyshev::LinearMap::RadialTorPolFunction>> pF = {});
