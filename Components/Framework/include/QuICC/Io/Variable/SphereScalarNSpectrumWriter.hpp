...
public:
    ...
    */
   SphereScalarNSpectrumWriter(const std::string& prefix,
      const std::string& type);

   /**
    * @brief Destructor
    */
   virtual ~SphereScalarNSpectrumWriter() = default;
...
typedef std::shared_ptr<SphereScalarNSpectrumWriter>
   SharedSphereScalarNSpectrumWriter;
