...
public:
    ...
    */
   ShellScalarLSpectrumWriter(const std::string& prefix,
      const std::string& type);

   /**
    * @brief Destructor
    */
   virtual ~ShellScalarLSpectrumWriter() = default;
...
typedef std::shared_ptr<ShellScalarLSpectrumWriter>
   SharedShellScalarLSpectrumWriter;
