...
public:
    ...
    * @brief Destructor
    */
   virtual ~VisualizationFileReader() = default;
...
protected:
    ...
    */
   void readPhysicalScalar(const std::string& name,
    ...
    * @param isRequired Field is required
    */
   void readPhysicalVector(const std::string& name,
    ...
    * @param isRequired field is required
    */
   void readPhysicalComponent(const std::string& name,
    ...
    * @param isRequired Field is required
    */
   void readPhysicalTensor(const std::string& name,
      std::map<std::pair<FieldComponents::Physical::Id,
                  FieldComponents::Physical::Id>,
         Framework::Selector::PhysicalScalarField>& rTensor,
      const bool isRequired);
