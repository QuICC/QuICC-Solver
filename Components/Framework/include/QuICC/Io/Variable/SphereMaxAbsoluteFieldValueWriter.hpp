...
public:
    ...
    */
   SphereMaxAbsoluteFieldValueWriter(const std::string& prefix,
...
typedef std::shared_ptr<SphereMaxAbsoluteFieldValueWriter>
   SharedSphereMaxAbsoluteFieldValueWriter;
