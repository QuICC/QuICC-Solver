 ...
 * for a Toroidal/Poloidal field in a sphere
 */
...
public:
    ...
    */
   SphereTorPolEnstrophyWriter(const std::string& prefix,
      const std::string& type);

   /**
    * @brief Destructor
    */
   virtual ~SphereTorPolEnstrophyWriter() = default;
...
typedef std::shared_ptr<SphereTorPolEnstrophyWriter>
   SharedSphereTorPolEnstrophyWriter;
