...
namespace Variable {
   ...
   class ISphericalTorPolLSpectrumWriter: public ISphericalTorPolEnergyBaseWriter
   {
      public:
          ...
          */
         ISphericalTorPolLSpectrumWriter(const std::string& prefix, const std::string& type, std::vector<std::shared_ptr<QuICC::DenseSM::Chebyshev::LinearMap::RadialTorPolFunction>> pF = {});
