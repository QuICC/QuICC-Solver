...
public:
    ...
    */
   ICartesian1DTorPolEnergyBaseWriter(std::string name, std::string ext,
...
private:
    ...
    */
   virtual void storeQEnergy(const int kx, const int ky,
    ...
    * @param energy  Energy of mode
    */
   virtual void storeSEnergy(const int kx, const int ky,
      const MHDFloat energy) = 0;
    ...
    * @param energy  Energy of mode
    */
   virtual void storeTEnergy(const int kx, const int ky,
      const MHDFloat energy) = 0;
};
