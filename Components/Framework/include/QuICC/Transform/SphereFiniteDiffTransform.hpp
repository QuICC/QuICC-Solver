/**
 * @file SphereFiniteDiffTransform.hpp
 * @brief Implementation of the Finite Differences transform in a sphere
 */

#ifndef QUICC_TRANSFORM_SPHEREFINITEDIFFTRANSFORM_HPP
#define QUICC_TRANSFORM_SPHEREFINITEDIFFTRANSFORM_HPP
...
namespace Transform {
    ...
    */
   class SphereFiniteDiffTransform: public ITransform
   {
      public:
         /// Typedef for setup type
         typedef FiniteDiff::Sphere::Transform::SetupType SetupType;

         /// Typedef for setup type
         typedef FiniteDiff::Sphere::Transform::SharedSetupType SharedSetupType;

         /**
          * @brief Constructor
          */
         SphereFiniteDiffTransform() = default;

         /**
          * @brief Destructor
          */
         virtual ~SphereFiniteDiffTransform() = default;
      ...
      private:
          ...
          */
         FiniteDiff::Sphere::Transform mImpl;
...
#endif // QUICC_TRANSFORM_SPHEREFINITEDIFFTRANSFORM_HPP
