/**
 * @file ShellChebyshevTransform.hpp
 * @brief Implementation of the FFTW transform for a Chebyshev expansion for a shell radius
 */

#ifndef QUICC_TRANSFORM_SHELLCHEBYSHEVTRANSFORM_HPP
#define QUICC_TRANSFORM_SHELLCHEBYSHEVTRANSFORM_HPP
...
namespace Transform {
    ...
    */
   class ShellChebyshevTransform: public ITransform
   {
      public:
          ...
          */
         ShellChebyshevTransform() = default;
...
#endif // QUICC_TRANSFORM_SHELLCHEBYSHEVTRANSFORM_HPP
