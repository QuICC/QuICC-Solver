/**
 * @file SphereBesselTransform.hpp
 * @brief Implementation of the spherical Bessel transform in a sphere
 */

#ifndef QUICC_TRANSFORM_SPHEREBESSELANSFORM_HPP
#define QUICC_TRANSFORM_SPHEREBESSELANSFORM_HPP
...
#include "QuICC/Transform/Poly/Bessel/Transform.hpp"
...
namespace Transform {
    ...
    * @brief Implementation of the spherical Bessel transform in a sphere
    */
   class SphereBesselTransform: public ITransform
   {
      public:
         /// Typedef for setup type
         typedef Poly::Bessel::Transform::SetupType SetupType;

         /// Typedef for setup type
         typedef Poly::Bessel::Transform::SharedSetupType SharedSetupType;

         /**
          * @brief Constructor
          */
         SphereBesselTransform() = default;

         /**
          * @brief Destructor
          */
         virtual ~SphereBesselTransform() = default;
...
#endif // QUICC_TRANSFORM_SPHEREBESSELANSFORM_HPP
