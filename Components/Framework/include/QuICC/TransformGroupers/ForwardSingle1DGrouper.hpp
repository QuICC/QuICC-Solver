...
namespace Transform {
   ...
   template <typename TConfigurator> void ForwardSingle1DGrouper<TConfigurator>::setupGroupedSpectralCommunication(const TransformTree& tree, TransformCoordinatorType& coord)
   {
