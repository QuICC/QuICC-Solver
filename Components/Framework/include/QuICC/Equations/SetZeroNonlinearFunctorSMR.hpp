...
#ifndef QUICC_EQUATIONS_SETZERONONLINEARFUNCTORSMR_HPP
#define QUICC_EQUATIONS_SETZERONONLINEARFUNCTORSMR_HPP
...
template <>
template <typename TData, typename TField> void SetZeroNonlinearFunctor<CouplingIndexType::SLOWEST_MULTI_RHS>::apply(const TField& field, TData& storage, const int start)
{
...
#endif // QUICC_EQUATIONS_SETZERONONLINEARFUNCTORSMR_HPP
