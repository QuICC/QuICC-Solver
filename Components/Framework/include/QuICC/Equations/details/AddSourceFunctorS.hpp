...
#ifndef QUICC_EQUATIONS_DETAILS_ADDSOURCEFUNCTORS_HPP
#define QUICC_EQUATIONS_DETAILS_ADDSOURCEFUNCTORS_HPP
...
#endif // QUICC_EQUATIONS_DETAILS_ADDSOURCEFUNCTORS_HPP
