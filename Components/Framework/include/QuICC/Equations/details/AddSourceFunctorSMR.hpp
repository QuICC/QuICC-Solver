...
#ifndef QUICC_EQUATIONS_DETAILS_ADDSOURCEFUNCTORSMR_HPP
#define QUICC_EQUATIONS_DETAILS_ADDSOURCEFUNCTORSMR_HPP
...
#endif // QUICC_EQUATIONS_DETAILS_ADDSOURCEFUNCTORSMR_HPP
