...
#ifndef QUICC_EQUATIONS_SETBOUNDARYVALUEFUNCTORSSR_HPP
#define QUICC_EQUATIONS_SETBOUNDARYVALUEFUNCTORSSR_HPP
...
template <>
template <typename TData, typename TField> void SetBoundaryValueFunctor<CouplingIndexType::SLOWEST_SINGLE_RHS>::apply(const TField& field, TData& storage, const int start)
{
...
#endif // QUICC_EQUATIONS_SETBOUNDARYVALUEFUNCTORSSR_HPP
