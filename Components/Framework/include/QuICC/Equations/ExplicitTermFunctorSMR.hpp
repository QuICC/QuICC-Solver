...
#ifndef QUICC_EQUATIONS_EXPLICITTERMFUNCTORSMR_HPP
#define QUICC_EQUATIONS_EXPLICITTERMFUNCTORSMR_HPP
...
template <>
   template <typename T, typename TOperator, typename TData>
      void ExplicitTermFunctor<CouplingIndexType::SLOWEST_MULTI_RHS>::compute(const std::size_t opId, TData& rSolverField, const int eqStart, SpectralFieldId fieldId, const typename Framework::Selector::ScalarField<T>& explicitField)
   {
...
#endif // QUICC_EQUATIONS_EXPLICITTERMFUNCTORSMR_HPP
