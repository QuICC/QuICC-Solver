/**
 * @file SetBoundaryValueFunctorS.hpp
 * @brief SetBoundaryValue implementation
 */

#ifndef QUICC_EQUATIONS_SETBOUNDARYVALUEFUNCTORS_HPP
#define QUICC_EQUATIONS_SETBOUNDARYVALUEFUNCTORS_HPP
...
template <>
   template <typename TData, typename TField> void SetBoundaryValueFunctor<CouplingIndexType::SINGLE>::apply(const TField& field, TData& storage, const int start)
   {
...
#endif // QUICC_EQUATIONS_SETBOUNDARYVALUEFUNCTORS_HPP
