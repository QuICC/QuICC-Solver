...
namespace Model {
   ...
   class IPhysicalModel
   {
      public:
          ...
          */
         template <typename T, typename TApp> void enableAsciiFile(const std::string tag, const std::string prefix, const std::size_t id, std::shared_ptr<TApp> spSim);
   ...
   template <typename T, typename TApp> void IPhysicalModel::enableAsciiFile(const std::string tag, const std::string prefix, const std::size_t id, std::shared_ptr<TApp> spSim)
   {
