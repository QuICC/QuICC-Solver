...
#ifndef QUICC_TRANSFORM_ANNULUSTRANSFORMSTEPS_HPP
#define QUICC_TRANSFORM_ANNULUSTRANSFORMSTEPS_HPP
...
namespace QuICC {
   ...
   namespace Transform {
       ...
       */
      class AnnulusTransformSteps: public ITransformSteps
      {
         public:
            /**
             * @brief Constructor
             */
            AnnulusTransformSteps(std::shared_ptr<const SpatialScheme::ISpatialScheme> spScheme);

            /**
             * @brief Constructor
             */
            virtual ~AnnulusTransformSteps() = default;
...
#endif // QUICC_TRANSFORM_ANNULUSTRANSFORMSTEPS_HPP
