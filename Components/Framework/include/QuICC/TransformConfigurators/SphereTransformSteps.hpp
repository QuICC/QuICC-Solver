...
#ifndef QUICC_TRANSFORM_SPHERETRANSFORMSTEPS_HPP
#define QUICC_TRANSFORM_SPHERETRANSFORMSTEPS_HPP
...
namespace QuICC {
   ...
   namespace Transform {
       ...
       */
      class SphereTransformSteps: public ITransformSteps
      {
         public:
            /**
             * @brief Constructor
             */
            SphereTransformSteps(std::shared_ptr<const SpatialScheme::ISpatialScheme> spScheme);

            /**
             * @brief Constructor
             */
            virtual ~SphereTransformSteps() = default;
...
#endif // QUICC_TRANSFORM_SPHERETRANSFORMSTEPS_HPP
