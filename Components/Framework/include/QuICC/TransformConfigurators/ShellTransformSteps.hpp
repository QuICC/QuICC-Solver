...
#ifndef QUICC_TRANSFORM_SHELLTRANSFORMSTEPS_HPP
#define QUICC_TRANSFORM_SHELLTRANSFORMSTEPS_HPP
...
namespace QuICC {
   ...
   namespace Transform {
       ...
       */
      class ShellTransformSteps: public ITransformSteps
      {
         public:
            /**
             * @brief Constructor
             */
            ShellTransformSteps(std::shared_ptr<const SpatialScheme::ISpatialScheme> spScheme);

            /**
             * @brief Constructor
             */
            virtual ~ShellTransformSteps() = default;
...
#endif // QUICC_TRANSFORM_SHELLTRANSFORMSTEPS_HPP
