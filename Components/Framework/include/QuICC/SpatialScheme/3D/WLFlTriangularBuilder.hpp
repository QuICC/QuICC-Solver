/**
 * @file WLFlTriangularBuilder.hpp
...
#ifndef QUICC_SPATIALSCHEME_3D_WLFLTRIANGULARBUILDER_HPP
#define QUICC_SPATIALSCHEME_3D_WLFLTRIANGULARBUILDER_HPP
...
namespace SpatialScheme {
    ...
    * @brief Implementation of the sphere Worland(poly) + Spherical harmonics (Associated Legendre(poly) +  Fourier) scheme with spectral l ordering
    */
   class WLFlTriangularBuilder: public ITriangularSHlBuilder
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         explicit WLFlTriangularBuilder(const ArrayI& dim, const GridPurpose::Id purpose);

         /**
          * @brief Destructor
          */
         virtual ~WLFlTriangularBuilder();
...
#endif // QUICC_SPATIALSCHEME_3D_WLFLTRIANGULARBUILDER_HPP
