/**
 * @file TFF.hpp
 * @brief ID of the Chebyshev(FFT) + Fourier + Fourier scheme
 */

#ifndef QUICC_SPATIALSCHEME_3D_TFF_HPP
#define QUICC_SPATIALSCHEME_3D_TFF_HPP
...
namespace SpatialScheme {
    ...
    * @brief ID of the Chebyshev(FFT) + Fourier + Fourier scheme
    */
   class TFF: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit TFF(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_TFF_HPP
