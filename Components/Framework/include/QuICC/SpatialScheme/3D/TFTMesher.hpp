/** 
 * @file TFTMesher.hpp
 * @brief Implementation of the TFT spatial scheme mesher
 */

#ifndef QUICC_SPATIALSCHEME_3D_TFTMESHER_HPP
#define QUICC_SPATIALSCHEME_3D_TFTMESHER_HPP
...
namespace SpatialScheme {
    ...
    * @brief Implementation of the TFT spatial scheme mesher
    */
   class TFTMesher: public IMesher
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         explicit TFTMesher(const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_TFTMESHER_HPP
