/**
 * @file JLFm.hpp
 * @brief ID of the spherical Bessel(poly) + Spherical harmonics (Associated Legendre(poly) +  Fourier) scheme with spectral m ordering
 */

#ifndef QUICC_SPATIALSCHEME_3D_JLFM_HPP
#define QUICC_SPATIALSCHEME_3D_JLFM_HPP
...
namespace SpatialScheme {
    ...
    * @brief ID of the spherical Bessel(poly) + Spherical harmonics (Associated Legendre(poly) +  Fourier) scheme with spectral m ordering
    */
   class JLFm: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit JLFm(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_JLFM_HPP
