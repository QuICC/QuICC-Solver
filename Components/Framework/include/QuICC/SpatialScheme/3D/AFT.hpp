/**
 * @file AFT.hpp
 * @brief ID of the annulus Chebyshev(FFT) + Fourier + Chebyshev(FFT) scheme
 */

#ifndef QUICC_SPATIALSCHEME_3D_AFT_HPP
#define QUICC_SPATIALSCHEME_3D_AFT_HPP
...
namespace SpatialScheme {
   ...
   /**
    * @brief ID of annulus Chebyshev(FFT) + Fourier + Chebyshev(FFT) scheme
    */
   class AFT: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit AFT(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_AFT_HPP
