/** 
 * @file ITriangularSHlBuilder.hpp
 * @brief Implementation of the triangular basis + Spherical Harmonics scheme with l spectral ordering
 */

#ifndef QUICC_SPATIALSCHEME_ITRIANGULARSHLBUILDER_HPP
#define QUICC_SPATIALSCHEME_ITRIANGULARSHLBUILDER_HPP
...
namespace SpatialScheme {
   ...
   /**
    * @brief Implementation of triangular basis + Spherical Harmonics scheme with l spectral ordering
    */
   class ITriangularSHlBuilder: public IBuilder
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         explicit ITriangularSHlBuilder(const ArrayI& dim, const GridPurpose::Id purpose);

         /**
          * @brief Destructor
          */
         virtual ~ITriangularSHlBuilder();
...
#endif // QUICC_SPATIALSCHEME_ITRIANGULARSHLBUILDER_HPP
