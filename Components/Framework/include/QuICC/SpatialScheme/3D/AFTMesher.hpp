/** 
 * @file AFTMesher.hpp
 * @brief Implementation of the AFT spatial scheme mesher
 */

#ifndef QUICC_SPATIALSCHEME_3D_AFTMESHER_HPP
#define QUICC_SPATIALSCHEME_3D_AFTMESHER_HPP
...
namespace SpatialScheme {
    ...
    * @brief Implementation of the AFT spatial scheme mesher
    */
   class AFTMesher: public IMesher
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         explicit AFTMesher(const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_AFTMESHER_HPP
