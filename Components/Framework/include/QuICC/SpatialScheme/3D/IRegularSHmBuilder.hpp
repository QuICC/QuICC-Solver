/** 
 * @file IRegularSHmBuilder.hpp
 * @brief Implementation of the Regular basis + Spherical Harmonics scheme with m spectral ordering
 */

#ifndef QUICC_SPATIALSCHEME_IREGULARSHMBUILDER_HPP
#define QUICC_SPATIALSCHEME_IREGULARSHMBUILDER_HPP
...
namespace SpatialScheme {
    ...
    */
   class IRegularSHmBuilder: public IBuilder
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         explicit IRegularSHmBuilder(const ArrayI& dim, const GridPurpose::Id purpose);

         /**
          * @brief Destructor
          */
         virtual ~IRegularSHmBuilder();
...
#endif // QUICC_SPATIALSCHEME_IREGULARSHMBUILDER_HPP
