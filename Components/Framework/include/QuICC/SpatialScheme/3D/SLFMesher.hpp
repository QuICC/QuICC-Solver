/** 
 * @file SLFMesher.hpp
 * @brief Implementation of the SLF spatial scheme mesher
 */

#ifndef QUICC_SPATIALSCHEME_3D_SLFMESHER_HPP
#define QUICC_SPATIALSCHEME_3D_SLFMESHER_HPP
...
namespace SpatialScheme {
    ...
    * @brief Implementation of the SLF spatial scheme mesher
    */
   class SLFMesher: public IMesher
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         explicit SLFMesher(const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_SLFMESHER_HPP
