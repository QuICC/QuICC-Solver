/**
 * @file FFF.hpp
 * @brief ID of the Fourier + Fourier + Fourier scheme
 */

#ifndef QUICC_SPATIALSCHEME_3D_FFF_HPP
#define QUICC_SPATIALSCHEME_3D_FFF_HPP
...
namespace SpatialScheme {
   ...
   /**
    * @brief ID of Fourier + Fourier + Fourier scheme
    */
   class FFF: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit FFF(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_FFF_HPP
