/**
 * @file FdWLFl.hpp
 * @brief ID of the Finite Differences sphere + Spherical harmonics (Associated Legendre(poly) +  Fourier) scheme with spectral l ordering
 */

#ifndef QUICC_SPATIALSCHEME_3D_FDWLFL_HPP
#define QUICC_SPATIALSCHEME_3D_FDWLFL_HPP
...
namespace SpatialScheme {
    ...
    * @brief ID of the Finite differences sphere + Spherical harmonics (Associated Legendre(poly) +  Fourier) scheme with spectral l ordering
    */
   class FdWLFl: public xLF
   {
      public:
         /**
          * @brief Constructor
          */
         explicit FdWLFl(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_FDWLFL_HPP
