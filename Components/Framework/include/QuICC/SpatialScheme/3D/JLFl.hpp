/**
 * @file JLFl.hpp
 * @brief ID of the spherical Bessel(poly) + Spherical harmonics (Associated Legendre(poly) +  Fourier) scheme with spectral l ordering
 */

#ifndef QUICC_SPATIALSCHEME_3D_JLFL_HPP
#define QUICC_SPATIALSCHEME_3D_JLFL_HPP
...
namespace SpatialScheme {
    ...
    * @brief ID of the spherical Bessel(poly) + Spherical harmonics (Associated Legendre(poly) +  Fourier) scheme with spectral l ordering
    */
   class JLFl: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit JLFl(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_3D_JLFL_HPP
