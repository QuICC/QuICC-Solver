/**
 * @file WFT.hpp
 * @brief ID of the cylindrical Worland(poly) + Fourier + Chebyshev(FFT) scheme
 */
...
namespace SpatialScheme {
    ...
    * @brief ID of the cylindrical Worland(poly) + Fourier + Chebyshev(FFT) scheme
    */
   class WFT: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit WFT(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
