...
#ifndef QUICC_SPATIALSCHEME_TOOLS_UNIFORM3D1D_HPP
#define QUICC_SPATIALSCHEME_TOOLS_UNIFORM3D1D_HPP
...
namespace Tools {
   ...
   /**
    * @brief Implementation of the tools for the uniform + uniform + uniform spatial schemes (3D), 1D transform stage
    */
   class Uniform3D1D: public IBase
   {
      public:
         /**
          * @brief Default ctor
...
#endif // QUICC_SPATIALSCHEME_TOOLS_UNIFORM3D1D_HPP
