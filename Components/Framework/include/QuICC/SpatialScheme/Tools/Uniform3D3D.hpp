...
#ifndef QUICC_SPATIALSCHEME_TOOLS_UNIFORM3D3D_HPP
#define QUICC_SPATIALSCHEME_TOOLS_UNIFORM3D3D_HPP
...
namespace Tools {
   ...
   /**
    * @brief Implementation of the tools for the uniform + uniform + uniform spatial schemes, 3D transform stage
    */
   class Uniform3D3D: public IBase
   {
      public:
         /**
          * @brief Default ctor
...
#endif // QUICC_SPATIALSCHEME_TOOLS_UNIFORM3D3D_HPP
