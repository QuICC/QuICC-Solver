...
namespace SpatialScheme {
   ...
   class IBuilder : public ICosts
   {
      public:
          ...
          * @param idx3D   Storage for forward indexes of third dimension
          */
         virtual int fillIndexes1D(const Dimensions::Transform::Id transId, std::vector<std::vector<std::vector<int> > >& fwd1D, std::vector<std::vector<std::vector<int> > >& bwd1D, const std::vector<std::vector<int> >& idx2D, const std::vector<int>& idx3D) {return 1;};
