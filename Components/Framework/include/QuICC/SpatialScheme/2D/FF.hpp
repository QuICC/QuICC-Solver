...
#ifndef QUICC_SPATIALSCHEME_FF_HPP
#define QUICC_SPATIALSCHEME_FF_HPP
...
namespace SpatialScheme {
    ...
    */
   class FF: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit FF(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_FF_HPP
