/** 
 * @file FFMesher.hpp
 * @brief Implementation of the FF spatial scheme mesher
 */

#ifndef QUICC_SPATIALSCHEME_2D_FFMESHER_HPP
#define QUICC_SPATIALSCHEME_2D_FFMESHER_HPP
...
namespace SpatialScheme {
    ...
    * @brief Implementation of the FF spatial scheme mesher
    */
   class FFMesher: public I2DMesher
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         explicit FFMesher(const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_2D_FFMESHER_HPP
