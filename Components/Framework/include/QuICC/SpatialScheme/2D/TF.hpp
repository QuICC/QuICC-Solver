...
#ifndef QUICC_SPATIALSCHEME_TF_HPP
#define QUICC_SPATIALSCHEME_TF_HPP
...
namespace SpatialScheme {
    ...
    */
   class TF: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit TF(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_TF_HPP
