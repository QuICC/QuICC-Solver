...
#ifndef QUICC_SPATIALSCHEME_T_HPP
#define QUICC_SPATIALSCHEME_T_HPP
...
namespace SpatialScheme {
   ...
   /**
    * @brief Implementation ID of Chebyshev(FFT) scheme
    */
   class T: public ISpatialScheme
   {
      public:
         /**
          * @brief Constructor
          */
         explicit T(const VectorFormulation::Id formulation, const GridPurpose::Id purpose);
...
#endif // QUICC_SPATIALSCHEME_T_HPP
