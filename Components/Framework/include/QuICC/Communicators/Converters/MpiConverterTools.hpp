...
/**
 * @brief Specialisation of the tools used by the MPI converter for 3D
 * simulation.
 */
...
public:
    ...
    */
   static void buildLocalFwdMap(CoordinateMap& rLocalIdxMap,
      SharedResolution spRes, const Dimensions::Transform::Id fwdDim);

   /**
    * @brief Build local cpu map of backward data
    */
   static void buildLocalBwdMap(CoordinateMap& rLocalIdxMap,
      SharedResolution spRes, const Dimensions::Transform::Id fwdDim,
   ...
   template <typename TData,
      Dimensions::Data::Id TDataId = Dimensions::Data::DATF1D>
   static MPI_Datatype buildDatatype(const CoordinateMap& localIdxMap,
      SharedResolution spRes, const Dimensions::Transform::Id fwdDim,
      const Dimensions::Transform::Id keyId, TData& data, const int cpuId);
   ...
   template <typename TData,
      Dimensions::Data::Id TDataId = Dimensions::Data::DATF1D>
   static void buildDatatype(CoordinateVector& coords,
      const CoordinateMap& localIdxMap, SharedResolution spRes,
      const Dimensions::Transform::Id fwdDim,
      const Dimensions::Transform::Id keyId, TData& data, const int cpuId);
    ...
    */
   template <typename TData>
   static void pack(TData* rBuffer, int& position,
      const typename Framework::Selector::ScalarField<TData>& data,
      const CoordinateVector& coords);
    ...
    */
   template <typename TData>
   static void pack(char* rBuffer, int& position,
      const typename Framework::Selector::ScalarField<TData>& data,
      const CoordinateVector& coords);
    ...
    */
   template <typename TData>
   static void unpack(typename Framework::Selector::ScalarField<TData>& rData,
      const CoordinateVector& coords, const char* buffer, int& position);
   ...
   template <typename TData>
   static void unpack(typename Framework::Selector::ScalarField<TData>& rData,
      const CoordinateVector& coords, const TData* buffer, int& position);
...
private:
   ...
   static void buildLocalMap3D(CoordinateMap& rLocalIdxMap,
      SharedResolution spRes, const Dimensions::Transform::Id tId,
      const IIndexConv& idxConv);
    ...
    */
   template <Dimensions::Data::Id TDataId>
   static void buildLocalMap1D(CoordinateMap& rLocalIdxMap,
      SharedResolution spRes, const Dimensions::Transform::Id tId,
      const IIndexConv& idxConv);
   /**
    ...
    */
   template <Dimensions::Data::Id TDataId>
   static void buildLocalMap2D(CoordinateMap& rLocalIdxMap,
      SharedResolution spRes, const Dimensions::Transform::Id tId,
      const IIndexConv& idxConv);
    ...
    */
   template <Dimensions::Data::Id TDataId>
   static void buildCpuMap3D(CoordinateMap& sharedMap,
      const CoordinateMap& localIdxMap, SharedResolution spRes,
      const Dimensions::Transform::Id tId,
      const Dimensions::Transform::Id keyId, const int cpuId);
    ...
    */
   template <Dimensions::Data::Id TDataId>
   static void buildCpuMap2D(CoordinateMap& sharedMap,
      const CoordinateMap& localIdxMap, SharedResolution spRes,
      const Dimensions::Transform::Id tId,
      const Dimensions::Transform::Id keyId, const int cpuId);
    ...
    */
   template <Dimensions::Data::Id TDataId>
   static void buildCpuMap1D(CoordinateMap& sharedMap,
      const CoordinateMap& localIdxMap, SharedResolution spRes,
      const Dimensions::Transform::Id tId,
      const Dimensions::Transform::Id keyId, const int cpuId);
   ...
   static MPI_Datatype buildType(
      typename Framework::Selector::ScalarField<TData>& data,
      const CoordinateMap& sharedMap);
...
template <typename TData>
void MpiConverterTools::pack(char* rBuffer, int& position,
   const typename Framework::Selector::ScalarField<TData>& data,
   const CoordinateVector& coords)
{
...
template <typename TData>
void MpiConverterTools::pack(TData* rBuffer, int& position,
   const typename Framework::Selector::ScalarField<TData>& data,
   const CoordinateVector& coords)
{
   // Create MPI displacement list
...
template <typename TData>
void MpiConverterTools::unpack(
   typename Framework::Selector::ScalarField<TData>& rData,
   const CoordinateVector& coords, const char* buffer, int& position)
{
   // Create MPI displacement list
   for (auto it = coords.cbegin(); it != coords.cend(); ++it)
...
template <typename TData>
MPI_Datatype MpiConverterTools::buildType(
   typename Framework::Selector::ScalarField<TData>& data,
   const CoordinateMap& sharedMap)
{
   // MPI error code
   ...
   // Create MPI datatype
   MPI_Datatype type;
   // ierr = MPI_Type_create_hindexed(nElements, blocks, displ,
   // MpiTypes::type<TData>(), &type);
   ierr = MPI_Type_create_hindexed_block(nElements, 1, displ,
      Environment::MpiTypes::type<TData>(), &type);
...
void MpiConverterTools::buildDatatype(CoordinateVector& coords,
   const CoordinateMap& localIdxMap, SharedResolution spRes,
   const Dimensions::Transform::Id fwdDim,
   const Dimensions::Transform::Id keyId, TData& data, const int cpuId)
{
   ...
   {
   case 3:
      MpiConverterTools::buildCpuMap3D<TDataId>(sharedMap, localIdxMap, spRes,
         fwdDim, keyId, cpuId);
      break;
   case 2:
      MpiConverterTools::buildCpuMap2D<TDataId>(sharedMap, localIdxMap, spRes,
         fwdDim, keyId, cpuId);
      break;
   case 1:
      MpiConverterTools::buildCpuMap1D<TDataId>(sharedMap, localIdxMap, spRes,
         fwdDim, keyId, cpuId);
      break;
   default:
      throw std::logic_error(
         "Tried to build CPU coordinate map for unimplemented dimension!");
   }
...
template <typename TData, Dimensions::Data::Id TDataId>
MPI_Datatype MpiConverterTools::buildDatatype(const CoordinateMap& localIdxMap,
   SharedResolution spRes, const Dimensions::Transform::Id fwdDim,
   const Dimensions::Transform::Id keyId, TData& data, const int cpuId)
{
   CoordinateMap sharedMap;
...
template <Dimensions::Data::Id TDataId>
void MpiConverterTools::buildLocalMap3D(CoordinateMap& rLocalIdxMap,
   SharedResolution spRes, const Dimensions::Transform::Id tId,
   const IIndexConv& idxConv)
{
...
template <Dimensions::Data::Id TDataId>
void MpiConverterTools::buildLocalMap2D(CoordinateMap& rLocalIdxMap,
   SharedResolution spRes, const Dimensions::Transform::Id tId,
   const IIndexConv& idxConv)
{
   // Make sure key map is empty
...
template <Dimensions::Data::Id TDataId>
void MpiConverterTools::buildLocalMap1D(CoordinateMap& rLocalIdxMap,
   SharedResolution spRes, const Dimensions::Transform::Id tId,
   const IIndexConv& idxConv)
{
   // Make sure key map is empty
   ...
   for (int i = 0; i < spRes->cpu(QuICCEnv().id())->dim(tId)->dim<TDataId>();
        ++i)
   {
      // Extract "physical" index of fast data dimension
...
template <Dimensions::Data::Id TDataId>
void MpiConverterTools::buildCpuMap3D(CoordinateMap& sharedMap,
   const CoordinateMap& localIdxMap, SharedResolution spRes,
   ...
   const int cpuId)
{
   ...
   if (cpuId == QuICCEnv().id(tId))
   {
      ...
      QuICCEnv().check(ierr,
         "Broadcast of sizes in 3D remote index map failed");

      // Broadcast data
      QuICCEnv().synchronize(tId);
      ierr = MPI_Bcast(matRemote.data(), matRemote.size(), MPI_INT, cpuId,
         QuICCEnv().comm(tId));
   ...
   else
   {
      ...
      ierr = MPI_Bcast(&nCoords, 1, MPI_INT, cpuId, QuICCEnv().comm(tId));
      QuICCEnv().check(ierr,
         "Receiving broadcast of sizes of 3D remote index map failed");
      ...
      ierr = MPI_Bcast(matRemote.data(), matRemote.size(), MPI_INT, cpuId,
         QuICCEnv().comm(tId));
      QuICCEnv().check(ierr,
         "Receiving broadcast of 3D remote index map failed");
...
template <Dimensions::Data::Id TDataId>
void MpiConverterTools::buildCpuMap2D(CoordinateMap& sharedMap,
   const CoordinateMap& localIdxMap, SharedResolution spRes,
   const Dimensions::Transform::Id tId, const Dimensions::Transform::Id keyId,
   const int cpuId)
{
   ...
   if (cpuId == QuICCEnv().id(tId))
   {
      ...
      for (int j = 0; j < tRes.dim<Dimensions::Data::DAT2D>(); ++j)
      {
         ...
         for (int i = 0; i < tRes.dim<TDataId>(); ++i)
         {
            ...
            // Create key as (2D, 3D, 1D) indexes (i.e. data gets transposed
      ...
      ierr = MPI_Bcast(&nCoords, 1, MPI_INT, cpuId, QuICCEnv().comm(tId));
      QuICCEnv().check(ierr,
         "Broadcast of sizes in 2D remote index map failed");
   ...
   else
   {
      ...
      ierr = MPI_Bcast(&nCoords, 1, MPI_INT, cpuId, QuICCEnv().comm(tId));
      QuICCEnv().check(ierr,
         "Receiving broadcast of sizes of 2D remote index map failed");
      ...
      ierr = MPI_Bcast(matRemote.data(), matRemote.size(), MPI_INT, cpuId,
         QuICCEnv().comm(tId));
      QuICCEnv().check(ierr,
         "Receiving broadcast of 2D remote index map failed");
...
template <Dimensions::Data::Id TDataId>
void MpiConverterTools::buildCpuMap1D(CoordinateMap& sharedMap,
   const CoordinateMap& localIdxMap, SharedResolution spRes,
   const Dimensions::Transform::Id tId, const Dimensions::Transform::Id keyId,
   const int cpuId)
{
