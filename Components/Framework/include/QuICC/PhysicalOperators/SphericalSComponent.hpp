...
namespace Physical {
   ...
   template <typename TFIELD>
   void SphericalSComponent::set(TFIELD &rS, const Resolution& res, const Array& cosTheta, const Array& sinTheta, const Datatypes::VectorField<TFIELD, FieldComponents::Physical::Id> &v, const MHDFloat c)
   {
      IdxResFunctor f(res);
   ...
   template <typename TFIELD>
   void SphericalSComponent::add(TFIELD &rS, const Resolution& res, const Array& cosTheta, const Array& sinTheta, const Datatypes::VectorField<TFIELD, FieldComponents::Physical::Id> &v, const MHDFloat c)
   {
      IdxResFunctor f(res);
   ...
   template <typename TFIELD>
   void SphericalSComponent::sub(TFIELD &rS, const Resolution& res, const Array& cosTheta, const Array& sinTheta, const Datatypes::VectorField<TFIELD, FieldComponents::Physical::Id> &v, const MHDFloat c)
   {
      IdxResFunctor f(res);
   ...
   template <typename TFIELD, typename TIDXFUNC>
   void SphericalSComponent::set(TFIELD &rS, const TIDXFUNC& idxFunc, const Array& cosTheta, const Array& sinTheta, const Datatypes::VectorField<TFIELD, FieldComponents::Physical::Id> &v, const MHDFloat c)
   {
   ...
   template <typename TFIELD, typename TIDXFUNC>
   void SphericalSComponent::add(TFIELD &rS, const TIDXFUNC& idxFunc, const Array& cosTheta, const Array& sinTheta, const Datatypes::VectorField<TFIELD, FieldComponents::Physical::Id> &v, const MHDFloat c)
   {
      using scalar_t = typename TFIELD::PointType;
      if constexpr(std::is_same_v<TFIELD, Datatypes::ViewScalarField<scalar_t>>)
      {
   ...
   template <typename TFIELD, typename TIDXFUNC>
   void SphericalSComponent::sub(TFIELD &rS, const TIDXFUNC& idxFunc, const Array& cosTheta, const Array& sinTheta, const Datatypes::VectorField<TFIELD, FieldComponents::Physical::Id> &v, const MHDFloat c)
   {
      using scalar_t = typename TFIELD::PointType;
      if constexpr(std::is_same_v<TFIELD, Datatypes::ViewScalarField<scalar_t>>)
      {
