...
public:
   ...
   typedef std::pair<ScalarEquation_iterator, ScalarEquation_iterator>
      ScalarEquation_range;

   /// Typedef for a shared vector equation range
   typedef std::pair<VectorEquation_iterator, VectorEquation_iterator>
      VectorEquation_range;
   ...
   typedef std::pair<ScalarVariable_iterator, ScalarVariable_iterator>
      ScalarVariable_range;

   /// Typedef for a shared vector variable range
   typedef std::pair<VectorVariable_iterator, VectorVariable_iterator>
      VectorVariable_range;
    ...
    */
   void initParallel(SharedResolution spRes,
    ...
    */
   void solvePrognosticEquations(ScalarEquation_range scalarEq_range,
...
protected:
    ...
    * @param it   Iteration index
    */
   SharedIScalarEquation scalarEq(const std::size_t eqId, const int it,
      const int i = 0);
    ...
    * @param it   Iteration index
    */
   SharedIVectorEquation vectorEq(const std::size_t eqId, const int it,
      const int i = 0);
    ...
    * @brief Transform coordinator
    */
   std::shared_ptr<Transform::TransformCoordinatorType>
      mspImposedTransformCoordinator;
    ...
    */
   std::map<int, std::map<std::size_t, Physical::Kernel::SharedIPhysicalKernel>>
      mPhysicalKernels;
   ...
   using varBlock_t = std::variant<Memory::MemBlock<double>,
...
private:
    ...
    */
   void addToMap(const std::size_t eqId, const int it,
   ...
   /**
    * @brief Sort equations and store information for timestep/solver/nothing
    * ranges
    */
   void sortEquations();
