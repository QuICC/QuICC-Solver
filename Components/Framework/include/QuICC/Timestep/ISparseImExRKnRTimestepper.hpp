...
namespace Timestep {
    ...
    */
   template <typename TOperator,typename TData,template <typename> class TSolver> class ISparseImExRKnRTimestepper: public ISparseTimestepper<TOperator,TData,TSolver>
   {
      public:
         /**
          * @brief Constructor
   ...
   template <typename TOperator,typename TData,template <typename> class TSolver> int ISparseImExRKnRTimestepper<TOperator,TData,TSolver>::steps() const
   {
   ...
   template <typename TOperator,typename TData,template <typename> class TSolver> MHDFloat ISparseImExRKnRTimestepper<TOperator,TData,TSolver>::aIm(const int step) const
   {
   ...
   template <typename TOperator,typename TData,template <typename> class TSolver> void ISparseImExRKnRTimestepper<TOperator,TData,TSolver>::addStorage(const int rows, const int cols)
   {
      ...
      std::vector<std::size_t> ids = {Register::Implicit::id(), Register::Explicit::id(), Register::Intermediate::id()};
