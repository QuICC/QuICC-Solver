...
#ifndef QUICC_SPECTRAL_KERNEL_SHELL_CONSERVEANGULARMOMENTUM_HPP
#define QUICC_SPECTRAL_KERNEL_SHELL_CONSERVEANGULARMOMENTUM_HPP
...
namespace Shell {
   ...
   class ConserveAngularMomentum: public ISpectralKernel
   {
      public:
          ...
          */
         explicit ConserveAngularMomentum(const bool isComplex, MHDFloat ro, MHDFloat ri);
      ...
      private:
         ...
         /**
          * @brief outer boundary radius
          */
         MHDFloat mRo;

         /**
          * @brief inner boundary radius
          */
         MHDFloat mRi;
...
#endif // QUICC_SPECTRAL_KERNEL_SHELL_CONSERVEANGULARMOMENTUM_HPP
