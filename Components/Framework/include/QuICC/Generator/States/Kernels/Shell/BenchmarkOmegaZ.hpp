/**
 * @file BenchmarkOmegaZ.hpp
 * @brief Velocity benchmark state Omega X generator kernel
 */

#ifndef QUICC_PHYSICAL_KERNEL_SHELL_BENCHMARKOMEGAZ_HPP
#define QUICC_PHYSICAL_KERNEL_SHELL_BENCHMARKOMEGAZ_HPP
...
namespace Shell {
    ...
    * @brief Velocity benchmark state Omega X generator kernel
    */
   class BenchmarkOmegaZ: public IPhysicalKernel
   {
      public:
         /**
          * @brief Simple constructor
          */
         explicit BenchmarkOmegaZ();

         /**
          * @brief Simple empty destructor
          */
         virtual ~BenchmarkOmegaZ();
...
#endif // QUICC_PHYSICAL_KERNEL_SHELL_BENCHMARKOMEGAZ_HPP
