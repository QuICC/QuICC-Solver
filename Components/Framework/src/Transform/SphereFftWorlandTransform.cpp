...
//      this->mImpl.addOperator<Fft::Worland::Projector::D1R1>(Backward::D1R1::id());
      ...
      this->mImpl.addOperator<Fft::Worland::Integrator::R1>(Forward::R1::id());
      this->mImpl.addOperator<Fft::Worland::Integrator::I4DivR1_Zero>(Forward::Q4::id());
      this->mImpl.addOperator<Fft::Worland::Integrator::I4DivR1D1R1_Zero>(Forward::S4::id());
      this->mImpl.addOperator<Fft::Worland::Integrator::I2_Zero>(Forward::T::id());
      this->mImpl.addOperator<Fft::Worland::Integrator::I2DivR1_Zero>(Forward::Q2::id());
      this->mImpl.addOperator<Fft::Worland::Integrator::I2DivR1D1R1_Zero>(Forward::S2::id());
