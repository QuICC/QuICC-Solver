...
namespace Transform {
   ...
   void DefaultShellChebyshevMap::operator()(MapType& m) const
   {
      ...
      this->addOperator<Fft::Chebyshev::LinearMap::Projector::D1Y1<backend_t>>(m, Backward::D1R1::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Projector::D2<backend_t>>(m, Backward::D2::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Projector::DivY1D1Y1<backend_t>>(m, Backward::Overr1D1R1::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Projector::SphRadLapl<backend_t>>(m, Backward::Slaplr::id());

      // Create integrators
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::P<backend_t>>(m, Forward::P::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::Y1_Zero<backend_t>>(m, Forward::Pol::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::P_Zero<backend_t>>(m, Forward::T::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::I4Y3_Zero<backend_t>>(m, Forward::I4Q::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::I4Y3D1Y1_Zero<backend_t>>(m, Forward::I4S::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::I2Y2_Zero<backend_t>>(m, Forward::I2T::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::I2Y1_Zero<backend_t>>(m, Forward::I2Q::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::I2Y1D1Y1_Zero<backend_t>>(m, Forward::I2S::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::I2Y2_Zero<backend_t>>(m, Forward::I2rQ::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Integrator::I2Y2D1Y1_Zero<backend_t>>(m, Forward::I2rS::id());
      

      // Create reductors
      this->addOperator<Fft::Chebyshev::LinearMap::Reductor::Energy<backend_t>>(m, Reductor::Energy::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Reductor::EnergyD1Y1<backend_t>>(m, Reductor::EnergyD1R1::id());
      this->addOperator<Fft::Chebyshev::LinearMap::Reductor::EnergyY2<backend_t>>(m, Reductor::EnergyR2::id());
   }
