...
void DefaultSphereWorlandMap::operator()(MapType& m) const
{
    ...
    this->addOperator<Fft::Worland::Projector::P<backend_t>>(m,
         Backward::P::id());
      this->addOperator<Fft::Worland::Projector::DivR1_Zero<backend_t>>(m,
         Backward::Overr1::id());
      this->addOperator<Fft::Worland::Projector::D1<backend_t>>(m,
         Backward::D1::id());
      //this->addOperator<Fft::Worland::Projector::D1R1<backend_t>>(m,
      //   Backward::D1R1::id());
      this->addOperator<Fft::Worland::Projector::DivR1D1R1_Zero<backend_t>>(m,
         Backward::Overr1D1R1::id());
      this->addOperator<Fft::Worland::Projector::SphLapl<backend_t>>(m,
         Backward::Slapl::id());

      // Create integrators
      this->addOperator<Fft::Worland::Integrator::P<backend_t>>(m,
         Forward::P::id());
      this->addOperator<Fft::Worland::Integrator::R1_Zero<backend_t>>(m,
         Forward::Pol::id());
      this->addOperator<Fft::Worland::Integrator::DivR1_Zero<backend_t>>(m,
         Forward::Q::id());
      this->addOperator<Fft::Worland::Integrator::DivR1D1R1_Zero<backend_t>>(m,
         Forward::S::id());
      this->addOperator<Fft::Worland::Integrator::P_Zero<backend_t>>(m,
         Forward::T::id());
      this->addOperator<Fft::Worland::Integrator::I2<backend_t>>(m,
         Forward::I2P::id());
      this->addOperator<Fft::Worland::Integrator::I2DivR1_Zero<backend_t>>(m,
         Forward::I2Q::id());
      this->addOperator<Fft::Worland::Integrator::I2DivR1D1R1_Zero<backend_t>>(
         m, Forward::I2S::id());
      this->addOperator<Fft::Worland::Integrator::I2_Zero<backend_t>>(m,
         Forward::I2T::id());
      this->addOperator<Fft::Worland::Integrator::I4DivR1_Zero<backend_t>>(m,
         Forward::I4Q::id());
      this->addOperator<Fft::Worland::Integrator::I4DivR1D1R1_Zero<backend_t>>(
         m, Forward::I4S::id());
#else
   ...
   using backend_t = Poly::Worland::viewCpu_t;
      ...
      // Create projectors
      this->addOperator<Poly::Worland::Projector::P<backend_t>>(m,
         Backward::P::id());
      ...
      this->addOperator<Poly::Worland::Integrator::P<backend_t>>(m,
         Forward::P::id());
      this->addOperator<Poly::Worland::Integrator::R1_Zero<backend_t>>(m,
         Forward::Pol::id());
      this->addOperator<Poly::Worland::Integrator::DivR1_Zero<backend_t>>(m,
         Forward::Q::id());
      this->addOperator<Poly::Worland::Integrator::DivR1D1R1_Zero<backend_t>>(m,
         Forward::S::id());
      this->addOperator<Poly::Worland::Integrator::P_Zero<backend_t>>(m,
         Forward::T::id());
      this->addOperator<Poly::Worland::Integrator::I2<backend_t>>(m,
         Forward::I2P::id());
      this->addOperator<Poly::Worland::Integrator::I2DivR1_Zero<backend_t>>(m,
         Forward::I2Q::id());
      this->addOperator<Poly::Worland::Integrator::I2DivR1D1R1_Zero<backend_t>>(
         m, Forward::I2S::id());
      ...
      this->addOperator<Poly::Worland::Integrator::I4DivR1_Zero<backend_t>>(m,
         Forward::I4Q::id());
      this->addOperator<Poly::Worland::Integrator::I4DivR1D1R1_Zero<backend_t>>(
         m, Forward::I4S::id());

      // Create reductors
      this->addOperator<Poly::Worland::Reductor::EnergySLaplR2<backend_t>>(m,
         Reductor::EnergySlaplR2::id());
      this->addOperator<Poly::Worland::Reductor::EnergyD1R1<backend_t>>(m,
         Reductor::EnergyD1R1::id());
      this->addOperator<Poly::Worland::Reductor::EnergyR2<backend_t>>(m,
         Reductor::EnergyR2::id());
      this->addOperator<Poly::Worland::Reductor::Energy<backend_t>>(m,
         Reductor::Energy::id());
      this->addOperator<Poly::Worland::Reductor::PowerSLaplR2<backend_t>>(m,
         Reductor::PowerSlaplR2::id());
      this->addOperator<Poly::Worland::Reductor::PowerD1R1<backend_t>>(m,
         Reductor::PowerD1R1::id());
      this->addOperator<Poly::Worland::Reductor::PowerR2<backend_t>>(m,
         Reductor::PowerR2::id());
      ...
      this->addOperator<
         Poly::Worland::Reductor::RadialPowerDivR1D1R1<backend_t>>(m,
