...
namespace Transform {
   ...
   void DefaultSphereWorlandMap::operator()(MapType& m) const
   {
      ...
      this->addOperator<Poly::Worland::Projector::DivR1_Zero>(m, Backward::Overr1::id());
      this->addOperator<Poly::Worland::Projector::D1>(m, Backward::D1::id());
      this->addOperator<Poly::Worland::Projector::D1R1>(m, Backward::D1R1::id());
      this->addOperator<Poly::Worland::Projector::DivR1D1R1_Zero>(m, Backward::Overr1D1R1::id());
      this->addOperator<Poly::Worland::Projector::SphLapl>(m, Backward::Slapl::id());

      // Create integrators
      this->addOperator<Poly::Worland::Integrator::P>(m, Forward::P::id());
      this->addOperator<Poly::Worland::Integrator::R1_Zero>(m, Forward::Pol::id());
      this->addOperator<Poly::Worland::Integrator::DivR1_Zero>(m, Forward::Q::id());
      this->addOperator<Poly::Worland::Integrator::DivR1D1R1_Zero>(m, Forward::S::id());
      this->addOperator<Poly::Worland::Integrator::P_Zero>(m, Forward::T::id());
      this->addOperator<Poly::Worland::Integrator::I2>(m, Forward::I2P::id());
      this->addOperator<Poly::Worland::Integrator::I2DivR1_Zero>(m, Forward::I2Q::id());
      this->addOperator<Poly::Worland::Integrator::I2DivR1D1R1_Zero>(m, Forward::I2S::id());
      this->addOperator<Poly::Worland::Integrator::I2_Zero>(m, Forward::I2T::id());
      this->addOperator<Poly::Worland::Integrator::I4DivR1_Zero>(m, Forward::I4Q::id());
      this->addOperator<Poly::Worland::Integrator::I4DivR1D1R1_Zero>(m, Forward::I4S::id());

      // Create reductors
      this->addOperator<Poly::Worland::Reductor::EnergySLaplR2>(m, Reductor::EnergySlaplR2::id());
      this->addOperator<Poly::Worland::Reductor::EnergyD1R1>(m, Reductor::EnergyD1R1::id());
      this->addOperator<Poly::Worland::Reductor::EnergyR2>(m, Reductor::EnergyR2::id());
      this->addOperator<Poly::Worland::Reductor::Energy>(m, Reductor::Energy::id());
      this->addOperator<Poly::Worland::Reductor::PowerSLaplR2>(m, Reductor::PowerSlaplR2::id());
      this->addOperator<Poly::Worland::Reductor::PowerD1R1>(m, Reductor::PowerD1R1::id());
      this->addOperator<Poly::Worland::Reductor::PowerR2>(m, Reductor::PowerR2::id());
      this->addOperator<Poly::Worland::Reductor::Power>(m, Reductor::Power::id());
      this->addOperator<Poly::Worland::Reductor::RadialPower>(m, Reductor::RadialPower::id());
      this->addOperator<Poly::Worland::Reductor::RadialPowerDivR1>(m, Reductor::RadialPowerOverr1::id());
      this->addOperator<Poly::Worland::Reductor::RadialPowerDivR1D1R1>(m, Reductor::RadialPowerOverr1D1R1::id());
   }
