...
#include "QuICC/Transform/Poly/ALegendre/Projector/Llm1D1.hpp"
...
void ALegendreTransform::requiredOptions(std::set<std::size_t>& list,
   const Dimensions::Transform::Id dimId) const
{
   this->mImpl.requiredOptions(list, dimId);
}

void ALegendreTransform::setOptions(
   const std::map<std::size_t, NonDimensional::SharedINumber>& options,
   const Dimensions::Transform::Id dimId)
{
...
void ALegendreTransform::initOperators()
{
   ...
   this->mImpl.addOperator<Poly::ALegendre::Integrator::P<backend_t>>(
      Forward::P::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::DivLl<backend_t>>(
      Forward::Overlaplh::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::Ll<backend_t>>(
      Forward::Laplh::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::Ll2<backend_t>>(
      Forward::Laplh2::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::DivS1<backend_t>>(
      Forward::Oversin::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::DivLlDivS1<backend_t>>(
      Forward::OverlaplhOversin::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::LlDivS1<backend_t>>(
      Forward::LaplhOversin::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::D1<backend_t>>(
      Forward::D1::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::DivLlD1<backend_t>>(
      Forward::OverlaplhD1::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::LlD1<backend_t>>(
      Forward::LaplhD1::id());
   this->mImpl.addOperator<Poly::ALegendre::Integrator::DivS1Dp<backend_t>>(
      Forward::OversinDphi::id());
   this->mImpl
      .addOperator<Poly::ALegendre::Integrator::DivLlDivS1Dp<backend_t>>(
