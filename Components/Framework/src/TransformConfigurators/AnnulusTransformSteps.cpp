...
namespace Transform {
   ...
   std::vector<TransformPath>  AnnulusTransformSteps::forwardScalar(const std::vector<std::pair<FieldComponents::Spectral::Id,int> >& components) const
   {
   ...
   std::vector<TransformPath>  AnnulusTransformSteps::forwardNLScalar(const std::vector<std::pair<FieldComponents::Spectral::Id,int> >& components) const
   {
      assert(components.size() == 1);
      std::vector<TransformPath> transform;
   ...
   std::vector<TransformPath>  AnnulusTransformSteps::forwardVector(const std::vector<std::pair<FieldComponents::Spectral::Id,int> >& components) const
   {
      std::vector<TransformPath> transform;
   ...
   std::vector<TransformPath>  AnnulusTransformSteps::forwardNLVector(const std::vector<std::pair<FieldComponents::Spectral::Id,int> >& components) const
   {
      std::vector<TransformPath> transform;
