/** 
 * @file TrapezoidalSHmlIndexCounter.cpp
 * @brief Source of spherical harmonic index counter with m spectral ordering with trapezoidal radial truncation
 */
...
namespace QuICC {
   ...
   TrapezoidalSHmlIndexCounter::TrapezoidalSHmlIndexCounter(SharedCSimulationResolution spSim, SharedCCoreResolution spCpu)
      : IResolutionIndexCounter(spSim, spCpu)
   {
   }

   int TrapezoidalSHmlIndexCounter::dim(const Dimensions::Simulation::Id simId, const Dimensions::Space::Id spaceId, const MHDFloat l) const
   {
   ...
   std::vector<int> TrapezoidalSHmlIndexCounter::makeVKey(const Dimensions::Transform::Id id, const int i, const int j, const int k) const
   {
      std::vector<int> key;
   ...
   std::tuple<int,int,int> TrapezoidalSHmlIndexCounter::makeKey(const Dimensions::Transform::Id id, const int i, const int j, const int k) const
   {
   ...
   ArrayI TrapezoidalSHmlIndexCounter::orderedDimensions(const Dimensions::Space::Id spaceId) const
   {
   ...
   ArrayI TrapezoidalSHmlIndexCounter::orderedDimensions(const ArrayI& dims, const Dimensions::Space::Id spaceId) const
   {
