/** 
 * @file RegularSHmIndexCounter.cpp
...
namespace QuICC {
   ...
   RegularSHmIndexCounter::RegularSHmIndexCounter(SharedCSimulationResolution spSim, SharedCCoreResolution spCpu)
      : IResolutionIndexCounter(spSim, spCpu)
   {
   }

   RegularSHmIndexCounter::~RegularSHmIndexCounter()
   {
   }

   std::vector<int> RegularSHmIndexCounter::makeVKey(const Dimensions::Transform::Id id, const int i, const int j, const int k) const
   {
      std::vector<int> key;
   ...
   std::tuple<int,int,int> RegularSHmIndexCounter::makeKey(const Dimensions::Transform::Id id, const int i, const int j, const int k) const
   {
   ...
   ArrayI RegularSHmIndexCounter::orderedDimensions(const Dimensions::Space::Id spaceId) const
   {
   ...
   ArrayI RegularSHmIndexCounter::orderedDimensions(const ArrayI& dims, const Dimensions::Space::Id spaceId) const
   {
