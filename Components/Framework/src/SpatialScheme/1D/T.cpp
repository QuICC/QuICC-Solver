...
namespace SpatialScheme {
   ...
   const std::size_t T::sId = Hasher::makeId(T::sTag);
   ...
   {
      auto spBuilder = makeBuilder<TBuilder>(dim, this->purpose(), needInterpretation, this->mImplType, this->mspCustomMesher);
