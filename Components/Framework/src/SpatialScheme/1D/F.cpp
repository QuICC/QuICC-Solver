...
namespace SpatialScheme {
   ...
   const std::size_t F::sId = Hasher::makeId(F::sTag);
   ...
   {
      auto spBuilder = makeBuilder<FBuilder>(dim, this->purpose(), needInterpretation, this->mImplType, this->mspCustomMesher);
