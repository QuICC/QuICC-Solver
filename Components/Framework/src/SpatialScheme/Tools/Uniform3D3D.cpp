...
namespace Tools {
   ...
   int Uniform3D3D::truncationFwd(const int nN, const int l)
   {
      return nN;
   }

   int Uniform3D3D::truncationBwd(const int nN, const int l)
   {
      return nN;
   }

   int Uniform3D3D::index(const int i, const int k)
   {
      return i;
   }
