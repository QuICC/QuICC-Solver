...
namespace Tools {
   ...
   int Uniform3D1D::truncationFwd(const int nN, const int j, const int k)
   {
      return nN;
   }

   int Uniform3D1D::truncationBwd(const int nN, const int j, const int k)
   {
      return nN;
   }

   int Uniform3D1D::index(const int i, const int j, const int k)
   {
      return i;
   }
