 ...
 * (Associated Legendre(poly) + Fourrier) scheme implementation with l spectral
 * ordering
 */
...
Transform::Fft::Chebyshev::SharedSetup SLFlBuilder::spSetup1D(
...
Transform::Poly::ALegendre::SharedSetup SLFlBuilder::spSetup2D(
   SharedResolution spRes) const
{
...
Transform::Fft::Fourier::Mixed::SharedSetup SLFlBuilder::spSetup3D(
   SharedResolution spRes) const
{
   // Get size of FFT transform
   int size = spRes->cpu()
