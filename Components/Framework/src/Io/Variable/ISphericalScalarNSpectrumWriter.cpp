...
ISphericalScalarNSpectrumWriter::ISphericalScalarNSpectrumWriter(
   const std::string& prefix, const std::string& type) :
    ISphericalScalarPowerBaseWriter(prefix + Tags::Spectrum::NBASENAME,
...
void ISphericalScalarNSpectrumWriter::resetPower()
{
   this->mPower.setZero();
}

void ISphericalScalarNSpectrumWriter::storePower(const int n, const int l,
