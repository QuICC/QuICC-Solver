/**
 * @file ShellScalarModeSpectrumWriter.cpp
 * @brief Source of the implementation of the ASCII spherical harmonics mode energy spectrum calculation for scalar field in a spherical shell
 */
...
// Project includes
//
#include "QuICC/Io/Variable/ShellScalarModeSpectrumWriter.hpp"
...
namespace Variable {
   ...
   ShellScalarModeSpectrumWriter::ShellScalarModeSpectrumWriter(const std::string& prefix, const std::string& type)
      : ISphericalScalarModeSpectrumWriter(prefix, type)
   {
   }

   void ShellScalarModeSpectrumWriter::init()
   {
