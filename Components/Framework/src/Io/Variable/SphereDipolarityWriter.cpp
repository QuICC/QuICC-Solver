...
SphereDipolarityWriter::SphereDipolarityWriter(const std::string& prefix,
...
void SphereDipolarityWriter::prepareInput(
...
void SphereDipolarityWriter::setCmbTruncation(const int nL)
{
   if(nL < 0)
   {
