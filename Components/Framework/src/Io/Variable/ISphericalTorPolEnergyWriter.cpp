 ...
 * calculation for toroidal/poloidal field in a spherical geometry
 */
...
void ISphericalTorPolEnergyWriter::storeQEnergy(const int l, const int m,
...
void ISphericalTorPolEnergyWriter::storeSEnergy(const int l, const int m,
   const MHDFloat energy)
{
   if ((l - m) % 2 == 0)
   {
...
void ISphericalTorPolEnergyWriter::storeTEnergy(const int l, const int m,
   const MHDFloat energy)
{
   if ((l - m) % 2 == 1)
   {
