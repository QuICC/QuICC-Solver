...
void ISphericalTorPolEnstrophyBaseWriter::prepareInput(
...
void ISphericalTorPolEnstrophyBaseWriter::compute(
   Transform::TransformCoordinatorType& coord)
{
   constexpr auto TId = Dimensions::Transform::TRA1D;
   Matrix spectrum;
   ...
   std::visit(
      ...
      {
         coord.transform1D().reduce(spectrum, p->data(),
            Transform::Reductor::EnergyD1R1::id());
      },
      pInVarPolQ);
   ...
   std::visit(
      ...
      {
         coord.transform1D().reduce(spectrum, p->data(),
            Transform::Reductor::EnergySlaplR2::id());
      },
      pInVarPolS);
