    ...
    mShowParity(false)
{
   ...
   std::vector<std::size_t> ops = {Transform::Reductor::EnergyR2::id(),
      Transform::Reductor::Energy::id(), Transform::Reductor::EnergyD1R1::id()};
...
void ISphericalTorPolEnergyBaseWriter::prepareInput(
...
void ISphericalTorPolEnergyBaseWriter::compute(
   Transform::TransformCoordinatorType& coord)
{
