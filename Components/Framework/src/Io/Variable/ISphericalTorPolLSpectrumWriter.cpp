...
ISphericalTorPolLSpectrumWriter::ISphericalTorPolLSpectrumWriter(
   const std::string& prefix, const std::string& type, std::vector<std::shared_ptr<QuICC::DenseSM::IGenericProfile>> pF) :
    ISphericalTorPolEnergyBaseWriter(prefix + Tags::Spectrum::LBASENAME,
...
void ISphericalTorPolLSpectrumWriter::resetEnergy()
{
   this->mTorEnergy.setZero();
   this->mPolEnergy.setZero();
}

void ISphericalTorPolLSpectrumWriter::storeQEnergy(const int l, const int m,
   const MHDFloat energy)
{
   this->mPolEnergy(l) += energy;
}

void ISphericalTorPolLSpectrumWriter::storeSEnergy(const int l, const int m,
   const MHDFloat energy)
{
   this->mPolEnergy(l) += energy;
}

void ISphericalTorPolLSpectrumWriter::storeTEnergy(const int l, const int m,
   const MHDFloat energy)
{
