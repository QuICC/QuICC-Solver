/**
 * @file ShellAngularMomentumWriter.cpp
...
namespace Variable {
   ...
   ShellAngularMomentumWriter::~ShellAngularMomentumWriter()
   {
   }

   void ShellAngularMomentumWriter::init()
   {
   ...
   void ShellAngularMomentumWriter::compute(Transform::TransformCoordinatorType& coord)
   {
   ...
   void ShellAngularMomentumWriter::writeContent()
   {
      // Create file
      this->preWrite();
      ...
      {
         QuICCEnv().abort("Shell angular momentum is NaN!");
      }
   }
