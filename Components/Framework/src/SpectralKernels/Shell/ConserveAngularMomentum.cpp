 ...
 * @brief Source of angular momentum conservation kernel in a shell
 */
...
// Class include
//
#include "QuICC/SpectralKernels/Shell/ConserveAngularMomentum.hpp"
...
namespace Shell {
   ...
   ConserveAngularMomentum::ConserveAngularMomentum(const bool isComplex, MHDFloat ro, MHDFloat ri)
