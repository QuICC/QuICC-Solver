...
if(QUICC_USE_DOUBLEDOUBLE_VKFFT)
    target_compile_definitions(VkFFT INTERFACE -DVKFFT_USE_DOUBLEDOUBLE_FP128)
endif()
...
if(QUICC_USE_SYSTEM_VKFFT)
    ...
    target_compile_definitions(VkFFT INTERFACE -DVKFFT_KERNELS_DIR="${VKFFT_KERNELS_DIR}")
else()
...
elseif(${VKFFT_BACKEND} EQUAL 1)
    ...
    target_compile_definitions(VkFFT INTERFACE -DCUDA_TOOLKIT_ROOT_DIR="${CUDA_TOOLKIT_ROOT_DIR}")
